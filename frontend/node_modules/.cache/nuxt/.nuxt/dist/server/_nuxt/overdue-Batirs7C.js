...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "lock-bg pa-4 pa-md-6" }, _attrs))} data-v-f7a0e5a7><div class="mx-auto" style="${ssrRenderStyle({ "max-width": "960px" })}" data-v-f7a0e5a7>`);
      _push(ssrRenderComponent(VCard, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="d-flex align-center flex-wrap ga-3" data-v-f7a0e5a7${_scopeId}>`);
            _push2(ssrRenderComponent(VIcon, {
              icon: "mdi-lock-alert",
              size: "44"
            }, null, _parent2, _scopeId));
            _push2(`<div class="flex-grow-1" style="${ssrRenderStyle({ "min-width": "220px" })}" data-v-f7a0e5a7${_scopeId}><div class="text-overline" style="${ssrRenderStyle({ "opacity": ".85" })}" data-v-f7a0e5a7${_scopeId}>Service restricted</div><h1 class="text-h5 font-weight-bold ma-0" data-v-f7a0e5a7${_scopeId}>Clear your bills to continue</h1><div class="text-body-2 mt-1" style="${ssrRenderStyle({ "opacity": ".9" })}" data-v-f7a0e5a7${_scopeId}>${ssrInterpolate(statusReason.value || "Your account has overdue API usage bills. Settle them to restore access for your team.")}</div></div><div class="text-right" data-v-f7a0e5a7${_scopeId}><div class="text-caption" style="${ssrRenderStyle({ "opacity": ".85" })}" data-v-f7a0e5a7${_scopeId}>Overdue balance</div><div class="text-h4 font-weight-bold" data-v-f7a0e5a7${_scopeId}>${ssrInterpolate(unref(fmtCurrency)(summary.value.total_overdue || overdueTotal.value))}</div></div></div>`);
          } else {
            return [
      ...
      if (data.value) {
                  ...
                  if (_push3) {
                    _push3(ssrRenderComponent(VCard, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="d-flex align-center justify-space-between" data-v-f7a0e5a7${_scopeId3}><div class="text-caption text-medium-emphasis" data-v-f7a0e5a7${_scopeId3}>Outstanding</div>`);
                          ...
                          _push4(`</div><div class="text-h6 font-weight-bold mt-1" data-v-f7a0e5a7${_scopeId3}>${ssrInterpolate(unref(fmtCurrency)(summary.value.total_outstanding, data.value.currency))}</div><div class="text-caption text-medium-emphasis mt-1" data-v-f7a0e5a7${_scopeId3}>${ssrInterpolate(summary.value.outstanding_count)} unpaid</div>`);
                        } else {
                          return [
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(VCard, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="d-flex align-center justify-space-between" data-v-f7a0e5a7${_scopeId3}><div class="text-caption text-medium-emphasis" data-v-f7a0e5a7${_scopeId3}>Overdue</div>`);
                          _push4(ssrRenderComponent(VIcon, {
                            size: "20",
                            color: "error"
                          }, {
                          ...
                          _push4(`</div><div class="text-h6 font-weight-bold mt-1" data-v-f7a0e5a7${_scopeId3}>${ssrInterpolate(unref(fmtCurrency)(summary.value.total_overdue, data.value.currency))}</div><div class="text-caption text-medium-emphasis mt-1" data-v-f7a0e5a7${_scopeId3}>${ssrInterpolate(summary.value.overdue_count)} overdue</div>`);
                        } else {
                          return [
                            createVNode("div", { class: "d-flex align-center justify-space-between" }, [
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(VCard, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="d-flex align-center justify-space-between" data-v-f7a0e5a7${_scopeId3}><div class="text-caption text-medium-emphasis" data-v-f7a0e5a7${_scopeId3}>Wallet balance</div>`);
                          ...
                          _push4(`</div><div class="text-h6 font-weight-bold mt-1" data-v-f7a0e5a7${_scopeId3}>${ssrInterpolate(unref(fmtCurrency)(data.value.wallet_balance, data.value.currency))}</div><div class="text-caption text-medium-emphasis mt-1" data-v-f7a0e5a7${_scopeId3}>Pre-funded credit</div>`);
                        } else {
                          return [
                            createVNode("div", { class: "d-flex align-center justify-space-between" }, [
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              if (billsToClear.value.length) {
                      ...
                      ssrRenderList(billsToClear.value, (b, i) => {
                        ...
                        _push3(ssrRenderComponent(VListItem, null, {
                          ...
                          append: withCtx((_3, _push4, _parent4, _scopeId3) => {
                            if (_push4) {
                              _push4(`<div class="d-flex ga-1" data-v-f7a0e5a7${_scopeId3}>`);
                          ...
                          default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                            if (_push4) {
                              ...
                              _push4(ssrRenderComponent(VListItemSubtitle, null, {
                                default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                  if (_push5) {
                                    _push5(` Balance <strong data-v-f7a0e5a7${_scopeId4}>${ssrInterpolate(unref(fmtCurrency)(b.balance ?? b.amount, b.currency))}</strong>`);
                                    if (b.due_date) {
                                      _push5(`<span data-v-f7a0e5a7${_scopeId4}> · due ${ssrInterpolate(unref(fmtDate)(b.due_date))}</span>`);
                                    } else {
                                      _push5(`<!---->`);
                                    }
                                    if (Number(b.discount_amount) > 0) {
                                      _push5(`<span data-v-f7a0e5a7${_scopeId4}> · ${ssrInterpolate(unref(fmtCurrency)(b.discount_amount, b.currency))} discount applied</span>`);
                                    } else {
                                      _push5(`<!---->`);
                                    }
                                  } else {
                ...
                _push2(`<div class="text-center py-8" data-v-f7a0e5a7${_scopeId}>`);
                _push2(ssrRenderComponent(VIcon, {
                  size: "48",
                  color: "success",
                  class: "mb-3"
                ...
                _push2(`<div class="text-h6 font-weight-bold mb-2" data-v-f7a0e5a7${_scopeId}>All bills settled!</div>`);
        ...
        _push(`<div class="d-flex justify-space-between flex-wrap ga-2" data-v-f7a0e5a7>`);
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(ssrRenderComponent(VCardText, null, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="d-flex justify-space-between mb-1" data-v-f7a0e5a7${_scopeId3}><span class="text-medium-emphasis" data-v-f7a0e5a7${_scopeId3}>Bill amount</span><span class="font-weight-bold" data-v-f7a0e5a7${_scopeId3}>${ssrInterpolate(unref(fmtCurrency)(payTarget.value.amount, payTarget.value.currency))}</span></div><div class="d-flex justify-space-between mb-3" data-v-f7a0e5a7${_scopeId3}><span class="text-medium-emphasis" data-v-f7a0e5a7${_scopeId3}>Balance due</span><span class="font-weight-bold text-warning" data-v-f7a0e5a7${_scopeId3}>${ssrInterpolate(unref(fmtCurrency)(billBalance.value, payTarget.value.currency))}</span></div><div class="text-caption text-medium-emphasis mb-1" data-v-f7a0e5a7${_scopeId3}>Payment method</div>`);
                                                  ...
                                                  _push8(ssrRenderComponent(VCard, {
                                                    ...
                                                    default: withCtx((_7, _push9, _parent9, _scopeId8) => {
                                                      if (_push9) {
                                                        ...
                                                        _push9(`<div class="text-caption mt-1" data-v-f7a0e5a7${_scopeId8}>M-Pesa</div>`);
                                                      } else {
                                                        return [
                                                          createVNode(VIcon, {
                                                            size: "26",
                                                  ...
                                                  _push8(ssrRenderComponent(VCard, {
                                                    ...
                                                    default: withCtx((_7, _push9, _parent9, _scopeId8) => {
                                                      if (_push9) {
                                                        ...
                                                        _push9(`<div class="text-caption mt-1" data-v-f7a0e5a7${_scopeId8}>Wallet</div><div class="text-caption text-medium-emphasis" data-v-f7a0e5a7${_scopeId8}>${ssrInterpolate(unref(fmtCurrency)(data.value?.wallet_balance, data.value?.currency))}</div>`);
                                                      } else {
                                                        return [
                                                          createVNode(VIcon, {
                                                            size: "26",
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(ssrRenderComponent(VCardText, null, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="d-flex justify-space-between mb-3" data-v-f7a0e5a7${_scopeId3}><span class="text-medium-emphasis" data-v-f7a0e5a7${_scopeId3}>Balance due</span><span class="font-weight-bold text-warning" data-v-f7a0e5a7${_scopeId3}>${ssrInterpolate(unref(fmtCurrency)(couponTarget.value.balance ?? couponTarget.value.amount, couponTarget.value.currency))}</span></div>`);
                          _push4(ssrRenderComponent(VTextField, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        if (mpesa.state === "processing") {
                          ...
                          _push4(`<div class="text-h6 font-weight-bold mb-1" data-v-f7a0e5a7${_scopeId3}>Awaiting your confirmation</div><p class="text-body-2 text-medium-emphasis mb-2" data-v-f7a0e5a7${_scopeId3}> Check your phone and enter your M-Pesa PIN to authorise the payment. </p>`);
                          ...
                          _push4(`<div class="text-caption text-medium-emphasis" data-v-f7a0e5a7${_scopeId3}>`);
                          ...
                          _push4(`<div class="text-h6 font-weight-bold mb-1" data-v-f7a0e5a7${_scopeId3}>Payment successful</div><p class="text-body-2 text-medium-emphasis" data-v-f7a0e5a7${_scopeId3}>${ssrInterpolate(mpesa.message)}</p><!--]-->`);
                          ...
                          _push4(`<div class="text-h6 font-weight-bold mb-1" data-v-f7a0e5a7${_scopeId3}>Payment not completed</div><p class="text-body-2 text-medium-emphasis" data-v-f7a0e5a7${_scopeId3}>${ssrInterpolate(mpesa.message)}</p><!--]-->`);
                        } else {
                          _push4(`<!---->`);
                        }
                      } else {
...
const overdue = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f7a0e5a7"]]);
export {
  overdue as default
};
//# sourceMappingURL=overdue-Batirs7C.js.map
