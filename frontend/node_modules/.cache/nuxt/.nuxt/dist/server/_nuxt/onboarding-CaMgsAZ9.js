import { _ as __nuxt_component_0 } from "./Auth3DScene-UNoq0V5T.js";
import { _ as __nuxt_component_1 } from "./OnboardingForm-Cf1HWAIP.js";
...
import { a6 as VApp, a7 as VMain, i as VRow, j as VCol, d as VIcon } from "../server.mjs";
import "./nuxt-link-CMdK2Lfo.js";
                      ...
                      if (_push4) {
                        _push4(ssrRenderComponent(VCol, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="brand-glass" style="${ssrRenderStyle({ "max-width": "26rem", "position": "relative", "z-index": "10" })}" data-v-19355ef8${_scopeId4}><div class="d-flex align-center ga-3 mb-6" data-v-19355ef8${_scopeId4}><div class="d-flex align-center justify-center brand-logo" data-v-19355ef8${_scopeId4}>`);
                              ...
                              _push5(`</div><h1 class="text-h5 font-weight-bold brand-title" style="${ssrRenderStyle({ "letter-spacing": "-0.02em" })}" data-v-19355ef8${_scopeId4}>DomendraPOS</h1></div><h2 class="text-h6 font-weight-bold brand-title mb-3" data-v-19355ef8${_scopeId4}>Launch your store in minutes</h2><p class="text-body-2 brand-lede mb-6" data-v-19355ef8${_scopeId4}> Get an isolated workspace with inventory, POS, billing, and analytics — ready to go in under a minute. </p><div class="d-flex flex-column ga-3" data-v-19355ef8${_scopeId4}><!--[-->`);
                              ssrRenderList(benefits, (benefit) => {
                                _push5(`<div class="d-flex align-start ga-3" data-v-19355ef8${_scopeId4}><div class="benefit-icon" data-v-19355ef8${_scopeId4}>`);
                                _push5(ssrRenderComponent(VIcon, {
                                  size: "16",
                                  color: "white"
                                }, {
                                ...
                                _push5(`</div><span class="benefit-text" data-v-19355ef8${_scopeId4}>${ssrInterpolate(benefit.text)}</span></div>`);
                              });
                              _push5(`<!--]--></div></div>`);
                            } else {
                              return [
                        ...
                        _push4(ssrRenderComponent(VCol, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="w-100" style="${ssrRenderStyle({ "max-width": "34rem", "position": "relative", "z-index": "10" })}" data-v-19355ef8${_scopeId4}><div class="glass-card" data-v-19355ef8${_scopeId4}>`);
                              _push5(ssrRenderComponent(_component_OnboardingForm, null, null, _parent5, _scopeId4));
                              _push5(`</div><p class="text-center text-caption mt-6 auth3d-footer" data-v-19355ef8${_scopeId4}> © 2026 DomendraPOS. All rights reserved. </p></div>`);
                            } else {
                              return [
                                createVNode("div", {
                                  class: "w-100",
...
const onboarding = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-19355ef8"]]);
export {
  onboarding as default
};
//# sourceMappingURL=onboarding-CaMgsAZ9.js.map
