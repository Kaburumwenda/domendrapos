    ...
    <div class="mx-auto" style="max-width: 960px;">
      ...
      <v-card rounded="xl" color="error" variant="flat" class="pa-5 mb-4">
        <div class="d-flex align-center flex-wrap ga-3">
          ...
          <div class="flex-grow-1" style="min-width: 220px;">
            ...
            <h1 class="text-h5 font-weight-bold ma-0">Access temporarily restricted</h1>
            <div class="text-body-2 mt-1" style="opacity:.9">
              {{ statusReason || (tenantName || 'Your organisation') + "'s account has overdue API usage bills. Settle them to restore access for your team." }}
            </div>
          </div>
      ...
      <v-alert type="warning" variant="tonal" rounded="lg" class="mb-4">
        ...
        <div class="text-body-2">
          ...
          You can <strong>pay now</strong> using M-Pesa or wallet credit below, or
          <strong>contact your administrator or management</strong> to settle the account.
        </div>
      </v-alert>
