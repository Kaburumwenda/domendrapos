...
import { camelizeProps, checkPrintable, deepEqual, ensureValidVNode, genericComponent, getActiveElement, IN_BROWSER, matchesSelector, omit, propsFactory, useRender, wrapInArray } from "../../util/index.js"; // Types
              ...
              default: () => [slots['prepend-item']?.(), !displayItems.value.length && !props.hideNoData && (slots['no-data']?.() ?? _createVNode(VListItem, {
                ...
                default: ({
                  ...
                  return slots.item?.({
                    ...
                    title: () => {
                      return search.value ? _createVNode(VHighlight, {
                        "text": item.title,
