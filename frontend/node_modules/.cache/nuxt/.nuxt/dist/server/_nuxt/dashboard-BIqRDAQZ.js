import { defineComponent, useModel, ref, withCtx, createTextVNode, toDisplayString, openBlock, createBlock, Fragment, renderList, createVNode, isRef, unref, mergeModels, useSSRContext, mergeProps, watch, onScopeDispose, computed, resolveComponent, resolveDynamicComponent, createCommentVNode, renderSlot } from "vue";
import { ssrRenderComponent, ssrRenderList, ssrInterpolate, ssrRenderAttrs, ssrRenderVNode, ssrRenderClass, ssrRenderSlot } from "vue/server-renderer";
import { Q as VBtnGroup, g as VBtn, x as VDialog, k as VCard, y as VCardTitle, z as VCardText, C as VTextField, D as VCardActions, f as VSpacer, d as VIcon, a0 as VSkeletonLoader, M as useToast } from "../server.mjs";
import { _ as _export_sfc } from "./_plugin-vue_export-helper-1tPrXgE0.js";
import { _ as __nuxt_component_0$2 } from "./nuxt-link-CMdK2Lfo.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderVNode(_push, createVNode(resolveDynamicComponent(__props.to ? unref(NuxtLink) : "div"), mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="kpi-card__top" data-v-aca39896${_scopeId}><span class="kpi-card__label" data-v-aca39896${_scopeId}>${ssrInterpolate(__props.label)}</span>`);
            _push2(ssrRenderComponent(_component_GradientIcon, {
              icon: __props.icon,
              color: __props.color
            }, null, _parent2, _scopeId));
            _push2(`</div><div class="${ssrRenderClass([__props.valueClass, "kpi-card__value"])}" data-v-aca39896${_scopeId}>`);
            ...
            if (__props.trend !== void 0) {
              _push2(`<div class="${ssrRenderClass([__props.trend >= 0 ? "kpi-card__trend--up" : "kpi-card__trend--down", "kpi-card__trend"])}" data-v-aca39896${_scopeId}>`);
              ...
              _push2(`<span data-v-aca39896${_scopeId}>${ssrInterpolate(Math.abs(__props.trend).toFixed(1))}% vs prev</span></div>`);
            } else if (__props.subtext) {
              _push2(`<div class="kpi-card__subtext" data-v-aca39896${_scopeId}>${ssrInterpolate(__props.subtext)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            if (__props.sparklineSeries && __props.sparklineSeries[0]?.data?.length) {
              _push2(`<div class="kpi-card__spark" data-v-aca39896${_scopeId}>`);
...
const __nuxt_component_3 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$5, [["__scopeId", "data-v-aca39896"]]), { __name: "DashboardKpiCard" });
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "dash-page" }, _attrs))} data-v-420802f1><div class="dash-header" data-v-420802f1><div class="dash-header__left" data-v-420802f1><div class="dash-header__title-icon" data-v-420802f1>`);
      ...
      _push(`</div><div data-v-420802f1><h1 class="text-h5 font-weight-bold" data-v-420802f1>Dashboard</h1><p class="text-body-2 text-medium-emphasis" data-v-420802f1>${ssrInterpolate(unref(greeting))} — here&#39;s your store at a glance</p></div></div><div class="dash-header__actions" data-v-420802f1><div class="dash-header__branch d-none d-md-flex align-center" data-v-420802f1>`);
      _push(ssrRenderComponent(VIcon, {
        size: "16",
      ...
      _push(`<span class="text-caption text-medium-emphasis" data-v-420802f1>${ssrInterpolate(unref(branchStore).branchName)}</span></div>`);
      ...
      if (unref(lastUpdated) && !unref(loading)) {
        _push(`<div class="dash-last-updated text-caption text-medium-emphasis" data-v-420802f1> Last updated: ${ssrInterpolate(unref(lastUpdated))}</div>`);
      } else {
        _push(`<!---->`);
      }
      ...
      if (unref(loading) && unref(transactions).length === 0) {
        ...
        _push(`<!--[--><div class="dash-kpi-grid" data-v-420802f1>`);
        ...
        _push(`</div><div class="dash-chart-row dash-chart-row--wide dash-animate dash-animate--2" data-v-420802f1>`);
        ...
        _push(`</div><div class="dash-chart-row dash-animate dash-animate--3" data-v-420802f1>`);
        _push(ssrRenderComponent(_component_DashboardChartCard, {
        ...
        _push(`</div><div class="dash-chart-row dash-chart-row--full dash-animate dash-animate--4" data-v-420802f1>`);
        _push(ssrRenderComponent(_component_DashboardChartCard, {
        ...
        _push(`</div><div class="dash-bottom-row dash-animate dash-animate--5" data-v-420802f1>`);
...
const dashboard = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-420802f1"]]);
export {
  dashboard as default
};
//# sourceMappingURL=dashboard-BIqRDAQZ.js.map
