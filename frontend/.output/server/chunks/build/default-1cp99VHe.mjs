...
import { useSSRContext, ref, defineComponent, mergeProps, unref, computed, watch, withCtx, createTextVNode, toDisplayString, createVNode, openBlock, createBlock, createCommentVNode, Fragment, renderList, withModifiers, renderSlot, shallowRef, toValue, nextTick, getCurrentScope, onScopeDispose, getCurrentInstance } from 'vue';
...
import { S as VSelect, N as useRoute$1, F as useCookie, aa as VApp, ae as VNavigationDrawer, d as VIcon, af as VAppBar, ag as VAppBarNavIcon, f as VSpacer, g as VBtn, H as VMenu, I as VList, p as VDivider, J as VListItem, Q as VAvatar, ab as VMain, V as VContainer, b as useRuntimeConfig, ad as useTheme$1 } from './server.mjs';
          ...
          if (_push2) {
            _push2(ssrRenderComponent(VNavigationDrawer, {
              ...
              append: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="sidebar-rail-toggle" data-v-e25414e0${_scopeId2}><button class="sidebar-item sidebar-item--rail" data-v-e25414e0${_scopeId2}>`);
                  ...
                  if (!rail.value) {
                    _push3(`<span class="sidebar-item__label" data-v-e25414e0${_scopeId2}>Collapse</span>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`</button></div>`);
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="sidebar-logo" data-v-e25414e0${_scopeId2}><div class="sidebar-logo__icon" data-v-e25414e0${_scopeId2}>`);
                  if (tenantLogoUrl.value) {
                    _push3(`<img${ssrRenderAttr("src", tenantLogoUrl.value)} alt="Logo" class="sidebar-logo__img" data-v-e25414e0${_scopeId2}>`);
                  } else {
                    _push3(ssrRenderComponent(VIcon, {
                      size: "22",
                      color: "white"
                  ...
                  _push3(`</div>`);
                  if (!rail.value) {
                    _push3(`<div class="sidebar-logo__text" data-v-e25414e0${_scopeId2}><span class="sidebar-logo__title" data-v-e25414e0${_scopeId2}>${ssrInterpolate(unref(auth).isSuperAdmin ? "DomendraPOS" : unref(auth).tenantName || "DomendraPOS")}</span><p class="sidebar-logo__sub" data-v-e25414e0${_scopeId2}>${ssrInterpolate(unref(auth).isSuperAdmin ? "Platform Admin" : "Point of Sale")}</p></div>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  _push3(`</div>`);
                  if (!unref(auth).isSuperAdmin) {
                    _push3(`<nav class="sidebar-nav" data-v-e25414e0${_scopeId2}><!--[-->`);
                    ssrRenderList(navItems.value, (item) => {
                      _push3(`<!--[-->`);
                      if (item.children) {
                        _push3(`<div class="sidebar-group" data-v-e25414e0${_scopeId2}><button class="${ssrRenderClass([{ "sidebar-item--active": isGroupActive(item), "sidebar-item--open": expandedGroups.value[item.label] }, "sidebar-item"])}" data-v-e25414e0${_scopeId2}>`);
                        _push3(ssrRenderComponent(VIcon, {
                          size: "20",
                          class: "sidebar-item__icon"
                        }, {
                        ...
                        if (!rail.value) {
                          _push3(`<span class="sidebar-item__label" data-v-e25414e0${_scopeId2}>${ssrInterpolate(item.label)}</span>`);
                        } else {
                          _push3(`<!---->`);
                        }
                        if (!rail.value) {
                        ...
                        if (!rail.value && expandedGroups.value[item.label]) {
                          _push3(`<div class="sidebar-group__children" data-v-e25414e0${_scopeId2}><!--[-->`);
                            ...
                            _push3(ssrRenderComponent(_component_NuxtLink, {
                              ...
                              default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                                if (_push4) {
                                  ...
                                  _push4(`<span class="sidebar-child__label" data-v-e25414e0${_scopeId3}>${ssrInterpolate(child.label)}</span>`);
                                } else {
                                  return [
                                    createVNode(VIcon, {
                                      size: "18",
                        ...
                        _push3(ssrRenderComponent(_component_NuxtLink, {
                          ...
                          default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                            if (_push4) {
                              ...
                              if (!rail.value) {
                                _push4(`<span class="sidebar-item__label" data-v-e25414e0${_scopeId3}>${ssrInterpolate(item.label)}</span>`);
                              } else {
                                _push4(`<!---->`);
                              }
                            } else {
                  ...
                  if (unref(auth).isManager) {
                    _push3(`<!--[-->`);
                    if (!rail.value) {
                      _push3(`<div class="sidebar-section-label" data-v-e25414e0${_scopeId2}>Administration</div>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    _push3(`<nav class="sidebar-nav sidebar-nav--admin" data-v-e25414e0${_scopeId2}><!--[-->`);
                  ...
                  if (unref(auth).isSuperAdmin) {
                    _push3(`<!--[-->`);
                    if (!rail.value) {
                      _push3(`<div class="sidebar-section-label" data-v-e25414e0${_scopeId2}>Platform</div>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    _push3(`<nav class="sidebar-nav sidebar-nav--admin" data-v-e25414e0${_scopeId2}><!--[-->`);
                      ...
                      createVNode("nav", { class: "sidebar-nav sidebar-nav--admin" }, [
                        (openBlock(true), createBlock(Fragment, null, renderList(superadminItems.value, (item) => {
                          return openBlock(), createBlock(Fragment, {
                            ...
                            !item.children ? (openBlock(), createBlock(_component_NuxtLink, {
                              key: 0,
                              to: item.path,
                              class: ["sidebar-item", { "sidebar-item--active": isActive(item.path) }]
                            }, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  if (sessionDuration.value) {
                    _push3(`<div class="nav-brand-clock" data-v-e25414e0${_scopeId2}><div class="nav-brand-clock__session" data-v-e25414e0${_scopeId2}>`);
                    ...
                    _push3(`<span class="nav-brand-clock__session-label" data-v-e25414e0${_scopeId2}>Session</span><span class="nav-brand-clock__session-value" data-v-e25414e0${_scopeId2}>${ssrInterpolate(sessionDuration.value)}</span></div></div>`);
                  } else {
                    _push3(`<!---->`);
                  }
                  ...
                  if (!unref(auth).isSuperAdmin) {
                    _push3(`<div class="nav-today" data-v-e25414e0${_scopeId2}><span class="nav-today__label" data-v-e25414e0${_scopeId2}>TODAY</span>`);
                    if (todayKpis.value.txCount > 0) {
                      _push3(`<div class="nav-today__live" data-v-e25414e0${_scopeId2}><span class="nav-today__live-dot" data-v-e25414e0${_scopeId2}></span><span class="nav-today__live-text" data-v-e25414e0${_scopeId2}>LIVE</span></div>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    _push3(`<div class="nav-clock" data-v-e25414e0${_scopeId2}><span class="nav-clock__digit" data-v-e25414e0${_scopeId2}>${ssrInterpolate(clockDigits.value.h1)}</span><span class="nav-clock__digit" data-v-e25414e0${_scopeId2}>${ssrInterpolate(clockDigits.value.h2)}</span><span class="${ssrRenderClass([{ "nav-clock__colon--blink": clockColon.value }, "nav-clock__colon"])}" data-v-e25414e0${_scopeId2}>:</span><span class="nav-clock__digit" data-v-e25414e0${_scopeId2}>${ssrInterpolate(clockDigits.value.m1)}</span><span class="nav-clock__digit" data-v-e25414e0${_scopeId2}>${ssrInterpolate(clockDigits.value.m2)}</span><span class="${ssrRenderClass([{ "nav-clock__colon--blink": clockColon.value }, "nav-clock__colon"])}" data-v-e25414e0${_scopeId2}>:</span><span class="nav-clock__digit" data-v-e25414e0${_scopeId2}>${ssrInterpolate(clockDigits.value.s1)}</span><span class="nav-clock__digit" data-v-e25414e0${_scopeId2}>${ssrInterpolate(clockDigits.value.s2)}</span></div>`);
                    if (storeOpen.value) {
                      _push3(`<div class="nav-countdown" data-v-e25414e0${_scopeId2}>`);
                      _push3(ssrRenderComponent(VIcon, {
                        size: "13",
                        color: "primary"
                      }, {
                      ...
                      _push3(`<span class="nav-countdown__value" data-v-e25414e0${_scopeId2}>${ssrInterpolate(countdown.value)}</span></div>`);
                    } else {
                      _push3(`<div class="nav-countdown nav-countdown--closed" data-v-e25414e0${_scopeId2}>`);
                      _push3(ssrRenderComponent(VIcon, {
                        size: "13",
                        color: "error"
                      }, {
                      ...
                      _push3(`<span class="nav-countdown__value" data-v-e25414e0${_scopeId2}>Closed</span></div>`);
                    }
                    _push3(`<div class="nav-today__stats" data-v-e25414e0${_scopeId2}><div class="nav-today__stat" data-v-e25414e0${_scopeId2}><span class="nav-today__stat-label" data-v-e25414e0${_scopeId2}>Revenue</span><span class="nav-today__stat-value text-success" data-v-e25414e0${_scopeId2}>${ssrInterpolate(formatMoney(todayKpis.value.revenue))}</span></div><div class="nav-today__sep" data-v-e25414e0${_scopeId2}></div><div class="nav-today__stat" data-v-e25414e0${_scopeId2}><span class="nav-today__stat-label" data-v-e25414e0${_scopeId2}>Txns</span><span class="nav-today__stat-value" data-v-e25414e0${_scopeId2}>${ssrInterpolate(todayKpis.value.txCount)}</span></div></div></div>`);
                  } else {
                    _push3(`<!---->`);
                  }
                            ...
                            if (_push5) {
                              _push5(ssrRenderComponent(VAvatar, {
                                ...
                                default: withCtx((_4, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<span class="text-white font-weight-bold text-body-2" data-v-e25414e0${_scopeId5}>${ssrInterpolate(initials.value)}</span>`);
                                  } else {
                                    return [
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(VList, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="px-4 py-2" data-v-e25414e0${_scopeId4}><p class="text-body-2 font-weight-bold" data-v-e25414e0${_scopeId4}>${ssrInterpolate(unref(auth).fullName)}</p><p class="text-caption text-medium-emphasis" data-v-e25414e0${_scopeId4}>${ssrInterpolate(unref(auth).user?.email)}</p></div>`);
                              ...
                              return [
                                createVNode("div", { class: "px-4 py-2" }, [
                                  ...
                                  createVNode("p", { class: "text-caption text-medium-emphasis" }, toDisplayString(unref(auth).user?.email), 1)
                                ]),
...
const _default = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e25414e0"]]);

export { _default as default };
//# sourceMappingURL=default-1cp99VHe.mjs.map
