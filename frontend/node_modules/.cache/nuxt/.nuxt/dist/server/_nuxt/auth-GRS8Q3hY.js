...
import { withCtx, createTextVNode, createVNode, openBlock, createBlock, Fragment, renderList, toDisplayString, renderSlot, useSSRContext } from "vue";
                      ...
                      if (_push4) {
                        _push4(ssrRenderComponent(VCol, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="brand-glass" style="${ssrRenderStyle({ "max-width": "30rem", "position": "relative", "z-index": "10" })}" data-v-f8773d8d${_scopeId4}><div class="d-flex align-center ga-3 mb-8" data-v-f8773d8d${_scopeId4}><div class="d-flex align-center justify-center brand-logo" data-v-f8773d8d${_scopeId4}>`);
                              ...
                              _push5(`</div><h1 class="text-h4 font-weight-bold brand-title" style="${ssrRenderStyle({ "letter-spacing": "-0.02em" })}" data-v-f8773d8d${_scopeId4}>DomendraPOS</h1></div><p class="text-h6 mb-8 brand-lede" data-v-f8773d8d${_scopeId4}> The complete multi-tenant Point-of-Sale platform for modern retail. </p><div class="d-flex flex-column ga-4" data-v-f8773d8d${_scopeId4}><!--[-->`);
                              ssrRenderList(features, (feature) => {
                                _push5(`<div class="d-flex align-center ga-3" data-v-f8773d8d${_scopeId4}><div class="d-flex align-center justify-center feature-chip" data-v-f8773d8d${_scopeId4}>`);
                                _push5(ssrRenderComponent(VIcon, {
                                  size: "20",
                                  color: "white"
                                }, {
                                ...
                                _push5(`</div><span class="feature-text" data-v-f8773d8d${_scopeId4}>${ssrInterpolate(feature)}</span></div>`);
                              });
                              _push5(`<!--]--></div></div>`);
                            } else {
                              return [
                        ...
                        _push4(ssrRenderComponent(VCol, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="w-100" style="${ssrRenderStyle({ "max-width": "30rem", "position": "relative", "z-index": "10" })}" data-v-f8773d8d${_scopeId4}><div class="glass-card" data-v-f8773d8d${_scopeId4}>`);
                              ssrRenderSlot(_ctx.$slots, "default", {}, null, _push5, _parent5, _scopeId4);
                              _push5(`</div><p class="text-center text-caption mt-6 auth3d-footer" data-v-f8773d8d${_scopeId4}> © 2026 DomendraPOS. All rights reserved. </p></div>`);
                            } else {
                              return [
                                createVNode("div", {
                                  class: "w-100",
...
const auth = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f8773d8d"]]);
export {
  auth as default
};
//# sourceMappingURL=auth-GRS8Q3hY.js.map
