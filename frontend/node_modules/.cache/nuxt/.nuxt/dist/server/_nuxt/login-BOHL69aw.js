...
import { M as useToast, d as VIcon, U as VForm, C as VTextField, S as VCheckbox, h as VAlert, g as VBtn, n as navigateTo } from "../server.mjs";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "login-content" }, _attrs))} data-v-c2e52a65><div class="d-flex align-center ga-3 mb-6" data-v-c2e52a65><div class="d-flex align-center justify-center logo-badge" data-v-c2e52a65>`);
      ...
      _push(`</div><div data-v-c2e52a65><div class="text-h5 font-weight-bold brand-title" data-v-c2e52a65>DomendraPOS</div><div class="text-caption text-muted" data-v-c2e52a65>Sign in to continue</div></div></div><div class="mb-6" data-v-c2e52a65><h2 class="text-h5 font-weight-semibold brand-title" data-v-c2e52a65>Welcome back</h2><p class="text-body-2 text-muted mt-1" data-v-c2e52a65>Sign in to your DomendraPOS account</p></div>`);
      _push(ssrRenderComponent(VForm, { onSubmit: handleLogin }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="d-flex align-center justify-space-between mb-4" data-v-c2e52a65${_scopeId}>`);
            ...
            _push2(`<a href="#" class="text-body-2 text-link text-decoration-none" data-v-c2e52a65${_scopeId}>Forgot password?</a></div>`);
            if (unref(error)) {
      ...
      _push(`<div class="mt-6 pt-6 demo-divider" data-v-c2e52a65><p class="text-caption text-muted mb-2" data-v-c2e52a65>Demo credentials:</p><div class="d-flex flex-column ga-1 text-caption text-muted" data-v-c2e52a65><p data-v-c2e52a65><code data-v-c2e52a65>admin@demo.com</code> / <code data-v-c2e52a65>Demo123!</code></p><p data-v-c2e52a65><code data-v-c2e52a65>admin@domendrapos.com</code> / <code data-v-c2e52a65>Admin123!</code> (super)</p></div></div><p class="text-center text-body-2 mt-6 text-muted" data-v-c2e52a65> New to DomendraPOS? `);
...
const login = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c2e52a65"]]);
export {
  login as default
};
//# sourceMappingURL=login-BOHL69aw.js.map
