import { _ as _sfc_main$1 } from "./PaginationBar-D54ggLJ2.js";
                        ...
                        _push4(ssrRenderComponent(VCardTitle, { class: "d-flex align-center justify-space-between pa-4" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              ...
                              _push5(`<div data-v-c9d5c0dc${_scopeId4}><div class="text-h6 font-weight-bold" data-v-c9d5c0dc${_scopeId4}>${ssrInterpolate(unref(selectedSale)?.transaction_number)}</div><div class="text-caption text-medium-emphasis" data-v-c9d5c0dc${_scopeId4}>${ssrInterpolate(unref(datetime)(unref(selectedSale)?.created_at))}</div></div></div>`);
                              _push5(ssrRenderComponent(VBtn, {
                                variant: "text",
                                icon: "mdi-close",
                                size: "small",
...
//# sourceMappingURL=sales-CFYDzZOq.js.map
