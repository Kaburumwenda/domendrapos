import { defineComponent, ref, computed, resolveComponent, mergeProps, unref, withCtx, createTextVNode, toDisplayString, useSSRContext } from 'file://D:/Projects/MY-APPS-2/DomendraPOS/frontend/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderStyle, ssrRenderAttr, ssrRenderList, ssrRenderClass } from 'file://D:/Projects/MY-APPS-2/DomendraPOS/frontend/node_modules/vue/server-renderer/index.mjs';
import { u as useFormat } from './useFormat-BvVWDMYe.mjs';
import { _ as _export_sfc, D as useToast, c as VBtn, x as VProgressCircular, a as VIcon } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const tabs = computed(() => {
      ...
      return [
        { id: "abc", label: "ABC Classification", icon: "mdi-chart-bell-curve", count: ((_b = (_a = data.value) == null ? void 0 : _a.abc_analysis) == null ? void 0 : _b.length) || 0 },
        { id: "low", label: "Low Stock Alerts", icon: "mdi-alert-outline", count: ((_d = (_c = data.value) == null ? void 0 : _c.low_stock_items) == null ? void 0 : _d.length) || 0 },
        { id: "movements", label: "Movement Log", icon: "mdi-swap-horizontal-bold", count: ((_f = (_e = data.value) == null ? void 0 : _e.movement_summary) == null ? void 0 : _f.length) || 0 }
      ];
    });
    ...
    const categoryDonutSeries = computed(() => {
      var _a, _b;
      return ((_b = (_a = data.value) == null ? void 0 : _a.by_category) == null ? void 0 : _b.map((c) => Number(c.value))) || [];
    });
    const categoryDonutOptions = computed(() => {
      ...
      return {
        ...
        labels: ((_b = (_a = data.value) == null ? void 0 : _a.by_category) == null ? void 0 : _b.map((c) => c.category)) || [],
        colors: palette,
    ...
    const movementSeries = computed(() => {
      var _a, _b;
      if (!((_b = (_a = data.value) == null ? void 0 : _a.movement_summary) == null ? void 0 : _b.length)) return [];
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(data)) {
        ...
        _push(`</div><div data-v-5ee3d871><h3 class="an-card__title" data-v-5ee3d871>ABC Classification</h3><p class="an-card__subtitle" data-v-5ee3d871>Pareto analysis of stock value</p></div></div><div class="an-card__body" data-v-5ee3d871><div class="an-abc-summary" data-v-5ee3d871><div class="an-abc-item" data-v-5ee3d871><div class="an-abc-item__badge an-abc-item__badge--a" data-v-5ee3d871>A</div><div class="an-abc-item__body" data-v-5ee3d871><p class="an-abc-item__count" data-v-5ee3d871>${ssrInterpolate(unref(data).abc_counts.A)}</p><p class="an-abc-item__label" data-v-5ee3d871>Class A \xB7 80% value</p></div></div><div class="an-abc-item" data-v-5ee3d871><div class="an-abc-item__badge an-abc-item__badge--b" data-v-5ee3d871>B</div><div class="an-abc-item__body" data-v-5ee3d871><p class="an-abc-item__count" data-v-5ee3d871>${ssrInterpolate(unref(data).abc_counts.B)}</p><p class="an-abc-item__label" data-v-5ee3d871>Class B \xB7 next 15%</p></div></div><div class="an-abc-item" data-v-5ee3d871><div class="an-abc-item__badge an-abc-item__badge--c" data-v-5ee3d871>C</div><div class="an-abc-item__body" data-v-5ee3d871><p class="an-abc-item__count" data-v-5ee3d871>${ssrInterpolate(unref(data).abc_counts.C)}</p><p class="an-abc-item__label" data-v-5ee3d871>Class C \xB7 remaining 5%</p></div></div></div>`);
        _push(ssrRenderComponent(_component_apexchart, {
          type: "donut",
          height: "200",
...
//# sourceMappingURL=stock-analysis-C80S49xy.mjs.map
