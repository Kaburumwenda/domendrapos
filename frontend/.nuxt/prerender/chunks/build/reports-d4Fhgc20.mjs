import { defineComponent, ref, computed, mergeProps, withCtx, createTextVNode, unref, toDisplayString, isRef, createVNode, openBlock, createBlock, Fragment, renderList, createCommentVNode, createSlots, useSSRContext } from 'file://D:/Projects/MY-APPS-2/DomendraPOS/frontend/node_modules/vue/index.mjs';
import { ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderStyle, ssrRenderAttr, ssrRenderAttrs } from 'file://D:/Projects/MY-APPS-2/DomendraPOS/frontend/node_modules/vue/server-renderer/index.mjs';
...
import { jsPDF } from 'file://D:/Projects/MY-APPS-2/DomendraPOS/frontend/node_modules/jspdf/dist/jspdf.node.min.js';
import autoTable from 'file://D:/Projects/MY-APPS-2/DomendraPOS/frontend/node_modules/jspdf-autotable/dist/jspdf.plugin.autotable.mjs';
import FileSaver from 'file://D:/Projects/MY-APPS-2/DomendraPOS/frontend/node_modules/file-saver/dist/FileSaver.min.js';
import ExcelJS from 'file://D:/Projects/MY-APPS-2/DomendraPOS/frontend/node_modules/exceljs/excel.js';
...
function useReportExport() {
  ...
  function _exportCSV(params) {
    ...
    const rows = items.map(
      (row) => columns.map((c) => {
        var _a;
        return `"${String((_a = row[c.key]) != null ? _a : "").replace(/"/g, '""')}"`;
      }).join(",")
    );
...
${csv}`;
  ...
  async function _exportExcel(params) {
    ...
    if (!items.length && !(kpis == null ? void 0 : kpis.length)) return;
  ...
  function _colWidth(col, items) {
    const sample = items.slice(0, 50).map((row) => {
      var _a;
      return String((_a = row[col.key]) != null ? _a : "");
    });
  ...
  async function _exportPDF(params) {
    ...
    const logoUrl = _logoUrl();
    {
      ...
      doc.setFontSize(16);
      const initials = _bizName().split(" ").slice(0, 2).map((w) => {
        var _a;
  ...
  function _drawFooter(doc, pageW, pageH, margin) {
    ...
    const left = `\xA9 ${(/* @__PURE__ */ new Date()).getFullYear()} ${_bizName()} \u2014 DomendraPOS`;
    ...
    for (const sec of sections) {
      ...
      if (displayItems.length) {
        ...
        if (sec.items.length > maxRows) {
          const finalY = ((_a = doc.lastAutoTable) == null ? void 0 : _a.finalY) || yPos + 10;
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function getKpis(reportId, d) {
      ...
      switch (reportId) {
        ...
        case "time-of-day": {
          ...
          return [
            { label: "Total Revenue", value: fmtCurrency(((_a = d.kpis) == null ? void 0 : _a.total_revenue) || 0), color: "#1976D2" },
            { label: "Total Txns", value: fmtNumber(((_b = d.kpis) == null ? void 0 : _b.total_transactions) || 0), color: "#2E7D32" },
        ...
        case "revenue-trend": {
          ...
          return [
            { label: "Total Revenue", value: fmtCurrency(((_c = d.kpis) == null ? void 0 : _c.total_revenue) || 0), color: "#1976D2" },
            { label: "Total Cost", value: fmtCurrency(((_d = d.kpis) == null ? void 0 : _d.total_cost) || 0), color: "#F44336" },
            { label: "Total Profit", value: fmtCurrency(((_e = d.kpis) == null ? void 0 : _e.total_profit) || 0), color: "#2E7D32" },
        ...
        case "product-analytics":
          return [
            { label: "Total Products", value: fmtNumber(((_f = d.kpis) == null ? void 0 : _f.total_products) || 0), color: "#1976D2" },
            { label: "Products Sold", value: fmtNumber(((_g = d.kpis) == null ? void 0 : _g.products_sold) || 0), color: "#2E7D32" },
            { label: "Never Sold", value: fmtNumber(((_h = d.kpis) == null ? void 0 : _h.products_never_sold) || 0), color: "#F44336" },
            { label: "Total Revenue", value: fmtCurrency(((_i = d.kpis) == null ? void 0 : _i.total_revenue) || 0), color: "#FF9800" },
            { label: "Stock Value", value: fmtCurrency(((_j = d.kpis) == null ? void 0 : _j.stock_value) || 0), color: "#7B1FA2" }
          ];
        case "category-analytics":
          return [
            { label: "Total Revenue", value: fmtCurrency(((_k = d.kpis) == null ? void 0 : _k.total_revenue) || 0), color: "#1976D2" },
            { label: "Categories", value: fmtNumber(((_l = d.kpis) == null ? void 0 : _l.total_categories) || 0), color: "#2E7D32" },
            { label: "Top Category", value: ((_m = d.kpis) == null ? void 0 : _m.top_category) || "-", color: "#FF9800" },
            { label: "Top Revenue", value: fmtCurrency(((_n = d.kpis) == null ? void 0 : _n.top_category_revenue) || 0), color: "#7B1FA2" }
          ];
        case "peak-hours-heatmap": {
          const grid = d.grid || [];
          let peakHour = 0, peakDay = 0, peakVal = 0, totalRev = 0;
          for (let h = 0; h < grid.length; h++) {
            for (let wd = 0; wd < (((_o = grid[h]) == null ? void 0 : _o.length) || 0); wd++) {
    ...
    const showHeatmap = computed(() => {
      var _a;
      return activeReport.value === "peak-hours-heatmap" && ((_a = reportData.value) == null ? void 0 : _a.grid);
    });
    ...
    async function doExport(format) {
      ...
      const reportLabel = ((_a = reports2.find((r) => r.id === activeReport.value)) == null ? void 0 : _a.label) || "Report";
    ...
    async function generateGeneralReport() {
      ...
      for (const rptId of generalReportIds.value) {
        try {
          ...
          const label = ((_a = reports2.find((r) => r.id === rptId)) == null ? void 0 : _a.label) || rptId;
    ...
    async function loadActive() {
      ...
      try {
        ...
        error.value = ((_a = e == null ? void 0 : e.data) == null ? void 0 : _a.detail) || e.message || "Failed to load report.";
      } finally {
        loading.value = false;
      }
    }
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(VChip, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                var _a, _b;
                if (_push3) {
                  _push3(`${ssrInterpolate((_a = reports2.find((r) => r.id === unref(activeReport))) == null ? void 0 : _a.label)}`);
                } else {
                  return [
                    createTextVNode(toDisplayString((_b = reports2.find((r) => r.id === unref(activeReport))) == null ? void 0 : _b.label), 1)
                  ];
                }
              }),
              _: 1
                      ...
                      createVNode("div", { class: "d-flex align-center justify-space-between flex-wrap ga-4" }, [
                        createVNode("div", null, [
                          ...
                          createVNode("div", { class: "text-body-2 text-medium-emphasis mt-2" }, [
                            ...
                            createTextVNode(" \xA0\u2022\xA0 Previous: "),
              ...
              createVNode("div", { class: "d-flex align-center mb-4 flex-wrap ga-2" }, [
                ...
                createVNode(VChip, {
                  ...
                  default: withCtx(() => {
                    var _a;
                    return [
                      createTextVNode(toDisplayString((_a = reports2.find((r) => r.id === unref(activeReport))) == null ? void 0 : _a.label), 1)
                    ];
                  }),
                  _: 1
                }),
...
//# sourceMappingURL=reports-d4Fhgc20.mjs.map
