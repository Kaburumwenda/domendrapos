import { u as usePosStore, _ as __nuxt_component_0 } from './pos-Bhu_f6Bd.mjs';
import { defineComponent, watch, computed, ref, mergeProps, withCtx, createTextVNode, unref, createVNode, toDisplayString, openBlock, createBlock, createCommentVNode, isRef, Fragment, renderList, useSSRContext } from 'vue';
...
import { M as useToast, d as VIcon, g as VBtn, v as VChip, Q as VAvatar, o as VBadge, x as VDialog, k as VCard, y as VCardTitle, f as VSpacer, p as VDivider, z as VCardText, C as VTextField, h as VAlert, D as VCardActions, _ as VTextarea } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function printReceipt() {
      const receiptEl = (void 0).querySelector(".receipt");
      if (!receiptEl) return;
      const win = (void 0).open("", "_blank", "width=400,height=600");
      if (!win) return;
      win.document.write(`<html><head><title>Receipt</title><style>body{font-family:monospace;margin:0;padding:20px;}${(void 0).querySelector("style[scoped]")?.textContent || ""}</style></head><body>${receiptEl.outerHTML}</body></html>`);
      win.document.close();
      setTimeout(() => {
        win.print();
      }, 250);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "smart-pos-shell" }, _attrs))} data-v-57e6fe9e><header class="smart-topbar" data-v-57e6fe9e><div class="smart-brand" data-v-57e6fe9e><div class="smart-brand__mark" data-v-57e6fe9e>`);
      ...
      _push(`</div><div class="smart-brand__text" data-v-57e6fe9e><h1 class="smart-brand__title" data-v-57e6fe9e>Smart POS</h1><p class="smart-brand__meta" data-v-57e6fe9e>Lane 01 · ${ssrInterpolate(nowLabel)}</p></div></div><div class="smart-search-wrap" data-v-57e6fe9e><div class="${ssrRenderClass([{ "smart-search--ready": unref(scannerReady) }, "smart-search"])}" data-v-57e6fe9e>`);
      _push(ssrRenderComponent(VIcon, {
        size: "20",
      ...
      _push(`<input${ssrRenderAttr("value", unref(scanInput))} class="smart-search__input" placeholder="Scan barcode or type SKU / name…" data-v-57e6fe9e>`);
      if (unref(scanInput)) {
      ...
      if (unref(showSuggestions) && unref(suggestions).length > 0) {
        _push(`<div class="scan-suggestions" data-v-57e6fe9e><!--[-->`);
        ssrRenderList(unref(suggestions), (p) => {
          _push(`<button type="button" class="scan-suggestion"${ssrIncludeBooleanAttr(stockOf(p) <= 0) ? " disabled" : ""} data-v-57e6fe9e><div class="scan-suggestion__thumb" data-v-57e6fe9e>`);
          if (p.image) {
            _push(`<img${ssrRenderAttr("src", p.image)} alt="" data-v-57e6fe9e>`);
          } else {
            _push(ssrRenderComponent(VIcon, {
              size: "16",
          ...
          _push(`</div><div class="scan-suggestion__body" data-v-57e6fe9e><div class="scan-suggestion__name" data-v-57e6fe9e>${ssrInterpolate(p.name)}</div><div class="scan-suggestion__meta" data-v-57e6fe9e>${ssrInterpolate(p.sku || "—")} · Stock ${ssrInterpolate(stockOf(p))}${ssrInterpolate(pieceStockLabel(p))}</div></div>`);
          if (p.barcode) {
            _push(`<div class="scan-suggestion__barcode" data-v-57e6fe9e>${ssrInterpolate(p.barcode)}</div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<div class="scan-suggestion__price" data-v-57e6fe9e>${ssrInterpolate(formatMoney(piecePrice(p)))}`);
      ...
      if (unref(showSuggestions) && unref(scanInput) && unref(suggestions).length === 0 && unref(products).length > 0) {
        _push(`<div class="scan-suggestions scan-suggestions--empty" data-v-57e6fe9e><div class="scan-suggestion__empty" data-v-57e6fe9e>No products match &quot;${ssrInterpolate(unref(scanInput))}&quot;</div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div><div class="smart-topbar__actions" data-v-57e6fe9e><div class="smart-stat d-none d-md-flex" data-v-57e6fe9e><span class="smart-stat__label" data-v-57e6fe9e>Today</span><span class="smart-stat__value" data-v-57e6fe9e>${ssrInterpolate(unref(todayStats).count)} sales · ${ssrInterpolate(formatMoney(unref(todayStats).revenue))}</span></div><div class="smart-cashier d-none d-sm-flex" data-v-57e6fe9e>`);
      _push(ssrRenderComponent(VAvatar, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span class="text-caption font-weight-bold text-white" data-v-57e6fe9e${_scopeId}>${ssrInterpolate(unref(cashierInitials))}</span>`);
          } else {
            return [
      ...
      _push(`<div class="smart-cashier__text" data-v-57e6fe9e><div class="smart-cashier__name" data-v-57e6fe9e>${ssrInterpolate(unref(cashierShort))}</div><div class="smart-cashier__role" data-v-57e6fe9e>${ssrInterpolate(unref(auth).role)}</div></div></div>`);
      _push(ssrRenderComponent(VBtn, {
        to: "/pos/parked",
        variant: "tonal",
        color: "warning",
      ...
      _push(`</div></header><div class="smart-grid" data-v-57e6fe9e><section class="smart-order" data-v-57e6fe9e><div class="smart-order-header" data-v-57e6fe9e><div class="smart-order-tile" data-v-57e6fe9e><div class="smart-order-tile__label" data-v-57e6fe9e>Order</div><div class="smart-order-tile__value" data-v-57e6fe9e>${ssrInterpolate(unref(orderRef))}</div></div><div class="smart-order-tile smart-order-tile--grow" data-v-57e6fe9e><div class="smart-order-tile__label" data-v-57e6fe9e>Customer</div><input${ssrRenderAttr("value", unref(pos).customerName)} class="smart-order-tile__input" placeholder="Walk-in customer" data-v-57e6fe9e></div><div class="smart-order-tile smart-order-tile--right" data-v-57e6fe9e><div class="smart-order-tile__label" data-v-57e6fe9e>Items</div><div class="smart-order-tile__value" data-v-57e6fe9e>${ssrInterpolate(unref(pos).itemCount)}</div></div></div><div class="smart-cart-table" data-v-57e6fe9e>`);
      if (!unref(pos).isEmpty) {
        _push(`<div class="smart-cart-rows" data-v-57e6fe9e><!--[-->`);
        ssrRenderList(unref(pos).cart, (item, i) => {
          _push(`<article class="${ssrRenderClass([{ "smart-cart-item--alt": i % 2 === 0 }, "smart-cart-item"])}" data-v-57e6fe9e><div class="smart-cart-item__main" data-v-57e6fe9e><div class="smart-cart-item__thumb" data-v-57e6fe9e>`);
          if (item.image) {
            _push(`<img${ssrRenderAttr("src", item.image)}${ssrRenderAttr("alt", item.name)} data-v-57e6fe9e>`);
          } else {
            _push(ssrRenderComponent(VIcon, {
              size: "18",
              color: "primary"
          ...
          _push(`</div><div class="smart-cart-item__info" data-v-57e6fe9e><div class="smart-cart-item__title" data-v-57e6fe9e>${ssrInterpolate(item.name)}</div><div class="smart-cart-item__meta" data-v-57e6fe9e>${ssrInterpolate(item.sku || "—")} · ${ssrInterpolate(formatMoney(item.price))} each`);
          ...
          _push(`</div></div></div><div class="smart-cart-item__controls" data-v-57e6fe9e><div class="smart-qty" data-v-57e6fe9e><button type="button" class="smart-qty__btn"${ssrIncludeBooleanAttr(item.qty <= 1) ? " disabled" : ""} data-v-57e6fe9e>`);
          ...
          _push(`</button><input${ssrRenderAttr("value", item.qty)} type="number" min="1"${ssrRenderAttr("max", item.max)} class="smart-qty__input" data-v-57e6fe9e><button type="button" class="smart-qty__btn smart-qty__btn--plus"${ssrIncludeBooleanAttr(item.qty >= item.max) ? " disabled" : ""} data-v-57e6fe9e>`);
          _push(ssrRenderComponent(VIcon, { size: "14" }, {
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`mdi-plus`);
          ...
          _push(`</button></div><div class="smart-cart-item__total" data-v-57e6fe9e>${ssrInterpolate(formatMoney(item.price * item.qty))}</div><button type="button" class="smart-cart-item__del" data-v-57e6fe9e>`);
        ...
        _push(`<div class="smart-cart-empty" data-v-57e6fe9e><div class="smart-cart-empty__card" data-v-57e6fe9e><div class="smart-cart-empty__ring" data-v-57e6fe9e>`);
        _push(ssrRenderComponent(VIcon, {
          size: "40",
          color: "primary"
        }, {
        ...
        _push(`</div><div class="smart-cart-empty__title" data-v-57e6fe9e>Ready to scan</div><p class="smart-cart-empty__body" data-v-57e6fe9e>Scan a barcode, type a name or SKU to add your first item.</p><div class="smart-keyhints" data-v-57e6fe9e><div class="smart-keyhint" data-v-57e6fe9e><kbd data-v-57e6fe9e>Enter</kbd><span data-v-57e6fe9e>Add</span></div><div class="smart-keyhint" data-v-57e6fe9e><kbd data-v-57e6fe9e>F2</kbd><span data-v-57e6fe9e>Search</span></div><div class="smart-keyhint" data-v-57e6fe9e><kbd data-v-57e6fe9e>F9</kbd><span data-v-57e6fe9e>Pay</span></div><div class="smart-keyhint" data-v-57e6fe9e><kbd data-v-57e6fe9e>F4</kbd><span data-v-57e6fe9e>Park</span></div><div class="smart-keyhint" data-v-57e6fe9e><kbd data-v-57e6fe9e>Esc</kbd><span data-v-57e6fe9e>Void</span></div></div>`);
        if (unref(parkedCount) > 0) {
          _push(`<div class="smart-parked-reminder" data-v-57e6fe9e>`);
          _push(ssrRenderComponent(VIcon, {
            size: "18",
            color: "warning"
          }, {
          ...
          _push(`<span data-v-57e6fe9e>${ssrInterpolate(unref(parkedCount))} parked sale${ssrInterpolate(unref(parkedCount) === 1 ? "" : "s")}</span>`);
          _push(ssrRenderComponent(VBtn, {
            to: "/pos/parked",
            variant: "tonal",
            size: "small",
      ...
      _push(`</div><div class="smart-totals" data-v-57e6fe9e><div class="smart-totals__row" data-v-57e6fe9e><span data-v-57e6fe9e>Subtotal</span><span data-v-57e6fe9e>${ssrInterpolate(formatMoney(unref(pos).subtotal))}</span></div><div class="smart-totals__row smart-totals__row--discount" data-v-57e6fe9e><span data-v-57e6fe9e>Discount</span><span data-v-57e6fe9e>- ${ssrInterpolate(formatMoney(unref(pos).discountAmount))}</span></div><div class="smart-totals__row" data-v-57e6fe9e><span data-v-57e6fe9e>Tax</span><span data-v-57e6fe9e>${ssrInterpolate(formatMoney(unref(pos).taxAmount))}</span></div><div class="smart-totals__row smart-totals__row--total" data-v-57e6fe9e><span data-v-57e6fe9e>Total</span><span data-v-57e6fe9e>${ssrInterpolate(formatMoney(unref(pos).total))}</span></div></div></section><aside class="smart-side" data-v-57e6fe9e><div class="smart-side-section" data-v-57e6fe9e><div class="smart-side-section__title" data-v-57e6fe9e>Payment Method</div><div class="smart-pay-grid" data-v-57e6fe9e><!--[-->`);
      ssrRenderList(paymentOptions, (opt) => {
        _push(`<button type="button" class="${ssrRenderClass([{ "smart-pay-btn--active": unref(pos).paymentMethod === opt.value }, "smart-pay-btn"])}" data-v-57e6fe9e><div class="smart-pay-btn__icon" data-v-57e6fe9e>`);
        ...
        _push(`</div><div class="smart-pay-btn__text" data-v-57e6fe9e><div class="smart-pay-btn__name" data-v-57e6fe9e>${ssrInterpolate(opt.label)}</div><div class="smart-pay-btn__hint" data-v-57e6fe9e>${ssrInterpolate(opt.hint)}</div></div>`);
        _push(ssrRenderComponent(VIcon, {
          size: "14",
      ...
      _push(`<!--]--></div></div><div class="smart-side-section" data-v-57e6fe9e><div class="smart-side-section__title" data-v-57e6fe9e>QUICK DISCOUNT</div><div class="smart-quick-disc" data-v-57e6fe9e><!--[-->`);
      ssrRenderList(quickDiscounts, (d) => {
        _push(`<button type="button" class="${ssrRenderClass([{ "smart-quick-disc__btn--active": unref(quickDisc) === d }, "smart-quick-disc__btn"])}" data-v-57e6fe9e>${ssrInterpolate(d === 0 ? "None" : `${d}%`)}</button>`);
      });
      _push(`<!--]--></div></div><div class="smart-side-section" data-v-57e6fe9e><div class="smart-side-section__title" data-v-57e6fe9e>SALE ACTIONS</div><div class="smart-actions" data-v-57e6fe9e>`);
      _push(ssrRenderComponent(VBtn, {
        variant: "tonal",
        color: "warning",
        rounded: "lg",
      ...
      _push(`</div></div><button type="button" class="${ssrRenderClass([{ "smart-pay-now--disabled": unref(pos).isEmpty || unref(checkingOut) }, "smart-pay-now"])}"${ssrIncludeBooleanAttr(unref(pos).isEmpty || unref(checkingOut)) ? " disabled" : ""} data-v-57e6fe9e><div class="smart-pay-now__inner" data-v-57e6fe9e><div class="smart-pay-now__left" data-v-57e6fe9e><div class="smart-pay-now__icon" data-v-57e6fe9e>`);
      _push(ssrRenderComponent(VIcon, {
        size: "22",
        color: "white"
      }, {
      ...
      _push(`</div><div data-v-57e6fe9e><div class="smart-pay-now__label" data-v-57e6fe9e>Charge</div><div class="smart-pay-now__hint" data-v-57e6fe9e>${ssrInterpolate(unref(itemCountLabel))}</div></div></div><div class="smart-pay-now__amount" data-v-57e6fe9e>${ssrInterpolate(formatMoney(unref(pos).total))}</div></div></button></aside></div>`);
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(VCardText, { class: "pt-4" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="checkout-total-banner" data-v-57e6fe9e${_scopeId3}><span class="text-body-2 text-medium-emphasis" data-v-57e6fe9e${_scopeId3}>Total Due</span><span class="checkout-total-banner__value" data-v-57e6fe9e${_scopeId3}>${ssrInterpolate(formatMoney(unref(pos).total))}</span><div class="checkout-total-banner__method" data-v-57e6fe9e${_scopeId3}>`);
                        ...
                        _push4(`<span data-v-57e6fe9e${_scopeId3}>${ssrInterpolate(paymentOptions.find((o) => o.value === unref(pos).paymentMethod)?.label)}</span></div></div>`);
                        ...
                        if (unref(pos).paymentMethod === "cash") {
                          _push4(`<!--[--><p class="text-subtitle-2 font-weight-medium mb-2" data-v-57e6fe9e${_scopeId3}>Cash Received</p><div class="quick-cash-grid mb-2" data-v-57e6fe9e${_scopeId3}><!--[-->`);
                          ...
                          _push4(`<div class="${ssrRenderClass([{ "change-row--positive": unref(change) > 0 }, "change-row"])}" data-v-57e6fe9e${_scopeId3}><span class="text-body-2" data-v-57e6fe9e${_scopeId3}>Change</span><span class="text-h6 font-weight-bold" data-v-57e6fe9e${_scopeId3}>${ssrInterpolate(formatMoney(Math.max(0, unref(change))))}</span></div><!--]-->`);
                        } else {
                          _push4(`<!---->`);
                        }
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(VAlert, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="d-flex justify-space-between" data-v-57e6fe9e${_scopeId4}><span data-v-57e6fe9e${_scopeId4}>Items: ${ssrInterpolate(unref(pos).itemCount)}</span><span data-v-57e6fe9e${_scopeId4}>Total: ${ssrInterpolate(formatMoney(unref(pos).total))}</span></div>`);
                            } else {
                              return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(VCard, { rounded: "xl" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="receipt-success-header" data-v-57e6fe9e${_scopeId2}>`);
                  ...
                  _push3(`<h3 class="text-h6 font-weight-bold mt-2" data-v-57e6fe9e${_scopeId2}>Sale Completed</h3><p class="text-caption text-medium-emphasis" data-v-57e6fe9e${_scopeId2}>${ssrInterpolate(unref(lastTransaction)?.transaction_number)}</p></div>`);
                  _push3(ssrRenderComponent(VDivider, null, null, _parent3, _scopeId2));
...
const smartpos = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-57e6fe9e"]]);

export { smartpos as default };
//# sourceMappingURL=smartpos-CaW8BASz.mjs.map
