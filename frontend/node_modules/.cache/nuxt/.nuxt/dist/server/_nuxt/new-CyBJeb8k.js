...
import { M as useToast, T as useRoute, u as useRouter, d as VIcon, g as VBtn, U as VForm, k as VCard, i as VRow, j as VCol, C as VTextField, W as VCombobox, X as VTextarea, O as VSelect, S as VCheckbox } from "../server.mjs";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "az-page" }, _attrs))} data-v-30dd5566><div class="az-exp-header" data-v-30dd5566><div class="az-exp-header__info" data-v-30dd5566><div class="az-exp-header__icon" data-v-30dd5566>`);
      ...
      _push(`</div><div data-v-30dd5566><h1 class="text-h5 font-weight-bold mb-1" data-v-30dd5566>${ssrInterpolate(unref(editing) ? "Edit Expense" : "New Expense")}</h1><p class="text-body-2 text-medium-emphasis ma-0" data-v-30dd5566>${ssrInterpolate(unref(editing) ? "Update expense details" : "Record a new business expense")}</p></div></div>`);
      ...
      _push(ssrRenderComponent(VForm, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="az-exp-layout__form" data-v-30dd5566${_scopeId}>`);
            _push2(ssrRenderComponent(VCard, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="az-exp-card__header" data-v-30dd5566${_scopeId2}><div class="az-exp-card__icon az-exp-card__icon--blue" data-v-30dd5566${_scopeId2}>`);
                  ...
                  _push3(`</div><span data-v-30dd5566${_scopeId2}>Expense Details</span></div>`);
            ...
            _push2(ssrRenderComponent(VCard, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="az-exp-card__header" data-v-30dd5566${_scopeId2}><div class="az-exp-card__icon az-exp-card__icon--green" data-v-30dd5566${_scopeId2}>`);
                  _push3(ssrRenderComponent(VIcon, { size: "18" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`mdi-cash`);
                  ...
                  _push3(`</div><span data-v-30dd5566${_scopeId2}>Amount &amp; Payment</span></div>`);
                  _push3(ssrRenderComponent(VRow, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(VCol, {
            ...
            _push2(ssrRenderComponent(VCard, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="az-exp-card__header" data-v-30dd5566${_scopeId2}><div class="az-exp-card__icon az-exp-card__icon--amber" data-v-30dd5566${_scopeId2}>`);
                  _push3(ssrRenderComponent(VIcon, { size: "18" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                  ...
                  _push3(`</div><span data-v-30dd5566${_scopeId2}>Status &amp; Options</span></div>`);
                  _push3(ssrRenderComponent(VRow, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(VCol, {
            ...
            _push2(`</div><div class="az-exp-layout__summary" data-v-30dd5566${_scopeId}>`);
            _push2(ssrRenderComponent(VCard, {
              variant: "outlined",
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="az-exp-summary__header" data-v-30dd5566${_scopeId2}><span class="text-caption text-uppercase font-weight-bold" data-v-30dd5566${_scopeId2}>Summary</span><span class="az-exp-summary__total" data-v-30dd5566${_scopeId2}>${ssrInterpolate(formatMoney(unref(summaryTotal)))}</span></div><div class="az-exp-summary__body" data-v-30dd5566${_scopeId2}><div class="az-exp-summary__stat" data-v-30dd5566${_scopeId2}><span class="text-caption text-medium-emphasis" data-v-30dd5566${_scopeId2}>Subtotal</span><span class="text-body-1 font-weight-bold" data-v-30dd5566${_scopeId2}>${ssrInterpolate(formatMoney(unref(form).amount))}</span></div><div class="az-exp-summary__stat" data-v-30dd5566${_scopeId2}><span class="text-caption text-medium-emphasis" data-v-30dd5566${_scopeId2}>Tax</span><span class="text-body-1 font-weight-bold" data-v-30dd5566${_scopeId2}>${ssrInterpolate(formatMoney(unref(form).tax))}</span></div><div class="az-exp-summary__stat" data-v-30dd5566${_scopeId2}><span class="text-caption text-medium-emphasis" data-v-30dd5566${_scopeId2}>Method</span><span class="text-body-1 font-weight-bold text-capitalize" data-v-30dd5566${_scopeId2}>${ssrInterpolate(unref(form).payment_method)}</span></div><div class="az-exp-summary__stat az-exp-summary__stat--total" data-v-30dd5566${_scopeId2}><span class="text-caption" style="${ssrRenderStyle({ "opacity": "0.85" })}" data-v-30dd5566${_scopeId2}>Total</span><span class="text-h6 font-weight-bold" data-v-30dd5566${_scopeId2}>${ssrInterpolate(formatMoney(unref(summaryTotal)))}</span></div></div><div class="az-exp-summary__actions" data-v-30dd5566${_scopeId2}>`);
...
const _new = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-30dd5566"]]);
export {
  _new as default
};
//# sourceMappingURL=new-CyBJeb8k.js.map
