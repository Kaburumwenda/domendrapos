import { defineComponent, ref, reactive, computed, mergeProps, withCtx, unref, createVNode, toDisplayString, createTextVNode, openBlock, createBlock, createCommentVNode, Fragment, renderList, useSSRContext } from "vue";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "lock-bg pa-4 pa-md-6" }, _attrs))} data-v-4e894a11><div class="mx-auto" style="${ssrRenderStyle({ "max-width": "960px" })}" data-v-4e894a11>`);
      _push(ssrRenderComponent(VCard, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="d-flex align-center flex-wrap ga-3" data-v-4e894a11${_scopeId}>`);
            _push2(ssrRenderComponent(VIcon, {
              icon: "mdi-lock-alert",
              size: "44"
            }, null, _parent2, _scopeId));
            _push2(`<div class="flex-grow-1" style="${ssrRenderStyle({ "min-width": "220px" })}" data-v-4e894a11${_scopeId}><div class="text-overline" style="${ssrRenderStyle({ "opacity": ".85" })}" data-v-4e894a11${_scopeId}>Service restricted</div><h1 class="text-h5 font-weight-bold ma-0" data-v-4e894a11${_scopeId}>Access temporarily restricted</h1><div class="text-body-2 mt-1" style="${ssrRenderStyle({ "opacity": ".9" })}" data-v-4e894a11${_scopeId}>${ssrInterpolate(statusReason.value || (tenantName.value || "Your organisation") + "'s account has overdue API usage bills. Settle them to restore access for your team.")}</div></div><div class="text-right" data-v-4e894a11${_scopeId}><div class="text-caption" style="${ssrRenderStyle({ "opacity": ".85" })}" data-v-4e894a11${_scopeId}>Overdue balance</div><div class="text-h4 font-weight-bold" data-v-4e894a11${_scopeId}>${ssrInterpolate(unref(fmtCurrency)(summary.value.total_overdue || overdueTotal.value))}</div></div></div>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(VAlert, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="font-weight-medium mb-1" data-v-4e894a11${_scopeId}>What this means</div><div class="text-body-2" data-v-4e894a11${_scopeId}> The service is paused for all staff until the outstanding balance is cleared. You can <strong data-v-4e894a11${_scopeId}>pay now</strong> using M-Pesa or wallet credit below, or <strong data-v-4e894a11${_scopeId}>contact your administrator or management</strong> to settle the account. </div>`);
          } else {
            return [
      ...
      if (data.value) {
                  ...
                  if (_push3) {
                    _push3(ssrRenderComponent(VCard, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="d-flex align-center justify-space-between" data-v-4e894a11${_scopeId3}><div class="text-caption text-medium-emphasis" data-v-4e894a11${_scopeId3}>Outstanding</div>`);
                          ...
                          _push4(`</div><div class="text-h6 font-weight-bold mt-1" data-v-4e894a11${_scopeId3}>${ssrInterpolate(unref(fmtCurrency)(summary.value.total_outstanding, data.value.currency))}</div><div class="text-caption text-medium-emphasis mt-1" data-v-4e894a11${_scopeId3}>${ssrInterpolate(summary.value.outstanding_count)} unpaid</div>`);
                        } else {
                          return [
                            ...
                            createVNode("div", { class: "text-h6 font-weight-bold mt-1" }, toDisplayString(unref(fmtCurrency)(summary.value.total_outstanding, data.value.currency)), 1),
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(VCard, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="d-flex align-center justify-space-between" data-v-4e894a11${_scopeId3}><div class="text-caption text-medium-emphasis" data-v-4e894a11${_scopeId3}>Overdue</div>`);
                          _push4(ssrRenderComponent(VIcon, {
                            size: "20",
                            color: "error"
                          }, {
                          ...
                          _push4(`</div><div class="text-h6 font-weight-bold mt-1" data-v-4e894a11${_scopeId3}>${ssrInterpolate(unref(fmtCurrency)(summary.value.total_overdue, data.value.currency))}</div><div class="text-caption text-medium-emphasis mt-1" data-v-4e894a11${_scopeId3}>${ssrInterpolate(summary.value.overdue_count)} overdue</div>`);
                        } else {
                          return [
                            createVNode("div", { class: "d-flex align-center justify-space-between" }, [
                            ...
                            createVNode("div", { class: "text-h6 font-weight-bold mt-1" }, toDisplayString(unref(fmtCurrency)(summary.value.total_overdue, data.value.currency)), 1),
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(ssrRenderComponent(VCard, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="d-flex align-center justify-space-between" data-v-4e894a11${_scopeId3}><div class="text-caption text-medium-emphasis" data-v-4e894a11${_scopeId3}>Wallet balance</div>`);
                          ...
                          _push4(`</div><div class="text-h6 font-weight-bold mt-1" data-v-4e894a11${_scopeId3}>${ssrInterpolate(unref(fmtCurrency)(data.value.wallet_balance, data.value.currency))}</div><div class="text-caption text-medium-emphasis mt-1" data-v-4e894a11${_scopeId3}>Pre-funded credit</div>`);
                        } else {
                          return [
                            createVNode("div", { class: "d-flex align-center justify-space-between" }, [
                            ...
                            createVNode("div", { class: "text-h6 font-weight-bold mt-1" }, toDisplayString(unref(fmtCurrency)(data.value.wallet_balance, data.value.currency)), 1),
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              if (billsToClear.value.length) {
                      ...
                      ssrRenderList(billsToClear.value, (b, i) => {
                        ...
                        _push3(ssrRenderComponent(VListItem, null, {
                          ...
                          append: withCtx((_3, _push4, _parent4, _scopeId3) => {
                            if (_push4) {
                              _push4(`<div class="d-flex ga-1" data-v-4e894a11${_scopeId3}>`);
                          ...
                          default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                            if (_push4) {
                              ...
                              _push4(ssrRenderComponent(VListItemSubtitle, null, {
                                default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                  if (_push5) {
                                    _push5(` Balance <strong data-v-4e894a11${_scopeId4}>${ssrInterpolate(unref(fmtCurrency)(b.balance ?? b.amount, b.currency))}</strong>`);
                                    if (b.due_date) {
                                      _push5(`<span data-v-4e894a11${_scopeId4}> · due ${ssrInterpolate(unref(fmtDate)(b.due_date))}</span>`);
                                    } else {
                                      _push5(`<!---->`);
                                    }
                                    if (Number(b.discount_amount) > 0) {
                                      _push5(`<span data-v-4e894a11${_scopeId4}> · ${ssrInterpolate(unref(fmtCurrency)(b.discount_amount, b.currency))} discount applied</span>`);
                                    } else {
                                      _push5(`<!---->`);
                                    }
                                  } else {
                                    return [
                                      ...
                                      createVNode("strong", null, toDisplayString(unref(fmtCurrency)(b.balance ?? b.amount, b.currency)), 1),
                                      b.due_date ? (openBlock(), createBlock("span", { key: 0 }, " · due " + toDisplayString(unref(fmtDate)(b.due_date)), 1)) : createCommentVNode("", true),
                                      Number(b.discount_amount) > 0 ? (openBlock(), createBlock("span", { key: 1 }, " · " + toDisplayString(unref(fmtCurrency)(b.discount_amount, b.currency)) + " discount applied", 1)) : createCommentVNode("", true)
                                    ];
                                  }
                                }),
                                _: 2
                ...
                _push2(`<div class="text-center py-8" data-v-4e894a11${_scopeId}>`);
                _push2(ssrRenderComponent(VIcon, {
                  size: "48",
                  color: "success",
                  class: "mb-3"
                ...
                _push2(`<div class="text-h6 font-weight-bold mb-2" data-v-4e894a11${_scopeId}>All bills settled!</div>`);
        ...
        _push(`<div class="d-flex justify-space-between flex-wrap ga-2" data-v-4e894a11>`);
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(ssrRenderComponent(VCardText, null, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="d-flex justify-space-between mb-1" data-v-4e894a11${_scopeId3}><span class="text-medium-emphasis" data-v-4e894a11${_scopeId3}>Bill amount</span><span class="font-weight-bold" data-v-4e894a11${_scopeId3}>${ssrInterpolate(unref(fmtCurrency)(payTarget.value.amount, payTarget.value.currency))}</span></div><div class="d-flex justify-space-between mb-3" data-v-4e894a11${_scopeId3}><span class="text-medium-emphasis" data-v-4e894a11${_scopeId3}>Balance due</span><span class="font-weight-bold text-warning" data-v-4e894a11${_scopeId3}>${ssrInterpolate(unref(fmtCurrency)(billBalance.value, payTarget.value.currency))}</span></div><div class="text-caption text-medium-emphasis mb-1" data-v-4e894a11${_scopeId3}>Payment method</div>`);
                                                  ...
                                                  _push8(ssrRenderComponent(VCard, {
                                                    ...
                                                    default: withCtx((_7, _push9, _parent9, _scopeId8) => {
                                                      if (_push9) {
                                                        ...
                                                        _push9(`<div class="text-caption mt-1" data-v-4e894a11${_scopeId8}>M-Pesa</div>`);
                                                      } else {
                                                        return [
                                                          createVNode(VIcon, {
                                                            size: "26",
                                                  ...
                                                  _push8(ssrRenderComponent(VCard, {
                                                    ...
                                                    default: withCtx((_7, _push9, _parent9, _scopeId8) => {
                                                      if (_push9) {
                                                        ...
                                                        _push9(`<div class="text-caption mt-1" data-v-4e894a11${_scopeId8}>Wallet</div><div class="text-caption text-medium-emphasis" data-v-4e894a11${_scopeId8}>${ssrInterpolate(unref(fmtCurrency)(data.value?.wallet_balance, data.value?.currency))}</div>`);
                                                      } else {
                                                        return [
                                                          createVNode(VIcon, {
                                                            size: "26",
                                                          ...
                                                          createVNode("div", { class: "text-caption text-medium-emphasis" }, toDisplayString(unref(fmtCurrency)(data.value?.wallet_balance, data.value?.currency)), 1)
                                                        ];
                                                      }
                                                    }),
                                                    _: 2
                          ...
                          _push4(ssrRenderComponent(VTextField, {
                            ...
                            variant: "outlined",
                            density: "comfortable",
                            prefix: payTarget.value.currency,
                            hint: `You can pay part of the balance (max ${unref(fmtCurrency)(billBalance.value, payTarget.value.currency)})`,
                            "persistent-hint": "",
                            class: "mb-2"
                          ...
                          return [
                            createVNode("div", { class: "d-flex justify-space-between mb-1" }, [
                              ...
                              createVNode("span", { class: "font-weight-bold" }, toDisplayString(unref(fmtCurrency)(payTarget.value.amount, payTarget.value.currency)), 1)
                            ]),
                            createVNode("div", { class: "d-flex justify-space-between mb-3" }, [
                              createVNode("span", { class: "text-medium-emphasis" }, "Balance due"),
                              createVNode("span", { class: "font-weight-bold text-warning" }, toDisplayString(unref(fmtCurrency)(billBalance.value, payTarget.value.currency)), 1)
                            ]),
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(ssrRenderComponent(VCardText, null, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="d-flex justify-space-between mb-3" data-v-4e894a11${_scopeId3}><span class="text-medium-emphasis" data-v-4e894a11${_scopeId3}>Balance due</span><span class="font-weight-bold text-warning" data-v-4e894a11${_scopeId3}>${ssrInterpolate(unref(fmtCurrency)(couponTarget.value.balance ?? couponTarget.value.amount, couponTarget.value.currency))}</span></div>`);
                          _push4(ssrRenderComponent(VTextField, {
                          ...
                          return [
                            createVNode("div", { class: "d-flex justify-space-between mb-3" }, [
                              createVNode("span", { class: "text-medium-emphasis" }, "Balance due"),
                              createVNode("span", { class: "font-weight-bold text-warning" }, toDisplayString(unref(fmtCurrency)(couponTarget.value.balance ?? couponTarget.value.amount, couponTarget.value.currency)), 1)
                            ]),
                            createVNode(VTextField, {
                              modelValue: couponCode.value,
                              "onUpdate:modelValue": ($event) => couponCode.value = $event,
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        if (mpesa.state === "processing") {
                          ...
                          _push4(`<div class="text-h6 font-weight-bold mb-1" data-v-4e894a11${_scopeId3}>Awaiting your confirmation</div><p class="text-body-2 text-medium-emphasis mb-2" data-v-4e894a11${_scopeId3}> Check your phone and enter your M-Pesa PIN to authorise the payment. </p>`);
                          ...
                          _push4(`<div class="text-caption text-medium-emphasis" data-v-4e894a11${_scopeId3}>`);
                          ...
                          _push4(`<div class="text-h6 font-weight-bold mb-1" data-v-4e894a11${_scopeId3}>Payment successful</div><p class="text-body-2 text-medium-emphasis" data-v-4e894a11${_scopeId3}>${ssrInterpolate(mpesa.message)}</p><!--]-->`);
                          ...
                          _push4(`<div class="text-h6 font-weight-bold mb-1" data-v-4e894a11${_scopeId3}>Payment not completed</div><p class="text-body-2 text-medium-emphasis" data-v-4e894a11${_scopeId3}>${ssrInterpolate(mpesa.message)}</p><!--]-->`);
                        } else {
                          _push4(`<!---->`);
                        }
                      } else {
...
const locked = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-4e894a11"]]);
export {
  locked as default
};
//# sourceMappingURL=locked-DEUJnSB3.js.map
