...
import { defineComponent, ref, computed, mergeProps, withCtx, createTextVNode, unref, toDisplayString, createVNode, useSSRContext } from "vue";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(loading) && unref(stats) === null) {
        ...
        _push(`</div></div><p class="sa-kpi__value">${ssrInterpolate(unref(stats)?.total_tenants ?? 0)}</p><div class="sa-kpi__sub"><span class="sa-kpi__delta sa-kpi__delta--up">`);
        ...
        _push(` ${ssrInterpolate(unref(stats)?.new_this_month ?? 0)} new this month </span></div></div><div class="sa-kpi"><div class="sa-kpi__top"><span class="sa-kpi__label">Active</span><div class="sa-kpi__icon sa-kpi__icon--success">`);
        _push(ssrRenderComponent(VIcon, { size: "20" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
        ...
        _push(`</div></div><p class="sa-kpi__value text-success">${ssrInterpolate(unref(stats)?.active ?? 0)}</p><div class="sa-kpi__sub">${ssrInterpolate(unref(activePct))}% of all tenants</div></div><div class="sa-kpi"><div class="sa-kpi__top"><span class="sa-kpi__label">On Trial</span><div class="sa-kpi__icon sa-kpi__icon--info">`);
        _push(ssrRenderComponent(VIcon, { size: "20" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
        ...
        _push(`</div></div><p class="sa-kpi__value text-info">${ssrInterpolate(unref(stats)?.trial ?? 0)}</p><div class="sa-kpi__sub">${ssrInterpolate(unref(stats)?.trial_expiring ?? 0)} expiring soon</div></div><div class="sa-kpi"><div class="sa-kpi__top"><span class="sa-kpi__label">Est. Monthly Revenue</span><div class="sa-kpi__icon sa-kpi__icon--teal">`);
        _push(ssrRenderComponent(VIcon, { size: "20" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
        ...
        _push(`</div></div><p class="sa-kpi__value">KSh ${ssrInterpolate(formatNum(unref(stats)?.mrr_estimate ?? 0))}</p><div class="sa-kpi__sub">Projected MRR across active plans</div></div><div class="sa-kpi"><div class="sa-kpi__top"><span class="sa-kpi__label">Suspended</span><div class="sa-kpi__icon sa-kpi__icon--warning">`);
        _push(ssrRenderComponent(VIcon, { size: "20" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
        ...
        _push(`</div></div><p class="sa-kpi__value text-warning">${ssrInterpolate(unref(stats)?.suspended ?? 0)}</p><div class="sa-kpi__sub">Temporarily disabled</div></div><div class="sa-kpi"><div class="sa-kpi__top"><span class="sa-kpi__label">Cancelled</span><div class="sa-kpi__icon sa-kpi__icon--error">`);
        _push(ssrRenderComponent(VIcon, { size: "20" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
        ...
        _push(`</div></div><p class="sa-kpi__value text-error">${ssrInterpolate(unref(stats)?.cancelled ?? 0)}</p><div class="sa-kpi__sub">No longer active</div></div><div class="sa-kpi"><div class="sa-kpi__top"><span class="sa-kpi__label">New This Month</span><div class="sa-kpi__icon sa-kpi__icon--accent">`);
        _push(ssrRenderComponent(VIcon, { size: "20" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
        ...
        _push(`</div></div><p class="sa-kpi__value">${ssrInterpolate(unref(stats)?.new_this_month ?? 0)}</p><div class="sa-kpi__sub">Tenants onboarded in ${ssrInterpolate(unref(monthName))}</div></div><div class="sa-kpi"><div class="sa-kpi__top"><span class="sa-kpi__label">Trial Expiring</span><div class="sa-kpi__icon sa-kpi__icon--warning">`);
        _push(ssrRenderComponent(VIcon, { size: "20" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
        ...
        _push(`</div></div><p class="sa-kpi__value text-warning">${ssrInterpolate(unref(stats)?.trial_expiring ?? 0)}</p><div class="sa-kpi__sub">Within 3 days — follow up</div></div></div><div class="sa-two-col"><div class="sa-card"><div class="sa-card__header"><div class="sa-card__header-icon sa-card__header-icon--indigo">`);
        _push(ssrRenderComponent(VIcon, { size: "20" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
        ...
        ssrRenderList(unref(recentTenants), (t) => {
          _push(`<div class="sa-tenant-row"><div class="sa-tenant-row__avatar" style="${ssrRenderStyle(avatarStyle(t.name))}">${ssrInterpolate(t.name?.charAt(0)?.toUpperCase())}</div><div class="flex-grow-1" style="${ssrRenderStyle({ "min-width": "0" })}"><p class="sa-tenant-row__name" style="${ssrRenderStyle({ "overflow": "hidden", "text-overflow": "ellipsis", "white-space": "nowrap" })}">${ssrInterpolate(t.name)}</p><p class="sa-tenant-row__meta">${ssrInterpolate(t.contact_email || "—")} · ${ssrInterpolate(formatDate(t.created_on))}</p></div>`);
          _push(ssrRenderComponent(VChip, {
...
//# sourceMappingURL=index-B9Fd2_jF.js.map
