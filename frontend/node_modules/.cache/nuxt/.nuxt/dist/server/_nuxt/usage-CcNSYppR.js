import { ref, computed, resolveComponent, mergeProps, withCtx, createTextVNode, unref, toDisplayString, isRef, createVNode, useSSRContext } from "vue";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const usageAnalysisSeries = computed(() => {
      ...
      const rpu = Number(analysisRate.value?.requests_per_unit) || 1e3;
      let cum = 0;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(data)) {
        ...
        _push(`</div><div data-v-5e790350><div class="az-highlight__title" data-v-5e790350>Previous Month</div><div class="az-highlight__sub" data-v-5e790350>${ssrInterpolate(fmt(unref(data).comparison.previous_month.total_requests))} req · ${ssrInterpolate(unref(fmtCurrency)(unref(data).comparison.previous_month.cost))}</div></div></div><div class="az-highlight" data-v-5e790350><div class="az-highlight__icon az-highlight__icon--success" data-v-5e790350>`);
        _push(ssrRenderComponent(VIcon, null, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
...
//# sourceMappingURL=usage-CcNSYppR.js.map
