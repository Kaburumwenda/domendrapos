import { executeAsync } from 'file://D:/Projects/MY-APPS-2/DomendraPOS/frontend/node_modules/unctx/dist/index.mjs';
...
import 'file://D:/Projects/MY-APPS-2/DomendraPOS/frontend/node_modules/vue/index.mjs';
...
import 'file://D:/Projects/MY-APPS-2/DomendraPOS/frontend/node_modules/vue/server-renderer/index.mjs';
import '../_/nitro.mjs';
    ...
    try {
      ...
      if (parts.length >= 2) {
        ...
        auth2.user = {
          ...
          email: payload.email || "",
          first_name: ((_a = payload.name) == null ? void 0 : _a.split(" ")[0]) || "",
          last_name: ((_b = payload.name) == null ? void 0 : _b.split(" ").slice(1).join(" ")) || "",
...
//# sourceMappingURL=auth-B6Az8-Q6.mjs.map
