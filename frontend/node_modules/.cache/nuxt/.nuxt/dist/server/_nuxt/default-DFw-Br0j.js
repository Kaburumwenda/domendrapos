...
import { defineComponent, mergeProps, unref, useSSRContext, nextTick, getCurrentScope, onScopeDispose, watch, getCurrentInstance, computed, shallowRef, toValue, ref, withCtx, createTextVNode, toDisplayString, createVNode, openBlock, createBlock, createCommentVNode, Fragment, renderList, withModifiers, renderSlot } from "vue";
...
import { J as VSelect, _ as _export_sfc, z as useCookie, ar as useTheme$1, E as useRoute, al as VApp, a2 as VNavigationDrawer, a as VIcon, as as VAppBar, at as VAppBarNavIcon, b as VSpacer, c as VBtn, C as VMenu, M as VList, k as VDivider, N as VListItem, H as VAvatar, am as VMain, V as VContainer, A as useRuntimeConfig } from "../server.mjs";
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(VList, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="px-4 py-2" data-v-36979901${_scopeId4}><p class="text-body-2 font-weight-bold" data-v-36979901${_scopeId4}>${ssrInterpolate(unref(auth).fullName)}</p><p class="text-caption text-medium-emphasis" data-v-36979901${_scopeId4}>${ssrInterpolate(unref(auth).user?.email)}</p></div>`);
...
//# sourceMappingURL=default-DFw-Br0j.js.map
