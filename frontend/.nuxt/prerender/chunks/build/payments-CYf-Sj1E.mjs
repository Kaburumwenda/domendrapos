import { defineComponent, computed, ref, reactive, mergeProps, withCtx, createTextVNode, toDisplayString, unref, createVNode, openBlock, createBlock, createCommentVNode, Fragment, useSSRContext } from 'file://D:/Projects/MY-APPS-2/DomendraPOS/frontend/node_modules/vue/index.mjs';
import { ssrRenderComponent, ssrInterpolate, ssrRenderClass } from 'file://D:/Projects/MY-APPS-2/DomendraPOS/frontend/node_modules/vue/server-renderer/index.mjs';
...
import { _ as _export_sfc, V as VContainer, a as VIcon, b as VSpacer, c as VBtn, d as VAlert, e as VRow, f as VCol, g as VCard, h as VTabs, i as VTab, j as VBadge, k as VDivider, l as VTabsWindow, m as VTabsWindowItem, n as VDataTable, o as VChip, p as VProgressLinear, q as VDialog, r as VCardTitle, s as VCardText, t as VItemGroup, u as VItem, v as VTextField, w as VCardActions, x as VProgressCircular } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function openAddFunds() {
      ...
      fundsAmount.value = 0;
      fundsPhone.value = ((_a = data.value) == null ? void 0 : _a.phone) || "";
    ...
    async function confirmAddFunds() {
      ...
      try {
        ...
        fundsError.value = ((_a = e == null ? void 0 : e.data) == null ? void 0 : _a.detail) || e.message || "Could not start payment.";
      } finally {
        paying.value = false;
      }
    }
    ...
    async function load() {
      ...
      try {
        ...
        error.value = ((_a = e == null ? void 0 : e.data) == null ? void 0 : _a.detail) || e.message || "Failed to load payments.";
      } finally {
        loading.value = false;
      }
    }
                              ...
                              if (_push5) {
                                _push5(ssrRenderComponent(VDataTable, {
                                  ...
                                  "item.balance": withCtx(({ item }, _push6, _parent6, _scopeId5) => {
                                    var _a, _b;
                                    if (_push6) {
                                      _push6(`<span class="font-weight-medium" data-v-a6648732${_scopeId5}>${ssrInterpolate(unref(fmtCurrency)((_a = item.balance) != null ? _a : item.amount))}</span>`);
                                    } else {
                                      return [
                                        createVNode("span", { class: "font-weight-medium" }, toDisplayString(unref(fmtCurrency)((_b = item.balance) != null ? _b : item.amount)), 1)
                                      ];
                                    }
                                  }),
                                ...
                                return [
                                  createVNode(VDataTable, {
                                    ...
                                    "item.balance": withCtx(({ item }) => {
                                      var _a;
                                      return [
                                        createVNode("span", { class: "font-weight-medium" }, toDisplayString(unref(fmtCurrency)((_a = item.balance) != null ? _a : item.amount)), 1)
                                      ];
                                    }),
...
//# sourceMappingURL=payments-CYf-Sj1E.mjs.map
