import { defineComponent, ref, reactive, computed, mergeProps, withCtx, createTextVNode, unref, toDisplayString, isRef, createVNode, openBlock, createBlock, createCommentVNode, withDirectives, vModelText, Fragment, renderList, vModelSelect, vModelCheckbox, useSSRContext } from "vue";
...
import { D as useToast, a as VIcon, q as VDialog, g as VCard, c as VBtn, k as VDivider, x as VProgressCircular, _ as _export_sfc } from "../server.mjs";
            ...
            _push2(ssrRenderComponent(VCard, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`</div><div class="flex-1" data-v-8a6a1a9d${_scopeId2}><h3 class="staff-dialog__title" data-v-8a6a1a9d${_scopeId2}>Reset Password</h3><p class="staff-dialog__sub" data-v-8a6a1a9d${_scopeId2}>Set a new password for ${ssrInterpolate(unref(resetPwTarget)?.first_name)} ${ssrInterpolate(unref(resetPwTarget)?.last_name)}</p></div>`);
                  _push3(ssrRenderComponent(VBtn, {
                    icon: "mdi-close",
                    variant: "text",
                    size: "small",
                  ...
                  return [
                    createVNode("div", { class: "staff-dialog__header" }, [
                      ...
                      createVNode("div", { class: "flex-1" }, [
                        ...
                        createVNode("p", { class: "staff-dialog__sub" }, "Set a new password for " + toDisplayString(unref(resetPwTarget)?.first_name) + " " + toDisplayString(unref(resetPwTarget)?.last_name), 1)
                      ]),
                      createVNode(VBtn, {
                        icon: "mdi-close",
                        variant: "text",
            ...
            _push2(ssrRenderComponent(VCard, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`</div>`);
                  _push3(ssrRenderComponent(VDivider, null, null, _parent3, _scopeId2));
                  _push3(`<div class="staff-dialog__body" data-v-8a6a1a9d${_scopeId2}><div class="staff-delete-info" data-v-8a6a1a9d${_scopeId2}><div class="staff-avatar staff-avatar--grey" style="${ssrRenderStyle({ "width": "48px", "height": "48px", "font-size": "0.875rem" })}" data-v-8a6a1a9d${_scopeId2}><span data-v-8a6a1a9d${_scopeId2}>${ssrInterpolate(unref(deleteTarget) ? initials(unref(deleteTarget)) : "")}</span></div><div data-v-8a6a1a9d${_scopeId2}><p class="staff-delete-info__name" data-v-8a6a1a9d${_scopeId2}>${ssrInterpolate(unref(deleteTarget) ? fullName(unref(deleteTarget)) : "")}</p><p class="staff-delete-info__email" data-v-8a6a1a9d${_scopeId2}>${ssrInterpolate(unref(deleteTarget)?.email)}</p></div></div><label class="staff-delete-check" data-v-8a6a1a9d${_scopeId2}><input type="checkbox"${ssrIncludeBooleanAttr(Array.isArray(unref(hardDelete)) ? ssrLooseContain(unref(hardDelete), null) : unref(hardDelete)) ? " checked" : ""} class="staff-checkbox" data-v-8a6a1a9d${_scopeId2}><span data-v-8a6a1a9d${_scopeId2}>Permanently delete this user (cannot be undone)</span></label></div>`);
                  _push3(ssrRenderComponent(VDivider, null, null, _parent3, _scopeId2));
                  ...
                  return [
                    createVNode("div", { class: "staff-dialog__header" }, [
                      ...
                      createVNode("div", { class: "flex-1" }, [
                        ...
                        createVNode("p", { class: "staff-dialog__sub" }, "This will deactivate " + toDisplayString(unref(deleteTarget)?.first_name) + " " + toDisplayString(unref(deleteTarget)?.last_name) + ". You can optionally permanently delete them.", 1)
                      ]),
                      createVNode(VBtn, {
                        icon: "mdi-close",
                        variant: "text",
                    ...
                    createVNode("div", { class: "staff-dialog__body" }, [
                      createVNode("div", { class: "staff-delete-info" }, [
                        ...
                        createVNode("div", null, [
                          ...
                          createVNode("p", { class: "staff-delete-info__email" }, toDisplayString(unref(deleteTarget)?.email), 1)
                        ])
                      ]),
...
//# sourceMappingURL=staff-D42RjoC_.js.map
