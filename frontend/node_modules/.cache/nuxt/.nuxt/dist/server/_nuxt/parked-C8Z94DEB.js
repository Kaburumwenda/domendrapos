                      ...
                      _push3(ssrRenderComponent(VCard, {
                        ...
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            ...
                            _push4(` ${ssrInterpolate(new Date(p.created_at).toLocaleString())}</p><div class="d-flex justify-space-between align-center mt-2"${_scopeId3}><span class="text-h6 font-weight-bold text-primary"${_scopeId3}>${ssrInterpolate(formatMoney(p.total))}</span><div class="d-flex ga-1"${_scopeId3}>`);
...
//# sourceMappingURL=parked-C8Z94DEB.js.map
