                            ...
                            if (_push4) {
                              ...
                              _push4(ssrRenderComponent(VListItemSubtitle, null, {
                                default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                  var _a, _b;
                                  if (_push5) {
                                    _push5(` Balance <strong data-v-f44a6b7e${_scopeId4}>${ssrInterpolate(unref(fmtCurrency)((_a = b.balance) != null ? _a : b.amount))}</strong>`);
                                    if (b.due_date) {
                                      _push5(`<span data-v-f44a6b7e${_scopeId4}> \xB7 due ${ssrInterpolate(unref(fmtDate)(b.due_date))}</span>`);
                                    } else {
                                      _push5(`<!---->`);
                                    }
                                    if (Number(b.discount_amount) > 0) {
                                      _push5(`<span data-v-f44a6b7e${_scopeId4}> \xB7 ${ssrInterpolate(unref(fmtCurrency)(b.discount_amount))} discount applied</span>`);
                                    } else {
                                      _push5(`<!---->`);
                                    }
                                  } else {
                                                  ...
                                                  _push8(ssrRenderComponent(VCard, {
                                                    ...
                                                    default: withCtx((_7, _push9, _parent9, _scopeId8) => {
                                                      ...
                                                      if (_push9) {
                                                        ...
                                                        _push9(`<div class="text-caption mt-1" data-v-f44a6b7e${_scopeId8}>Wallet</div><div class="text-caption text-medium-emphasis" data-v-f44a6b7e${_scopeId8}>${ssrInterpolate(unref(fmtCurrency)((_a2 = data.value) == null ? void 0 : _a2.wallet_balance))}</div>`);
                                                      } else {
                                                        return [
                                                          createVNode(VIcon, {
                                                            size: "26",
...
//# sourceMappingURL=locked-DuIr1UGC.mjs.map
