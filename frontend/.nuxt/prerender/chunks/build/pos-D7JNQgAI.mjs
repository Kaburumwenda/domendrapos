import { defineComponent, computed, mergeProps, withCtx, createTextVNode, unref, useSSRContext } from 'file://D:/Projects/MY-APPS-2/DomendraPOS/frontend/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderList } from 'file://D:/Projects/MY-APPS-2/DomendraPOS/frontend/node_modules/vue/server-renderer/index.mjs';
import { u as useFormat } from './useFormat-BvVWDMYe.mjs';
import { a as useAuthStore } from './useApi-D4YG8JPQ.mjs';
import { _ as _export_sfc, a as VIcon } from './server.mjs';
...
const usePosStore = defineStore("pos", {
  ...
  actions: {
    addToCart(product) {
      var _a, _b;
      const stockUnits = Number((_b = (_a = product.quantity_on_hand) != null ? _a : product.quantity) != null ? _b : 0);
...
export { __nuxt_component_0 as _, usePosStore as u };
//# sourceMappingURL=pos-D7JNQgAI.mjs.map
