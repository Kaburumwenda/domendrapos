...
import { _ as _export_sfc, e as VRow, f as VCol, o as VChip, a as VIcon, c as VBtn, y as navigateTo, g as VCard, d as VAlert, k as VDivider, M as VList, N as VListItem, n as VDataTable, aa as VExpansionPanels, ab as VExpansionPanel, ac as VExpansionPanelTitle, ad as VExpansionPanelText, b as VSpacer, a8 as __nuxt_component_1$1, a3 as VTimeline, a4 as VTimelineItem, a9 as VExpandTransition } from './server.mjs';
import { defineComponent, withCtx, createTextVNode, createVNode, unref, toDisplayString, openBlock, createBlock, Fragment, renderList, ref, mergeProps, computed, createCommentVNode, withDirectives, vShow, resolveComponent, useSSRContext } from 'file://D:/Projects/MY-APPS-2/DomendraPOS/frontend/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderStyle, ssrRenderList, ssrInterpolate, ssrRenderAttr } from 'file://D:/Projects/MY-APPS-2/DomendraPOS/frontend/node_modules/vue/server-renderer/index.mjs';
...
const dashboardSnap = "" + buildAssetsURL("snapshot-dashboard.BF2d59YY.svg");
const posSnap = "" + buildAssetsURL("snapshot-pos.T285eseg.svg");
const inventorySnap = "" + buildAssetsURL("snapshot-inventory.CQ4ZBlJt.svg");
const reportsSnap = "" + buildAssetsURL("snapshot-reports.COV62vg3.svg");
const iamSnap = "" + buildAssetsURL("snapshot-iam.BZvJzsRS.svg");
const auditSnap = "" + buildAssetsURL("snapshot-audit.V1CFQsHZ.svg");
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const inventoryConcepts = [
      ...
      { title: "Stock value", text: "On-hand \xD7 cost price, shown per branch and in total.", icon: "mdi-cash", color: "success" },
...
//# sourceMappingURL=docs-D2ZaMwZ_.mjs.map
