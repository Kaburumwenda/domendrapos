...
import { M as useToast, d as VIcon, g as VBtn, E as VProgressCircular, C as VTextField, O as VSelect, v as VChip, x as VDialog, k as VCard, y as VCardTitle, z as VCardText, X as VTextarea, D as VCardActions, f as VSpacer, t as VDataTable } from "../server.mjs";
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "az-page" }, _attrs))} data-v-5d4104ec><div class="az-header" data-v-5d4104ec><div class="az-header__left" data-v-5d4104ec><div class="az-header__title-icon az-header__title-icon--primary" data-v-5d4104ec>`);
      ...
      _push(`</div><div data-v-5d4104ec><h1 class="text-h5 font-weight-bold" data-v-5d4104ec>Customer Credit Accounts</h1><p class="text-body-2 text-medium-emphasis" data-v-5d4104ec>Track, collect and manage customer credit balances</p></div></div><div class="az-header__actions" data-v-5d4104ec>`);
      ...
      if (unref(loading) && unref(credits).length === 0) {
        _push(`<div class="az-loading" data-v-5d4104ec>`);
        ...
        _push(`<p class="text-body-2 text-medium-emphasis mt-3" data-v-5d4104ec>Loading credit accounts…</p></div>`);
      } else {
        _push(`<!--[--><div class="az-kpi-grid" data-v-5d4104ec><div class="az-kpi az-kpi--error" data-v-5d4104ec><div class="az-kpi__icon az-kpi__icon--error" data-v-5d4104ec>`);
        ...
        _push(`</div><div class="az-kpi__body" data-v-5d4104ec><p class="az-kpi__label" data-v-5d4104ec>Total Outstanding</p><p class="az-kpi__value text-error" data-v-5d4104ec>${ssrInterpolate(formatMoney(unref(kpis).outstanding))}</p><p class="az-kpi__sub" data-v-5d4104ec>${ssrInterpolate(unref(kpis).openCount)} open accounts</p></div></div><div class="az-kpi az-kpi--success" data-v-5d4104ec><div class="az-kpi__icon az-kpi__icon--success" data-v-5d4104ec>`);
        _push(ssrRenderComponent(VIcon, { size: "20" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
        ...
        _push(`</div><div class="az-kpi__body" data-v-5d4104ec><p class="az-kpi__label" data-v-5d4104ec>Total Collected</p><p class="az-kpi__value text-success" data-v-5d4104ec>${ssrInterpolate(formatMoney(unref(kpis).collected))}</p><p class="az-kpi__sub" data-v-5d4104ec>${ssrInterpolate(unref(kpis).settledCount)} settled accounts</p></div></div><div class="az-kpi az-kpi--info" data-v-5d4104ec><div class="az-kpi__icon az-kpi__icon--info" data-v-5d4104ec>`);
        _push(ssrRenderComponent(VIcon, { size: "20" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
        ...
        _push(`</div><div class="az-kpi__body" data-v-5d4104ec><p class="az-kpi__label" data-v-5d4104ec>Total Credit Extended</p><p class="az-kpi__value text-info" data-v-5d4104ec>${ssrInterpolate(formatMoney(unref(kpis).totalCredit))}</p><p class="az-kpi__sub" data-v-5d4104ec>${ssrInterpolate(unref(kpis).totalCount)} transactions</p></div></div><div class="az-kpi az-kpi--warning" data-v-5d4104ec><div class="az-kpi__icon az-kpi__icon--warning" data-v-5d4104ec>`);
        _push(ssrRenderComponent(VIcon, { size: "20" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
        ...
        _push(`</div><div class="az-kpi__body" data-v-5d4104ec><p class="az-kpi__label" data-v-5d4104ec>Overdue</p><p class="az-kpi__value text-warning" data-v-5d4104ec>${ssrInterpolate(formatMoney(unref(kpis).overdueAmount))}</p><p class="az-kpi__sub" data-v-5d4104ec>${ssrInterpolate(unref(kpis).overdueCount)} accounts overdue</p></div></div><div class="az-kpi az-kpi--purple" data-v-5d4104ec><div class="az-kpi__icon az-kpi__icon--purple" data-v-5d4104ec>`);
        _push(ssrRenderComponent(VIcon, { size: "20" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
        ...
        _push(`</div><div class="az-kpi__body" data-v-5d4104ec><p class="az-kpi__label" data-v-5d4104ec>Collection Rate</p><p class="az-kpi__value" style="${ssrRenderStyle({ "color": "#7C4DFF" })}" data-v-5d4104ec>${ssrInterpolate(unref(kpis).collectionRate)}%</p><p class="az-kpi__sub" data-v-5d4104ec>${ssrInterpolate(unref(kpis).partialCount)} partial payments</p></div></div><div class="az-kpi az-kpi--teal" data-v-5d4104ec><div class="az-kpi__icon az-kpi__icon--teal" data-v-5d4104ec>`);
        _push(ssrRenderComponent(VIcon, { size: "20" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
        ...
        _push(`</div><div class="az-kpi__body" data-v-5d4104ec><p class="az-kpi__label" data-v-5d4104ec>Avg Days to Collect</p><p class="az-kpi__value" style="${ssrRenderStyle({ "color": "#00B8D4" })}" data-v-5d4104ec>${ssrInterpolate(unref(kpis).avgDays)}</p><p class="az-kpi__sub" data-v-5d4104ec>across settled accounts</p></div></div></div><div class="az-chart-row az-chart-row--first" data-v-5d4104ec><div class="az-card az-card--two-thirds" data-v-5d4104ec><div class="az-card__header" data-v-5d4104ec><div class="az-card__header-icon az-card__header-icon--blue" data-v-5d4104ec>`);
        _push(ssrRenderComponent(VIcon, { size: "20" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
        ...
        _push(`</div><div data-v-5d4104ec><h3 class="az-card__title" data-v-5d4104ec>Credit Outstanding Trend</h3><p class="az-card__subtitle" data-v-5d4104ec>Outstanding balance over time</p></div></div><div class="az-card__body" data-v-5d4104ec>`);
        ...
        _push(`</div></div><div class="az-card az-card--third" data-v-5d4104ec><div class="az-card__header" data-v-5d4104ec><div class="az-card__header-icon az-card__header-icon--rose" data-v-5d4104ec>`);
        _push(ssrRenderComponent(VIcon, { size: "20" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
        ...
        _push(`</div><div data-v-5d4104ec><h3 class="az-card__title" data-v-5d4104ec>By Status</h3><p class="az-card__subtitle" data-v-5d4104ec>Distribution of credit accounts</p></div></div><div class="az-card__body" data-v-5d4104ec>`);
        _push(ssrRenderComponent(_component_apexchart, {
          type: "donut",
          height: "300",
        ...
        _push(`</div></div></div><div class="az-aging-wrap" data-v-5d4104ec><div class="az-aging-title" data-v-5d4104ec>`);
        ...
        _push(`<span data-v-5d4104ec>Receivables Aging Analysis</span></div><div class="az-aging-grid" data-v-5d4104ec><!--[-->`);
        ssrRenderList(unref(agingBuckets), (b) => {
          _push(`<div class="az-aging-bucket" data-v-5d4104ec><div class="az-aging-bucket__bar" style="${ssrRenderStyle({ background: b.color })}" data-v-5d4104ec></div><div class="az-aging-bucket__body" data-v-5d4104ec><p class="az-aging-bucket__label" data-v-5d4104ec>${ssrInterpolate(b.label)}</p><p class="az-aging-bucket__value" style="${ssrRenderStyle({ color: b.color })}" data-v-5d4104ec>${ssrInterpolate(formatMoney(b.amount))}</p><p class="az-aging-bucket__count" data-v-5d4104ec>${ssrInterpolate(b.count)} accounts</p></div></div>`);
        });
        _push(`<!--]--></div></div><div class="az-filters" data-v-5d4104ec>`);
        ...
        _push(`</div><div class="az-tabs" data-v-5d4104ec><!--[-->`);
        ssrRenderList(unref(tabs), (tab) => {
          _push(`<button class="${ssrRenderClass([{ "az-tab--active": unref(activeTab) === tab.id }, "az-tab"])}" data-v-5d4104ec>`);
          _push(ssrRenderComponent(VIcon, {
            size: "18",
            class: "mr-1"
          }, {
          ...
          _push(` ${ssrInterpolate(tab.label)} <span class="az-tab__badge" data-v-5d4104ec>${ssrInterpolate(tab.count)}</span></button>`);
        });
        _push(`<!--]--></div><div class="az-table-wrap" data-v-5d4104ec><table class="az-table" data-v-5d4104ec><thead data-v-5d4104ec><tr data-v-5d4104ec><th data-v-5d4104ec>Customer</th><th data-v-5d4104ec>Transaction #</th><th data-v-5d4104ec>Date</th><th class="text-right" data-v-5d4104ec>Total</th><th class="text-right" data-v-5d4104ec>Paid</th><th class="text-right" data-v-5d4104ec>Balance</th><th data-v-5d4104ec>Progress</th><th data-v-5d4104ec>Due Date</th><th data-v-5d4104ec>Status</th><th data-v-5d4104ec></th></tr></thead><tbody data-v-5d4104ec><!--[-->`);
        ssrRenderList(unref(pagedItems), (c) => {
          _push(`<tr class="az-table__row" data-v-5d4104ec><td data-v-5d4104ec><div class="az-customer-cell" data-v-5d4104ec><div class="${ssrRenderClass([`az-avatar--${avatarColor(c.customer_name)}`, "az-avatar"])}" data-v-5d4104ec>${ssrInterpolate(initials(c.customer_name))}</div><div data-v-5d4104ec><div class="font-weight-medium" data-v-5d4104ec>${ssrInterpolate(c.customer_name)}</div>`);
          if (c.customer_phone) {
            _push(`<div class="text-caption text-medium-emphasis" data-v-5d4104ec>`);
          ...
          _push(`</div></div></td><td class="text-medium-emphasis font-weight-medium" data-v-5d4104ec>${ssrInterpolate(c.transaction_number || "—")}</td><td class="text-medium-emphasis" data-v-5d4104ec>${ssrInterpolate(formatDate(c.created_at))}</td><td class="text-right font-weight-medium" data-v-5d4104ec>${ssrInterpolate(formatMoney(c.total_amount))}</td><td class="text-right text-success" data-v-5d4104ec>${ssrInterpolate(formatMoney(c.amount_paid))}</td><td class="${ssrRenderClass([Number(c.balance) > 0 ? "text-error" : "text-success", "text-right font-weight-bold"])}" data-v-5d4104ec>${ssrInterpolate(formatMoney(c.balance))}</td><td data-v-5d4104ec><div class="az-progress-wrap" data-v-5d4104ec><div class="az-progress-bar" data-v-5d4104ec><div style="${ssrRenderStyle({ width: progressPct(c) + "%" })}" class="${ssrRenderClass([progressClass(c), "az-progress-fill"])}" data-v-5d4104ec></div></div><span class="az-progress-label" data-v-5d4104ec>${ssrInterpolate(progressPct(c))}%</span></div></td><td data-v-5d4104ec><span class="${ssrRenderClass(isOverdue(c) ? "text-error font-weight-bold" : "text-medium-emphasis")}" data-v-5d4104ec>${ssrInterpolate(c.due_date ? formatDate(c.due_date) : "—")} `);
          if (isOverdue(c)) {
          ...
          _push(`</span></td><td data-v-5d4104ec><span class="${ssrRenderClass([`az-status-chip--${statusClass(c.status)}`, "az-status-chip"])}" data-v-5d4104ec>${ssrInterpolate(c.status_display || c.status)}</span></td><td data-v-5d4104ec><div class="az-row-actions" data-v-5d4104ec>`);
          _push(ssrRenderComponent(VBtn, {
            size: "small",
            variant: "tonal",
            color: "success",
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<span class="d-none d-sm-inline" data-v-5d4104ec${_scopeId}>Pay</span>`);
              } else {
                return [
        ...
        if (!unref(pagedItems).length) {
          _push(`<tr data-v-5d4104ec><td colspan="10" class="az-table__empty" data-v-5d4104ec>`);
          _push(ssrRenderComponent(VIcon, {
            size: "36",
          ...
          _push(`<p class="text-body-2 mt-2 text-medium-emphasis" data-v-5d4104ec>No credit accounts found.</p></td></tr>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</tbody></table>`);
        if (unref(filtered).length > itemsPerPage) {
          _push(`<div class="az-pagination" data-v-5d4104ec>`);
          _push(ssrRenderComponent(VBtn, {
            size: "small",
            variant: "text",
          ...
          _push(`<span class="az-pagination__info" data-v-5d4104ec>Page ${ssrInterpolate(unref(page))} of ${ssrInterpolate(unref(totalPages))}</span>`);
          _push(ssrRenderComponent(VBtn, {
            size: "small",
            variant: "text",
        ...
        if (unref(topDebtors).length > 0) {
          _push(`<div class="az-debtors-section" data-v-5d4104ec><div class="az-debtors-title" data-v-5d4104ec>`);
          _push(ssrRenderComponent(VIcon, {
            size: "18",
            color: "error"
          }, {
          ...
          _push(`<span data-v-5d4104ec>Top Debtors</span></div><div class="az-debtors-grid" data-v-5d4104ec><!--[-->`);
          ssrRenderList(unref(topDebtors), (d, i) => {
            _push(`<div class="az-debtor-card" data-v-5d4104ec><div class="az-debtor-rank" data-v-5d4104ec>#${ssrInterpolate(i + 1)}</div><div class="az-avatar az-avatar--error" data-v-5d4104ec>${ssrInterpolate(initials(d.customer_name))}</div><div class="az-debtor-info" data-v-5d4104ec><p class="az-debtor-name" data-v-5d4104ec>${ssrInterpolate(d.customer_name)}</p><p class="az-debtor-sub" data-v-5d4104ec>${ssrInterpolate(d.customer_phone || "No phone")}</p></div><div class="az-debtor-amount" data-v-5d4104ec><p class="font-weight-bold text-error" data-v-5d4104ec>${ssrInterpolate(formatMoney(d.balance))}</p><p class="text-caption text-medium-emphasis" data-v-5d4104ec>${ssrInterpolate(d.status_display || d.status)}</p></div></div>`);
          });
          _push(`<!--]--></div></div>`);
        } else {
          _push(`<!---->`);
                ...
                if (_push3) {
                  ...
                  if (unref(selectedCredit)) {
                    _push3(ssrRenderComponent(VCardText, null, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<div class="az-pay-summary" data-v-5d4104ec${_scopeId3}><div class="az-pay-summary__row" data-v-5d4104ec${_scopeId3}><span data-v-5d4104ec${_scopeId3}>Customer</span><span class="font-weight-bold" data-v-5d4104ec${_scopeId3}>${ssrInterpolate(unref(selectedCredit).customer_name)}</span></div><div class="az-pay-summary__row" data-v-5d4104ec${_scopeId3}><span data-v-5d4104ec${_scopeId3}>Transaction</span><span class="font-weight-medium" data-v-5d4104ec${_scopeId3}>${ssrInterpolate(unref(selectedCredit).transaction_number || "—")}</span></div><div class="az-pay-summary__row" data-v-5d4104ec${_scopeId3}><span data-v-5d4104ec${_scopeId3}>Total Amount</span><span data-v-5d4104ec${_scopeId3}>${ssrInterpolate(formatMoney(unref(selectedCredit).total_amount))}</span></div><div class="az-pay-summary__row" data-v-5d4104ec${_scopeId3}><span data-v-5d4104ec${_scopeId3}>Already Paid</span><span class="text-success font-weight-medium" data-v-5d4104ec${_scopeId3}>${ssrInterpolate(formatMoney(unref(selectedCredit).amount_paid))}</span></div><div class="az-pay-summary__row az-pay-summary__row--bold" data-v-5d4104ec${_scopeId3}><span data-v-5d4104ec${_scopeId3}>Outstanding Balance</span><span class="text-error font-weight-bold" data-v-5d4104ec${_scopeId3}>${ssrInterpolate(formatMoney(unref(selectedCredit).balance))}</span></div></div><div class="az-quick-amt" data-v-5d4104ec${_scopeId3}><button class="az-quick-amt__btn" data-v-5d4104ec${_scopeId3}>Full</button><button class="az-quick-amt__btn" data-v-5d4104ec${_scopeId3}>Half</button><button class="az-quick-amt__btn" data-v-5d4104ec${_scopeId3}>25%</button><button class="az-quick-amt__btn" data-v-5d4104ec${_scopeId3}>Clear</button></div>`);
                ...
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(VCardText, null, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        if (unref(selectedCredit)) {
                          _push4(`<div class="az-history-summary" data-v-5d4104ec${_scopeId3}><div class="az-history-summary__item" data-v-5d4104ec${_scopeId3}><p class="text-caption text-medium-emphasis" data-v-5d4104ec${_scopeId3}>Total Credit</p><p class="text-h6 font-weight-bold" data-v-5d4104ec${_scopeId3}>${ssrInterpolate(formatMoney(unref(selectedCredit).total_amount))}</p></div><div class="az-history-summary__item" data-v-5d4104ec${_scopeId3}><p class="text-caption text-medium-emphasis" data-v-5d4104ec${_scopeId3}>Total Paid</p><p class="text-h6 font-weight-bold text-success" data-v-5d4104ec${_scopeId3}>${ssrInterpolate(formatMoney(unref(selectedCredit).amount_paid))}</p></div><div class="az-history-summary__item" data-v-5d4104ec${_scopeId3}><p class="text-caption text-medium-emphasis" data-v-5d4104ec${_scopeId3}>Balance</p><p class="text-h6 font-weight-bold text-error" data-v-5d4104ec${_scopeId3}>${ssrInterpolate(formatMoney(unref(selectedCredit).balance))}</p></div></div>`);
                        } else {
                          _push4(`<!---->`);
                        }
                        if (unref(paymentHistory).length > 0) {
                          _push4(ssrRenderComponent(VDataTable, {
                            ...
                            "item.amount": withCtx(({ item }, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<span class="font-weight-bold text-success" data-v-5d4104ec${_scopeId4}>${ssrInterpolate(formatMoney(item.amount))}</span>`);
                              } else {
                                return [
                          ...
                          _push4(`<div class="text-center text-medium-emphasis py-8" data-v-5d4104ec${_scopeId3}>`);
                          _push4(ssrRenderComponent(VIcon, {
                            size: "40",
                            color: "grey-lighten-1"
                          }, {
                          ...
                          _push4(`<p class="mt-2" data-v-5d4104ec${_scopeId3}>No payments recorded yet.</p></div>`);
                        }
                      } else {
                        return [
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-5d4104ec"]]);
export {
  index as default
};
//# sourceMappingURL=index-CKkSYo-B.js.map
