...
import { ref, computed, watch, mergeProps, withCtx, unref, createVNode, toDisplayString, createTextVNode, isRef, openBlock, createBlock, Fragment, createCommentVNode, renderList, useSSRContext } from 'file://D:/Projects/MY-APPS-2/DomendraPOS/frontend/node_modules/vue/index.mjs';
import { ssrRenderComponent, ssrInterpolate, ssrRenderClass, ssrRenderStyle, ssrRenderList } from 'file://D:/Projects/MY-APPS-2/DomendraPOS/frontend/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    function typeLabel(value) {
      var _a;
      return ((_a = typeFilterItems.find((t) => t.value === value)) == null ? void 0 : _a.title) || value;
    }
    ...
    function exportCsv() {
      ...
      for (const r of rows) {
        const cells = [
          ...
          (_a = r.quantity_change) != null ? _a : "",
          (_b = r.quantity_after) != null ? _b : "",
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(VCol, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="text-h5 font-weight-bold"${_scopeId3}>Stock Movements</div><div class="text-body-2 text-medium-emphasis"${_scopeId3}>${ssrInterpolate(unref(stats).total)} movements \xB7 ${ssrInterpolate(unref(stats).netIn)} units net in \xB7 ${ssrInterpolate(unref(stats).netOut)} units net out </div>`);
                      } else {
                        return [
                          createVNode("div", { class: "text-h5 font-weight-bold" }, "Stock Movements"),
                          createVNode("div", { class: "text-body-2 text-medium-emphasis" }, toDisplayString(unref(stats).total) + " movements \xB7 " + toDisplayString(unref(stats).netIn) + " units net in \xB7 " + toDisplayString(unref(stats).netOut) + " units net out ", 1)
                        ];
                      }
                    }),
                    _: 1
...
//# sourceMappingURL=movements-BX4Hqypx.mjs.map
