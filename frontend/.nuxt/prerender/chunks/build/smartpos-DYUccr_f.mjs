...
import { defineComponent, ref, computed, watch, mergeProps, withCtx, createTextVNode, unref, createVNode, toDisplayString, openBlock, createBlock, createCommentVNode, isRef, Fragment, renderList, useSSRContext } from 'file://D:/Projects/MY-APPS-2/DomendraPOS/frontend/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderClass, ssrRenderAttr, ssrRenderList, ssrIncludeBooleanAttr } from 'file://D:/Projects/MY-APPS-2/DomendraPOS/frontend/node_modules/vue/server-renderer/index.mjs';
import { a as useAuthStore, u as useApi } from './useApi-D4YG8JPQ.mjs';
import { u as useFormat } from './useFormat-BvVWDMYe.mjs';
import { _ as _export_sfc, D as useToast, a as VIcon, c as VBtn, o as VChip, H as VAvatar, j as VBadge, q as VDialog, g as VCard, r as VCardTitle, b as VSpacer, k as VDivider, s as VCardText, v as VTextField, d as VAlert, w as VCardActions, $ as VTextarea } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const nowLabel = (/* @__PURE__ */ new Date()).toLocaleDateString("en-GB", { weekday: "short", day: "2-digit", month: "short", year: "numeric" }) + " \xB7 " + (/* @__PURE__ */ new Date()).toLocaleTimeString("en-GB", { hour: "2-digit", minute: "2-digit", hour12: true });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(showSuggestions) && unref(suggestions).length > 0) {
        ...
        ssrRenderList(unref(suggestions), (p) => {
          ...
          _push(`</div><div class="scan-suggestion__body" data-v-43b2f167><div class="scan-suggestion__name" data-v-43b2f167>${ssrInterpolate(p.name)}</div><div class="scan-suggestion__meta" data-v-43b2f167>${ssrInterpolate(p.sku || "\u2014")} \xB7 Stock ${ssrInterpolate(stockOf(p))}${ssrInterpolate(pieceStockLabel(p))}</div></div>`);
          if (p.barcode) {
      ...
      if (!unref(pos).isEmpty) {
        ...
        ssrRenderList(unref(pos).cart, (item, i) => {
          ...
          _push(`</div><div class="smart-cart-item__info" data-v-43b2f167><div class="smart-cart-item__title" data-v-43b2f167>${ssrInterpolate(item.name)}</div><div class="smart-cart-item__meta" data-v-43b2f167>${ssrInterpolate(item.sku || "\u2014")} \xB7 ${ssrInterpolate(formatMoney(item.price))} each`);
          if (item.items_per_unit > 1) {
            _push(`<!--[--> \xB7 ${ssrInterpolate(item.qty)} pcs (${ssrInterpolate((item.qty / item.items_per_unit).toFixed(2))} ${ssrInterpolate(item.unit)})<!--]-->`);
          } else {
            _push(`<!---->`);
          }
                            ...
                            if (_push5) {
                              _push5(ssrRenderComponent(VIcon, {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  var _a2, _b2;
                                  if (_push6) {
                                    _push6(`${ssrInterpolate((_a2 = paymentOptions.find((o) => o.value === unref(pos).paymentMethod)) == null ? void 0 : _a2.icon)}`);
                                  } else {
                                    return [
                              ...
                              _push5(` ${ssrInterpolate((_a = paymentOptions.find((o) => o.value === unref(pos).paymentMethod)) == null ? void 0 : _a.label)}`);
                            } else {
                              return [
                                createVNode(VIcon, {
                                  size: "14",
                                ...
                                createTextVNode(" " + toDisplayString((_b = paymentOptions.find((o) => o.value === unref(pos).paymentMethod)) == null ? void 0 : _b.label), 1)
                              ];
                            }
                          }),
                          _: 1
                          ...
                          createVNode(VChip, {
                            ...
                            default: withCtx(() => {
                              ...
                              return [
                                ...
                                createTextVNode(" " + toDisplayString((_a = paymentOptions.find((o) => o.value === unref(pos).paymentMethod)) == null ? void 0 : _a.label), 1)
                              ];
                            }),
                            _: 1
                          })
                  ...
                  _push3(ssrRenderComponent(VCardText, { class: "pt-4" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      ...
                      if (_push4) {
                        ...
                        _push4(`<span data-v-43b2f167${_scopeId3}>${ssrInterpolate((_a = paymentOptions.find((o) => o.value === unref(pos).paymentMethod)) == null ? void 0 : _a.label)}</span></div></div>`);
            ...
            _push2(ssrRenderComponent(VCard, { rounded: "xl" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                ...
                if (_push3) {
                  ...
                  _push3(`<h3 class="text-h6 font-weight-bold mt-2" data-v-43b2f167${_scopeId2}>Sale Completed</h3><p class="text-caption text-medium-emphasis" data-v-43b2f167${_scopeId2}>${ssrInterpolate((_a = unref(lastTransaction)) == null ? void 0 : _a.transaction_number)}</p></div>`);
                  _push3(ssrRenderComponent(VDivider, null, null, _parent3, _scopeId2));
...
//# sourceMappingURL=smartpos-DYUccr_f.mjs.map
