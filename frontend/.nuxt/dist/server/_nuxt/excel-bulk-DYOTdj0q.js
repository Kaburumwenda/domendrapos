...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const customerTypeOptions = computed(() => preview.value?.customer_types || ["individual", "business"]);
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              ...
                              if (!unref(selectedFile)) {
                                _push5(`<!--[--><div class="text-h6 font-weight-bold" data-v-585c1864${_scopeId4}>Drop your .xlsx here or <span class="text-primary" data-v-585c1864${_scopeId4}>browse</span></div><div class="text-body-2 text-medium-emphasis" data-v-585c1864${_scopeId4}>Only .xlsx files · max 20MB · Customer Code optional</div><!--]-->`);
                              } else {
                              ...
                              return [
                                ...
                                createVNode("div", {
                                  ...
                                  !unref(selectedFile) ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                                    ...
                                    createVNode("div", { class: "text-body-2 text-medium-emphasis" }, "Only .xlsx files · max 20MB · Customer Code optional")
...
//# sourceMappingURL=excel-bulk-DYOTdj0q.js.map
