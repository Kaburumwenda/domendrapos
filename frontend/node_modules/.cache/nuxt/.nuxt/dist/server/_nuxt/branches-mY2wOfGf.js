  ...
  setup(__props) {
    ...
    const filteredBranches = computed(() => {
      ...
      if (search.value) {
        ...
        list = list.filter(
          (b) => b.name.toLowerCase().includes(q) || b.code.toLowerCase().includes(q) || b.city?.toLowerCase().includes(q)
        );
      }
      return list;
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(loading)) {
        ...
        ssrRenderList(unref(filteredBranches), (branch) => {
          ...
          _push(`<span class="br-info-row__text" data-v-b0f66ae5>${ssrInterpolate(branch.currency_code)} · ${ssrInterpolate(branch.timezone)}</span></div></div><div class="br-card__footer" data-v-b0f66ae5><div class="br-card__stat" data-v-b0f66ae5>`);
...
//# sourceMappingURL=branches-mY2wOfGf.js.map
