import { ref, computed, watch, resolveComponent, mergeProps, withCtx, unref, createTextVNode, toDisplayString, openBlock, createBlock, Fragment, renderList, createVNode, isRef, createCommentVNode, useSSRContext } from 'file://D:/Projects/MY-APPS-2/DomendraPOS/frontend/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrInterpolate, ssrRenderClass, ssrRenderStyle } from 'file://D:/Projects/MY-APPS-2/DomendraPOS/frontend/node_modules/vue/server-renderer/index.mjs';
import { u as useFormat } from './useFormat-BvVWDMYe.mjs';
import { _ as _export_sfc, D as useToast, L as VBtnGroup, c as VBtn, x as VProgressCircular, a as VIcon, v as VTextField, J as VSelect, q as VDialog, g as VCard, r as VCardTitle, s as VCardText, e as VRow, f as VCol, Z as VCombobox, w as VCardActions, b as VSpacer } from './server.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const filtered = computed(() => {
      ...
      if (searchText.value) {
        ...
        list = list.filter(
          (e) => {
            var _a, _b, _c;
            return ((_a = e.description) == null ? void 0 : _a.toLowerCase().includes(s)) || ((_b = e.vendor) == null ? void 0 : _b.toLowerCase().includes(s)) || ((_c = e.expense_number) == null ? void 0 : _c.toLowerCase().includes(s));
          }
        );
      }
    ...
    const kpis = computed(() => {
      ...
      const topCategory = ((_a = catEntries[0]) == null ? void 0 : _a[0]) || "";
      const topCategoryPct = total > 0 ? (((_b = catEntries[0]) == null ? void 0 : _b[1]) || 0) / total * 100 : 0;
      ...
      const largestCat = (largestEntry == null ? void 0 : largestEntry.category) || "";
...
//# sourceMappingURL=index-CuXtU9ka.mjs.map
