import { defineComponent, ref, reactive, computed, mergeProps, withCtx, createTextVNode, toDisplayString, unref, createVNode, openBlock, createBlock, createCommentVNode, Fragment, useSSRContext } from "vue";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(VContainer, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="d-flex align-center mb-4" data-v-3322069e${_scopeId}>`);
            ...
            _push2(`<h1 class="text-h5 font-weight-bold" data-v-3322069e${_scopeId}>API Billing — Payments</h1>`);
            ...
            if (data.value) {
              _push2(`<div data-v-3322069e${_scopeId}>`);
                        ...
                        if (_push4) {
                          _push4(ssrRenderComponent(VCard, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<div class="d-flex align-center justify-space-between" data-v-3322069e${_scopeId4}><div class="text-caption text-medium-emphasis" data-v-3322069e${_scopeId4}>Outstanding</div>`);
                                ...
                                _push5(`</div><div class="text-h5 font-weight-bold mt-1" data-v-3322069e${_scopeId4}>${ssrInterpolate(unref(fmtCurrency)(summary.value.total_outstanding, summary.value.currency))}</div><div class="text-caption text-medium-emphasis mt-1" data-v-3322069e${_scopeId4}>${ssrInterpolate(summary.value.outstanding_count)} unpaid</div>`);
                              } else {
                                return [
                                  ...
                                  createVNode("div", { class: "text-h5 font-weight-bold mt-1" }, toDisplayString(unref(fmtCurrency)(summary.value.total_outstanding, summary.value.currency)), 1),
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(VCard, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<div class="d-flex align-center justify-space-between" data-v-3322069e${_scopeId4}><div class="text-caption text-medium-emphasis" data-v-3322069e${_scopeId4}>Overdue</div>`);
                                _push5(ssrRenderComponent(VIcon, {
                                  size: "20",
                                  color: "error"
                                }, {
                                ...
                                _push5(`</div><div class="text-h5 font-weight-bold mt-1" data-v-3322069e${_scopeId4}>${ssrInterpolate(unref(fmtCurrency)(summary.value.total_overdue, summary.value.currency))}</div><div class="text-caption text-medium-emphasis mt-1" data-v-3322069e${_scopeId4}>${ssrInterpolate(summary.value.overdue_count)} overdue</div>`);
                              } else {
                                return [
                                  createVNode("div", { class: "d-flex align-center justify-space-between" }, [
                                  ...
                                  createVNode("div", { class: "text-h5 font-weight-bold mt-1" }, toDisplayString(unref(fmtCurrency)(summary.value.total_overdue, summary.value.currency)), 1),
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(VCard, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<div class="d-flex align-center justify-space-between" data-v-3322069e${_scopeId4}><div class="text-caption text-medium-emphasis" data-v-3322069e${_scopeId4}>Wallet balance</div>`);
                                ...
                                _push5(`</div><div class="text-h5 font-weight-bold mt-1" data-v-3322069e${_scopeId4}>${ssrInterpolate(unref(fmtCurrency)(data.value.wallet_balance, data.value.currency))}</div><div class="text-caption text-medium-emphasis mt-1" data-v-3322069e${_scopeId4}>Pre-funded credit</div>`);
                              } else {
                                return [
                                  createVNode("div", { class: "d-flex align-center justify-space-between" }, [
                                  ...
                                  createVNode("div", { class: "text-h5 font-weight-bold mt-1" }, toDisplayString(unref(fmtCurrency)(data.value.wallet_balance, data.value.currency)), 1),
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                              ...
                              if (_push5) {
                                _push5(ssrRenderComponent(VDataTable, {
                                  ...
                                  "item.amount": withCtx(({ item }, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`${ssrInterpolate(unref(fmtCurrency)(item.amount, item.currency))}`);
                                    } else {
                                      return [
                                  ...
                                  "item.balance": withCtx(({ item }, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`<span class="font-weight-medium" data-v-3322069e${_scopeId5}>${ssrInterpolate(unref(fmtCurrency)(item.balance ?? item.amount, item.currency))}</span>`);
                                    } else {
                                      return [
                                        createVNode("span", { class: "font-weight-medium" }, toDisplayString(unref(fmtCurrency)(item.balance ?? item.amount, item.currency)), 1)
                                      ];
                                    }
                                  }),
                                  "item.due_date": withCtx(({ item }, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`<span class="${ssrRenderClass({ "text-error font-weight-medium": item.is_overdue })}" data-v-3322069e${_scopeId5}>${ssrInterpolate(item.due_date ? unref(fmtDate)(item.due_date) : "—")}</span>`);
                                    } else {
                                      return [
                                        createVNode("span", {
                                  ...
                                  "no-data": withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`<div class="text-medium-emphasis py-6 text-center" data-v-3322069e${_scopeId5}>No outstanding bills. You&#39;re all caught up.</div>`);
                                    } else {
                                      return [
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(ssrRenderComponent(VDataTable, {
                                  ...
                                  "no-data": withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`<div class="text-medium-emphasis py-6 text-center" data-v-3322069e${_scopeId5}>No payments yet.</div>`);
                                    } else {
                                      return [
                          ...
                          _push4(ssrRenderComponent(VTabsWindowItem, { value: "mpesa" }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<div class="d-flex align-center px-4 pt-3 pb-1" data-v-3322069e${_scopeId4}>`);
                                _push5(ssrRenderComponent(VIcon, {
                                  class: "mr-2",
                                  color: "success"
                                }, {
                                ...
                                _push5(`<span class="text-caption text-medium-emphasis" data-v-3322069e${_scopeId4}>All M-Pesa STK push requests</span></div>`);
                                _push5(ssrRenderComponent(VDataTable, {
                                  ...
                                  "no-data": withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`<div class="text-medium-emphasis py-6 text-center" data-v-3322069e${_scopeId5}>No M-Pesa payments yet.</div>`);
                                    } else {
                                      return [
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(ssrRenderComponent(VDataTable, {
                                  ...
                                  "item.amount": withCtx(({ item }, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`<span class="${ssrRenderClass(item.type === "credit" ? "text-success" : "text-error")}" data-v-3322069e${_scopeId5}>${ssrInterpolate(item.type === "credit" ? "+" : "-")} ${ssrInterpolate(unref(fmtCurrency)(item.amount, data.value.currency))}</span>`);
                                    } else {
                                      return [
                                        createVNode("span", {
                                          class: item.type === "credit" ? "text-success" : "text-error"
                                        }, toDisplayString(item.type === "credit" ? "+" : "-") + " " + toDisplayString(unref(fmtCurrency)(item.amount, data.value.currency)), 3)
                                      ];
                                    }
                                  }),
                                  "item.balance_after": withCtx(({ item }, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`${ssrInterpolate(unref(fmtCurrency)(item.balance_after, data.value.currency))}`);
                                    } else {
                                      return [
                                        createTextVNode(toDisplayString(unref(fmtCurrency)(item.balance_after, data.value.currency)), 1)
                                      ];
                                    }
                                  }),
                                  "no-data": withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`<div class="text-medium-emphasis py-6 text-center" data-v-3322069e${_scopeId5}>No wallet activity yet.</div>`);
                                    } else {
                                      return [
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          ...
                          _push4(ssrRenderComponent(VCardText, null, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<div class="d-flex justify-space-between mb-1" data-v-3322069e${_scopeId4}><span class="text-medium-emphasis" data-v-3322069e${_scopeId4}>Bill amount</span><span class="font-weight-bold" data-v-3322069e${_scopeId4}>${ssrInterpolate(unref(fmtCurrency)(payTarget.value.amount, payTarget.value.currency))}</span></div><div class="d-flex justify-space-between mb-3" data-v-3322069e${_scopeId4}><span class="text-medium-emphasis" data-v-3322069e${_scopeId4}>Balance due</span><span class="font-weight-bold text-warning" data-v-3322069e${_scopeId4}>${ssrInterpolate(unref(fmtCurrency)(billBalance.value, payTarget.value.currency))}</span></div><div class="text-caption text-medium-emphasis mb-1" data-v-3322069e${_scopeId4}>Payment method</div>`);
                                                        ...
                                                        _push9(ssrRenderComponent(VCard, {
                                                          ...
                                                          default: withCtx((_8, _push10, _parent10, _scopeId9) => {
                                                            if (_push10) {
                                                              ...
                                                              _push10(`<div class="text-caption mt-1" data-v-3322069e${_scopeId9}>M-Pesa</div>`);
                                                            } else {
                                                              return [
                                                                createVNode(VIcon, {
                                                                  size: "26",
                                                        ...
                                                        _push9(ssrRenderComponent(VCard, {
                                                          ...
                                                          default: withCtx((_8, _push10, _parent10, _scopeId9) => {
                                                            if (_push10) {
                                                              ...
                                                              _push10(`<div class="text-caption mt-1" data-v-3322069e${_scopeId9}>Wallet</div><div class="text-caption text-medium-emphasis" data-v-3322069e${_scopeId9}>${ssrInterpolate(unref(fmtCurrency)(data.value.wallet_balance, data.value.currency))}</div>`);
                                                            } else {
                                                              return [
                                                                createVNode(VIcon, {
                                                                  size: "26",
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(VCardText, null, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<p class="text-body-2 text-medium-emphasis mb-3" data-v-3322069e${_scopeId4}> Top up your DomendraPOS wallet via M-Pesa and use the balance to pay future bills. </p><div class="d-flex align-center mb-4" data-v-3322069e${_scopeId4}>`);
                              _push5(ssrRenderComponent(VIcon, {
                                class: "mr-2",
                                color: "success"
                              }, {
                              ...
                              _push5(`<span class="text-body-2" data-v-3322069e${_scopeId4}>Lipa na M-Pesa</span></div>`);
                              _push5(ssrRenderComponent(VTextField, {
                                ...
                                variant: "outlined",
                                density: "comfortable",
                                prefix: data.value?.currency || "KSH",
                                class: "mb-2"
                              }, null, _parent5, _scopeId4));
                              _push5(ssrRenderComponent(VTextField, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              ...
                              if (mpesa.state === "processing") {
                                ...
                                _push5(`<div class="text-h6 font-weight-bold mb-1" data-v-3322069e${_scopeId4}>Awaiting your confirmation</div><p class="text-body-2 text-medium-emphasis mb-2" data-v-3322069e${_scopeId4}> Check your phone and enter your M-Pesa PIN to authorise the payment. </p>`);
                                ...
                                _push5(`<div class="text-caption text-medium-emphasis" data-v-3322069e${_scopeId4}>`);
                                ...
                                _push5(`<div class="text-h6 font-weight-bold mb-1" data-v-3322069e${_scopeId4}>Payment successful</div><p class="text-body-2 text-medium-emphasis" data-v-3322069e${_scopeId4}>${ssrInterpolate(mpesa.message)}</p><!--]-->`);
                                ...
                                _push5(`<div class="text-h6 font-weight-bold mb-1" data-v-3322069e${_scopeId4}>Payment not completed</div><p class="text-body-2 text-medium-emphasis" data-v-3322069e${_scopeId4}>${ssrInterpolate(mpesa.message)}</p><!--]-->`);
                              } else {
                                _push5(`<!---->`);
                              }
                            } else {
...
const payments = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3322069e"]]);
export {
  payments as default
};
//# sourceMappingURL=payments-CU1S1lMV.js.map
