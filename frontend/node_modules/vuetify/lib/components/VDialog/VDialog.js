...
import { genericComponent, getActiveElement, noop, omit, propsFactory, useRender } from "../../util/index.js"; // Types
...
export const VDialog = genericComponent()({
  ...
  setup(props, {
    ...
    function onAfterEnter() {
      emit('afterEnter');
      if ((props.scrim || props.retainFocus) && overlay.value?.contentEl && !overlay.value.contentEl.contains(getActiveElement())) {
    ...
    useRender(() => {
      ...
      const locationStrategy = props.fullscreen ? noop : props.locationStrategy;
