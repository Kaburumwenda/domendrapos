import { _ as _export_sfc, E as useRoute$1, D as useToast, a as VIcon, c as VBtn, y as navigateTo, Y as VForm, v as VTextField, d as VAlert, A as useRuntimeConfig } from './server.mjs';
import { defineComponent, computed, reactive, ref, mergeProps, withCtx, createTextVNode, unref, toDisplayString, createVNode, openBlock, createBlock, createCommentVNode, useSSRContext } from 'file://D:/Projects/MY-APPS-2/DomendraPOS/frontend/node_modules/vue/index.mjs';
  ...
  setup(__props) {
    ...
    async function handleSubmit() {
      ...
      try {
        ...
        const msg = ((_a = e == null ? void 0 : e.data) == null ? void 0 : _a.detail) || ((_c = (_b = e == null ? void 0 : e.data) == null ? void 0 : _b.password) == null ? void 0 : _c[0]) || "Failed to reset password. Please try again.";
        error.value = msg;
      } finally {
        loading.value = false;
      }
...
//# sourceMappingURL=reset-password-DIxz1dU8.mjs.map
