import { ref, reactive, computed, mergeProps, withCtx, createTextVNode, unref, toDisplayString, createVNode, openBlock, createBlock, Fragment, renderList, isRef, createCommentVNode, useSSRContext } from 'file://D:/Projects/MY-APPS-2/DomendraPOS/frontend/node_modules/vue/index.mjs';
import { ssrRenderComponent, ssrRenderList, ssrInterpolate, ssrRenderClass } from 'file://D:/Projects/MY-APPS-2/DomendraPOS/frontend/node_modules/vue/server-renderer/index.mjs';
import { _ as _export_sfc, D as useToast, E as useRoute$1, V as VContainer, a as VIcon, c as VBtn, e as VRow, f as VCol, g as VCard, F as VFadeTransition, x as VProgressCircular, G as VTable, H as VAvatar, o as VChip, v as VTextField, k as VDivider, d as VAlert, I as VSwitch, q as VDialog } from './server.mjs';
  ...
  setup(__props) {
      ...
      return [
        {
          ...
          label: "Locked Users",
          icon: "mdi-lock-alert",
          count: (_a = overview.value.locked_count) != null ? _a : 0
        },
        {
          value: "attempts",
          label: "All Attempts",
          icon: "mdi-login",
          count: (_b = overview.value.total_attempts) != null ? _b : 0
        },
        {
          value: "logs",
          label: "Failure Logs",
          icon: "mdi-alert-circle-outline",
          count: (_c = overview.value.total_failure_logs) != null ? _c : 0
        },
        {
          value: "sessions",
    ...
    const kpis = computed(() => {
      ...
      return [
        {
          label: "Locked Out",
          value: (_a = overview.value.locked_count) != null ? _a : 0,
        ...
        },
        {
          ...
          value: (_b = overview.value.total_attempts) != null ? _b : 0,
          sub: `${(_c = overview.value.unique_ips) != null ? _c : 0} unique IPs`,
          icon: "mdi-login",
          color: "warning"
        },
        {
          label: "Active Sessions",
          value: (_d = overview.value.active_sessions) != null ? _d : 0,
        ...
        },
        {
          ...
          value: (_e = overview.value.recent_failures_24h) != null ? _e : 0,
          sub: `of ${(_f = overview.value.total_failure_logs) != null ? _f : 0} total failures`,
          icon: "mdi-alert-circle-outline",
          color: "purple"
        }
      ];
...
//# sourceMappingURL=index-046GMOh0.mjs.map
