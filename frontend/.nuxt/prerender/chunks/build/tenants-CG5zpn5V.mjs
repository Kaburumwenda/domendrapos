import { defineComponent, ref, computed, reactive, mergeProps, withCtx, createTextVNode, unref, isRef, createVNode, withModifiers, openBlock, createBlock, toDisplayString, Fragment, renderList, createCommentVNode, useSSRContext } from 'file://D:/Projects/MY-APPS-2/DomendraPOS/frontend/node_modules/vue/index.mjs';
...
import { _ as _export_sfc, D as useToast, a as VIcon, c as VBtn, a1 as VSkeletonLoader, b as VSpacer, v as VTextField, J as VSelect, n as VDataTable, o as VChip, a2 as VNavigationDrawer, h as VTabs, i as VTab, R as VWindow, S as VWindowItem, d as VAlert, a3 as VTimeline, a4 as VTimelineItem, M as VList, N as VListItem, O as VListItemTitle, P as VListItemSubtitle } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const filteredTenants = computed(() => {
      ...
      if (search.value) {
        ...
        list = list.filter(
          (t) => {
            var _a, _b, _c;
            return ((_a = t.name) == null ? void 0 : _a.toLowerCase().includes(q)) || ((_b = t.contact_email) == null ? void 0 : _b.toLowerCase().includes(q)) || ((_c = t.schema_name) == null ? void 0 : _c.toLowerCase().includes(q));
          }
        );
      }
      return list;
    ...
    function openDetail(_event, item) {
      const t = (item == null ? void 0 : item.item) || item || _event;
      selected.value = t;
      if (selected.value) {
    ...
    function activityColor(action) {
      if (action == null ? void 0 : action.includes("create")) return "success";
      if (action == null ? void 0 : action.includes("delete")) return "error";
      if (action == null ? void 0 : action.includes("update")) return "warning";
      return "primary";
    }
    function invColor(s) {
      ...
      if (unref(loading) && unref(tenants2).length === 0) {
        ...
        _push(ssrRenderComponent(VDataTable, {
          ...
          "item.name": withCtx(({ item }, _push2, _parent2, _scopeId) => {
            var _a, _b, _c, _d;
            if (_push2) {
              _push2(`<div class="d-flex align-center ga-2" data-v-f4f395f6${_scopeId}><div class="sa-tenant-row__avatar" style="${ssrRenderStyle(avatarStyle(item.name))}" data-v-f4f395f6${_scopeId}>${ssrInterpolate((_b = (_a = item.name) == null ? void 0 : _a.charAt(0)) == null ? void 0 : _b.toUpperCase())}</div><div data-v-f4f395f6${_scopeId}><p class="text-body-2 font-weight-medium" data-v-f4f395f6${_scopeId}>${ssrInterpolate(item.name)}</p><p class="text-caption text-medium-emphasis" data-v-f4f395f6${_scopeId}>${ssrInterpolate(item.contact_email)}</p></div></div>`);
            } else {
              return [
                createVNode("div", { class: "d-flex align-center ga-2" }, [
                  ...
                  }, toDisplayString((_d = (_c = item.name) == null ? void 0 : _c.charAt(0)) == null ? void 0 : _d.toUpperCase()), 5),
          ...
          "item.limits": withCtx(({ item }, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span class="text-body-2 text-medium-emphasis" data-v-f4f395f6${_scopeId}>${ssrInterpolate(item.max_branches)}b \xB7 ${ssrInterpolate(item.max_users)}u \xB7 ${ssrInterpolate(item.max_products)}p </span>`);
            } else {
              return [
                createVNode("span", { class: "text-body-2 text-medium-emphasis" }, toDisplayString(item.max_branches) + "b \xB7 " + toDisplayString(item.max_users) + "u \xB7 " + toDisplayString(item.max_products) + "p ", 1)
              ];
            }
          }),
                    ...
                    _push3(ssrRenderComponent(VWindowItem, { value: "overview" }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        ...
                        if (_push4) {
                          ...
                          _push4(`<!--]-->`);
                          if (!((_a2 = unref(selected).domains) == null ? void 0 : _a2.length)) {
                          ...
                          return [
                            ...
                            createVNode("div", { class: "d-flex flex-wrap ga-2" }, [
                              ...
                              !((_b2 = unref(selected).domains) == null ? void 0 : _b2.length) ? (openBlock(), createBlock("span", {
                                key: 0,
                                class: "text-body-2 text-medium-emphasis"
                                      ...
                                      default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                        if (_push6) {
                                          ...
                                          return [
                                            ...
                                            createVNode("p", { class: "text-caption text-medium-emphasis" }, toDisplayString(a.user_email || "system") + " \xB7 " + toDisplayString(a.resource_type), 1)
                                          ];
                                        }
                                      }),
                                      _: 2
                                      ...
                                      default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                        if (_push6) {
                                          ...
                                          _push6(ssrRenderComponent(VListItemSubtitle, null, {
                                            default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                              if (_push7) {
                                                _push7(`${ssrInterpolate(inv.status)} \xB7 due ${ssrInterpolate(formatDate(inv.due_date))}`);
                                              } else {
                                                return [
                                                  createTextVNode(toDisplayString(inv.status) + " \xB7 due " + toDisplayString(formatDate(inv.due_date)), 1)
                                                ];
                                              }
                                            }),
                                            _: 2
                        ...
                        default: withCtx(() => {
                          ...
                          return [
                            ...
                            createVNode("div", { class: "d-flex flex-wrap ga-2" }, [
                              ...
                              !((_a2 = unref(selected).domains) == null ? void 0 : _a2.length) ? (openBlock(), createBlock("span", {
                                key: 0,
                                class: "text-body-2 text-medium-emphasis"
                              }, "No domains")) : createCommentVNode("", true)
                            ]),
              ...
              unref(selected) ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                createVNode("div", { class: "sa-drawer__header" }, [
                  createVNode("div", { class: "d-flex align-center ga-3" }, [
                    ...
                    }, toDisplayString((_d = (_c = unref(selected).name) == null ? void 0 : _c.charAt(0)) == null ? void 0 : _d.toUpperCase()), 5),
                    createVNode("div", {
                      class: "flex-grow-1",
                      style: { "min-width": "0" }
                    }, [
...
export { tenants as default };
//# sourceMappingURL=tenants-CG5zpn5V.mjs.map
