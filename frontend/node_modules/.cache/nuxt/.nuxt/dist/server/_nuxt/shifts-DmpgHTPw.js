import { defineComponent, computed, ref, watch, mergeProps, withCtx, createTextVNode, unref, isRef, createVNode, openBlock, createBlock, createCommentVNode, withDirectives, Fragment, renderList, toDisplayString, vModelSelect, withKeys, vModelText, useSSRContext } from "vue";
            ...
            _push2(ssrRenderComponent(VCard, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`</div><div data-v-1afc2da0${_scopeId2}><h3 class="text-h6 font-weight-bold" data-v-1afc2da0${_scopeId2}>Close Shift — Z-Report</h3><p class="text-body-2 text-medium-emphasis" data-v-1afc2da0${_scopeId2}>${ssrInterpolate(unref(currentShift)?.reference)} · ${ssrInterpolate(unref(currentShift)?.branch_name)}</p></div></div>`);
                  _push3(ssrRenderComponent(VDivider, null, null, _parent3, _scopeId2));
                  _push3(`<div class="shifts-dialog__body" data-v-1afc2da0${_scopeId2}><div class="shifts-zreport" data-v-1afc2da0${_scopeId2}><div class="shifts-zreport__row" data-v-1afc2da0${_scopeId2}><span data-v-1afc2da0${_scopeId2}>Opening Float</span><span class="font-weight-medium" data-v-1afc2da0${_scopeId2}>${ssrInterpolate(formatMoney(unref(currentShift)?.opening_float))}</span></div><div class="shifts-zreport__row" data-v-1afc2da0${_scopeId2}><span data-v-1afc2da0${_scopeId2}>Cash Sales (expected)</span><span class="font-weight-medium" data-v-1afc2da0${_scopeId2}>${ssrInterpolate(formatMoney(unref(expectedCashSales)))}</span></div><div class="shifts-zreport__row shifts-zreport__row--bold" data-v-1afc2da0${_scopeId2}><span data-v-1afc2da0${_scopeId2}>Expected Cash in Drawer</span><span class="font-weight-bold" data-v-1afc2da0${_scopeId2}>${ssrInterpolate(formatMoney(unref(expectedTotal)))}</span></div>`);
                  ...
                  return [
                    createVNode("div", { class: "shifts-dialog__header" }, [
                      ...
                      createVNode("div", null, [
                        ...
                        createVNode("p", { class: "text-body-2 text-medium-emphasis" }, toDisplayString(unref(currentShift)?.reference) + " · " + toDisplayString(unref(currentShift)?.branch_name), 1)
                      ])
                    ]),
                    createVNode(VDivider),
                    createVNode("div", { class: "shifts-dialog__body" }, [
                      createVNode("div", { class: "shifts-zreport" }, [
                        createVNode("div", { class: "shifts-zreport__row" }, [
                          ...
                          createVNode("span", { class: "font-weight-medium" }, toDisplayString(formatMoney(unref(currentShift)?.opening_float)), 1)
                        ]),
                        createVNode("div", { class: "shifts-zreport__row" }, [
...
//# sourceMappingURL=shifts-DmpgHTPw.js.map
