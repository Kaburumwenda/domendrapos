import { defineComponent, ref, computed, mergeProps, withCtx, createTextVNode, unref, toDisplayString, isRef, createVNode, openBlock, createBlock, Fragment, renderList, useSSRContext } from 'file://D:/Projects/MY-APPS-2/DomendraPOS/frontend/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrRenderClass, ssrInterpolate, ssrRenderAttr, ssrRenderStyle, ssrIncludeBooleanAttr } from 'file://D:/Projects/MY-APPS-2/DomendraPOS/frontend/node_modules/vue/server-renderer/index.mjs';
import { u as useApi, a as useAuthStore } from './useApi-D4YG8JPQ.mjs';
import { _ as _export_sfc, D as useToast, a as VIcon, o as VChip, q as VDialog, g as VCard, c as VBtn, k as VDivider, x as VProgressCircular, b as VSpacer } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function isGranted(m, a) {
      ...
      const actions = (_a = matrix.value[activeRole.value]) == null ? void 0 : _a[m];
      return !!(actions == null ? void 0 : actions.includes(a));
    }
    function moduleSummary(role) {
      const roleMods = matrix.value[role] || {};
      return moduleList.map((m) => {
        var _a;
        const count = ((_a = roleMods[m.value]) == null ? void 0 : _a.length) || 0;
        return {
          module: m.value,
          label: m.label,
    ...
    async function saveMatrix() {
      ...
      try {
        ...
        toast.error(((_a = e == null ? void 0 : e.data) == null ? void 0 : _a.detail) || "Failed to save permissions");
        await loadMatrix();
      } finally {
        saving.value = false;
      }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "iam-page" }, _attrs))} data-v-c7e5d2d8><div class="iam-header" data-v-c7e5d2d8><div class="iam-header__left" data-v-c7e5d2d8><h1 class="iam-header__title" data-v-c7e5d2d8>Roles &amp; Permissions</h1><p class="iam-header__sub" data-v-c7e5d2d8>Manage role-based access control across every module</p></div><div class="iam-header__actions" data-v-c7e5d2d8><button class="iam-btn iam-btn--ghost" data-v-c7e5d2d8>`);
      ...
      _push(` Refresh </button></div></div><div class="iam-kpi-grid" data-v-c7e5d2d8><!--[-->`);
      ssrRenderList(unref(kpis), (kpi) => {
        _push(`<div class="iam-kpi" data-v-c7e5d2d8><div class="${ssrRenderClass([`iam-kpi__icon--${kpi.color}`, "iam-kpi__icon"])}" data-v-c7e5d2d8>`);
        ...
        _push(`</div><div class="iam-kpi__body" data-v-c7e5d2d8><p class="iam-kpi__label" data-v-c7e5d2d8>${ssrInterpolate(kpi.label)}</p><p class="iam-kpi__value" data-v-c7e5d2d8>${ssrInterpolate(kpi.value)}</p></div></div>`);
      });
      _push(`<!--]--></div><div class="iam-roles-grid" data-v-c7e5d2d8><!--[-->`);
      ssrRenderList(roleList, (r) => {
        _push(`<div class="${ssrRenderClass([{ "iam-role-card--active": unref(activeRole) === r.value }, "iam-role-card"])}" data-v-c7e5d2d8><div class="iam-role-card__head" data-v-c7e5d2d8><div class="${ssrRenderClass([`iam-role-card__icon--${roleColor(r.value)}`, "iam-role-card__icon"])}" data-v-c7e5d2d8>`);
        _push(ssrRenderComponent(VIcon, { size: "22" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
        ...
        _push(`</div><div class="iam-role-card__meta" data-v-c7e5d2d8><p class="iam-role-card__name" data-v-c7e5d2d8>${ssrInterpolate(r.label)}</p><p class="iam-role-card__count" data-v-c7e5d2d8>${ssrInterpolate(unref(roleUserCounts)[r.value] || 0)} user(s)</p></div>`);
        ...
        _push(`</div><div class="iam-role-card__bars" data-v-c7e5d2d8><!--[-->`);
        ssrRenderList(moduleSummary(r.value), (m) => {
          _push(`<div class="iam-role-card__bar"${ssrRenderAttr("title", m.label)} data-v-c7e5d2d8><span style="${ssrRenderStyle({ width: m.fill })}" class="${ssrRenderClass([`iam-role-card__bar-fill--${m.fill > 0 ? "on" : "off"}`, "iam-role-card__bar-fill"])}" data-v-c7e5d2d8></span></div>`);
        });
        _push(`<!--]--></div></div>`);
      });
      _push(`<!--]--></div>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(VCard, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="iam-dialog__header" data-v-c7e5d2d8${_scopeId2}><div class="iam-dialog__header-icon iam-dialog__header-icon--primary" data-v-c7e5d2d8${_scopeId2}>`);
                  ...
                  _push3(`</div><div class="flex-1" data-v-c7e5d2d8${_scopeId2}><h3 class="text-h6 font-weight-bold" data-v-c7e5d2d8${_scopeId2}>${ssrInterpolate(unref(activeRoleLabel))}</h3><p class="text-body-2 text-medium-emphasis" data-v-c7e5d2d8${_scopeId2}> Toggle module permissions for this role \u2014 changes save immediately. </p></div>`);
                  ...
                  if (unref(matrixLoading)) {
                    _push3(`<div class="iam-loading" data-v-c7e5d2d8${_scopeId2}>`);
                    ...
                    _push3(`<p data-v-c7e5d2d8${_scopeId2}>Loading permissions...</p></div>`);
                  } else {
                    _push3(`<div class="iam-dialog__body" data-v-c7e5d2d8${_scopeId2}><div class="iam-bulkbar" data-v-c7e5d2d8${_scopeId2}><div class="iam-bulkbar__info" data-v-c7e5d2d8${_scopeId2}>`);
                    ...
                    _push3(`<span data-v-c7e5d2d8${_scopeId2}>${ssrInterpolate(unref(totalGranted))} of ${ssrInterpolate(unref(totalPossible))} permissions granted</span></div><div class="iam-bulkbar__actions" data-v-c7e5d2d8${_scopeId2}><button class="iam-btn iam-btn--ghost iam-btn--sm" data-v-c7e5d2d8${_scopeId2}>`);
                    ...
                    _push3(` Grant All </button><button class="iam-btn iam-btn--ghost iam-btn--sm" data-v-c7e5d2d8${_scopeId2}>`);
                    _push3(ssrRenderComponent(VIcon, { size: "16" }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                    ...
                    _push3(` Revoke All </button><button class="iam-btn iam-btn--ghost iam-btn--sm" data-v-c7e5d2d8${_scopeId2}>`);
                    _push3(ssrRenderComponent(VIcon, { size: "16" }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                    ...
                    _push3(` Reset Defaults </button></div></div><div class="iam-matrix-wrap" data-v-c7e5d2d8${_scopeId2}><table class="iam-matrix" data-v-c7e5d2d8${_scopeId2}><thead data-v-c7e5d2d8${_scopeId2}><tr data-v-c7e5d2d8${_scopeId2}><th class="iam-matrix__col-module" data-v-c7e5d2d8${_scopeId2}>Module</th><!--[-->`);
                    ssrRenderList(actionList, (a) => {
                      _push3(`<th class="iam-matrix__col-action" data-v-c7e5d2d8${_scopeId2}><div class="iam-matrix__action-head" data-v-c7e5d2d8${_scopeId2}>`);
                      _push3(ssrRenderComponent(VIcon, { size: "16" }, {
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                      ...
                      _push3(`<span data-v-c7e5d2d8${_scopeId2}>${ssrInterpolate(a.label)}</span></div></th>`);
                    });
                    _push3(`<!--]--></tr></thead><tbody data-v-c7e5d2d8${_scopeId2}><!--[-->`);
                    ssrRenderList(moduleList, (m) => {
                      _push3(`<tr data-v-c7e5d2d8${_scopeId2}><td class="iam-matrix__module-cell" data-v-c7e5d2d8${_scopeId2}><div class="iam-matrix__module-info" data-v-c7e5d2d8${_scopeId2}>`);
                      ...
                      _push3(`<div data-v-c7e5d2d8${_scopeId2}><p class="iam-matrix__module-name" data-v-c7e5d2d8${_scopeId2}>${ssrInterpolate(m.label)}</p><p class="iam-matrix__module-desc" data-v-c7e5d2d8${_scopeId2}>${ssrInterpolate(moduleDesc(m.value))}</p></div></div></td><!--[-->`);
                      ssrRenderList(actionList, (a) => {
                        _push3(`<td class="iam-matrix__cell" data-v-c7e5d2d8${_scopeId2}><button class="${ssrRenderClass([{ "iam-toggle--on": isGranted(m.value, a.value) }, "iam-toggle"])}"${ssrIncludeBooleanAttr(unref(saving)) ? " disabled" : ""} data-v-c7e5d2d8${_scopeId2}>`);
                        _push3(ssrRenderComponent(VIcon, { size: "18" }, {
                          default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                            if (_push4) {
                  ...
                  _push3(ssrRenderComponent(VDivider, null, null, _parent3, _scopeId2));
                  _push3(`<div class="iam-dialog__actions" data-v-c7e5d2d8${_scopeId2}>`);
...
const rolesPermissions = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c7e5d2d8"]]);

export { rolesPermissions as default };
//# sourceMappingURL=roles-permissions-BLV8Fev3.mjs.map
