                          ...
                          default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                            if (_push4) {
                              ...
                              _push4(ssrRenderComponent(VListItemSubtitle, null, {
                                default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                  if (_push5) {
                                    _push5(` Balance <strong data-v-4b3b5688${_scopeId4}>${ssrInterpolate(unref(fmtCurrency)(b.balance ?? b.amount))}</strong>`);
                                    if (b.due_date) {
                                      _push5(`<span data-v-4b3b5688${_scopeId4}> · due ${ssrInterpolate(unref(fmtDate)(b.due_date))}</span>`);
                                    } else {
                                      _push5(`<!---->`);
                                    }
                                    if (Number(b.discount_amount) > 0) {
                                      _push5(`<span data-v-4b3b5688${_scopeId4}> · ${ssrInterpolate(unref(fmtCurrency)(b.discount_amount))} discount applied</span>`);
                                    } else {
                                      _push5(`<!---->`);
                                    }
                                  } else {
                                                  ...
                                                  _push8(ssrRenderComponent(VCard, {
                                                    ...
                                                    default: withCtx((_7, _push9, _parent9, _scopeId8) => {
                                                      if (_push9) {
                                                        ...
                                                        _push9(`<div class="text-caption mt-1" data-v-4b3b5688${_scopeId8}>Wallet</div><div class="text-caption text-medium-emphasis" data-v-4b3b5688${_scopeId8}>${ssrInterpolate(unref(fmtCurrency)(data.value?.wallet_balance))}</div>`);
                                                      } else {
                                                        return [
                                                          createVNode(VIcon, {
                                                            size: "26",
...
//# sourceMappingURL=overdue-Cbqvh_kM.mjs.map
