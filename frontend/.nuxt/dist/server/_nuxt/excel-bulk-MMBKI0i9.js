                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              ...
                              if (!unref(selectedFile)) {
                                _push5(`<!--[--><div class="text-h6 font-weight-bold" data-v-4d48917f${_scopeId4}>Drop your .xlsx here or <span class="text-primary" data-v-4d48917f${_scopeId4}>browse</span></div><div class="text-body-2 text-medium-emphasis" data-v-4d48917f${_scopeId4}>Only .xlsx files · max 20MB · PO Number optional</div><!--]-->`);
                              } else {
                              ...
                              return [
                                ...
                                createVNode("div", {
                                  ...
                                  !unref(selectedFile) ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                                    ...
                                    createVNode("div", { class: "text-body-2 text-medium-emphasis" }, "Only .xlsx files · max 20MB · PO Number optional")
                                      ...
                                      return [
                                        createVNode("div", { class: "d-flex align-center ga-3 mb-5 flex-wrap" }, [
                                          ...
                                          createVNode("div", null, [
                                            ...
                                            createVNode("div", { class: "text-body-2 text-medium-emphasis" }, toDisplayString(unref(previewRows).length) + " row(s) · " + toDisplayString(unref(preview).skipped) + " empty row(s) skipped · rows with the same PO Number create one PO ", 1)
                                          ]),
                                          createVNode(VSpacer),
                                          createVNode(VBtn, {
                                            variant: "text",
                                      ...
                                      return [
                                        createVNode("div", { class: "d-flex align-center ga-3 mb-5 flex-wrap" }, [
                                          ...
                                          createVNode("div", null, [
                                            ...
                                            createVNode("div", { class: "text-body-2 text-medium-emphasis" }, toDisplayString(unref(importResult).created) + " PO(s) created · " + toDisplayString(unref(importResult).lines_created || 0) + " line item(s) added ", 1)
                                          ]),
                                          createVNode(VSpacer),
...
export {
  excelBulk as default
};
//# sourceMappingURL=excel-bulk-MMBKI0i9.js.map
