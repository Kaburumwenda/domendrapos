import { ref, computed, mergeProps, isRef, unref, withCtx, createTextVNode, createVNode, toDisplayString, openBlock, createBlock, Fragment, renderList, withKeys, useSSRContext } from 'file://D:/Projects/MY-APPS-2/DomendraPOS/frontend/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderStyle, ssrRenderList, ssrRenderClass, ssrRenderAttr } from 'file://D:/Projects/MY-APPS-2/DomendraPOS/frontend/node_modules/vue/server-renderer/index.mjs';
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(VCardTitle, { class: "text-h6 font-weight-bold px-4 pt-4 d-flex align-center" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      ...
                      if (_push4) {
                        _push4(`<div class="az-cat-grid__icon mr-3" style="${ssrRenderStyle({ background: categoryColor((_a = unref(viewingCategory)) == null ? void 0 : _a.name) })}" data-v-d021cb38${_scopeId3}>${ssrInterpolate((((_b = unref(viewingCategory)) == null ? void 0 : _b.name) || "?").charAt(0).toUpperCase())}</div> ${ssrInterpolate(((_c = unref(viewingCategory)) == null ? void 0 : _c.name) || "Uncategorized")}`);
                      } else {
                        return [
                          createVNode("div", {
                            class: "az-cat-grid__icon mr-3",
                            style: { background: categoryColor((_d = unref(viewingCategory)) == null ? void 0 : _d.name) }
                          }, toDisplayString((((_e = unref(viewingCategory)) == null ? void 0 : _e.name) || "?").charAt(0).toUpperCase()), 5),
                          createTextVNode(" " + toDisplayString(((_f = unref(viewingCategory)) == null ? void 0 : _f.name) || "Uncategorized"), 1)
                        ];
                      }
                    }),
                    _: 1
                  ...
                  _push3(ssrRenderComponent(VCardText, { class: "px-4 pb-2" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      ...
                      if (_push4) {
                        ...
                        _push4(`</span></div><div class="az-cat-view__row" data-v-d021cb38${_scopeId3}><span class="az-cat-view__label" data-v-d021cb38${_scopeId3}>Description</span><span class="text-medium-emphasis" data-v-d021cb38${_scopeId3}>${ssrInterpolate(categoryDescription((_a = unref(viewingCategory)) == null ? void 0 : _a.name) || "\u2014")}</span></div><div class="az-cat-view__row" data-v-d021cb38${_scopeId3}><span class="az-cat-view__label" data-v-d021cb38${_scopeId3}>Color</span><span class="d-flex align-center gap-2" data-v-d021cb38${_scopeId3}><span class="az-cat-view__swatch" style="${ssrRenderStyle({ background: categoryColor((_b = unref(viewingCategory)) == null ? void 0 : _b.name) })}" data-v-d021cb38${_scopeId3}></span><code data-v-d021cb38${_scopeId3}>${ssrInterpolate(categoryColor((_c = unref(viewingCategory)) == null ? void 0 : _c.name))}</code></span></div><div class="az-cat-view__row" data-v-d021cb38${_scopeId3}><span class="az-cat-view__label" data-v-d021cb38${_scopeId3}>Status</span><span data-v-d021cb38${_scopeId3}><span class="${ssrRenderClass([categoryActiveObj((_d = unref(viewingCategory)) == null ? void 0 : _d.name) ? "az-cat-badge--custom" : "az-cat-badge--count", "az-cat-badge"])}" data-v-d021cb38${_scopeId3}>${ssrInterpolate(categoryActiveObj((_e = unref(viewingCategory)) == null ? void 0 : _e.name) ? "Active" : "Inactive")}</span></span></div>`);
                        _push4(ssrRenderComponent(VDivider, { class: "my-3" }, null, _parent4, _scopeId3));
                        _push4(`<div class="az-cat-view__stats" data-v-d021cb38${_scopeId3}><div class="az-cat-view__stat" data-v-d021cb38${_scopeId3}><span class="az-cat-view__stat-num" data-v-d021cb38${_scopeId3}>${ssrInterpolate((_g = (_f = unref(viewingCategory)) == null ? void 0 : _f.count) != null ? _g : 0)}</span><span class="az-cat-view__stat-label" data-v-d021cb38${_scopeId3}>Expenses</span></div><div class="az-cat-view__stat" data-v-d021cb38${_scopeId3}><span class="az-cat-view__stat-num text-error" data-v-d021cb38${_scopeId3}>${ssrInterpolate(formatMoney((_h = unref(viewingCategory)) == null ? void 0 : _h.spend))}</span><span class="az-cat-view__stat-label" data-v-d021cb38${_scopeId3}>Spend</span></div><div class="az-cat-view__stat" data-v-d021cb38${_scopeId3}><span class="az-cat-view__stat-num text-info" data-v-d021cb38${_scopeId3}>${ssrInterpolate(formatMoney((_i = unref(viewingCategory)) == null ? void 0 : _i.cost))}</span><span class="az-cat-view__stat-label" data-v-d021cb38${_scopeId3}>Cost</span></div><div class="az-cat-view__stat" data-v-d021cb38${_scopeId3}><span class="az-cat-view__stat-num" style="${ssrRenderStyle({ "color": "#7C4DFF" })}" data-v-d021cb38${_scopeId3}>${ssrInterpolate(formatMoney((_j = unref(viewingCategory)) == null ? void 0 : _j.retail))}</span><span class="az-cat-view__stat-label" data-v-d021cb38${_scopeId3}>Retail</span></div></div><div class="mt-3" data-v-d021cb38${_scopeId3}><div class="d-flex align-center justify-space-between mb-1" data-v-d021cb38${_scopeId3}><span class="text-caption text-medium-emphasis" data-v-d021cb38${_scopeId3}>Share of total cost</span><span class="text-caption font-weight-bold" data-v-d021cb38${_scopeId3}>${ssrInterpolate(((_l = (_k = unref(viewingCategory)) == null ? void 0 : _k.pct) != null ? _l : 0).toFixed(1))}%</span></div><div class="az-bar-wrap az-bar-wrap--full" data-v-d021cb38${_scopeId3}><div class="az-bar-fill" style="${ssrRenderStyle({ width: ((_n = (_m = unref(viewingCategory)) == null ? void 0 : _m.pct) != null ? _n : 0) + "%", background: categoryColor((_o = unref(viewingCategory)) == null ? void 0 : _o.name) })}" data-v-d021cb38${_scopeId3}></div></div></div>`);
                      } else {
                        return [
                          ...
                          createVNode("div", { class: "az-cat-view__row" }, [
                            ...
                            createVNode("span", { class: "text-medium-emphasis" }, toDisplayString(categoryDescription((_p = unref(viewingCategory)) == null ? void 0 : _p.name) || "\u2014"), 1)
                          ]),
                          createVNode("div", { class: "az-cat-view__row" }, [
                            ...
                            createVNode("span", { class: "d-flex align-center gap-2" }, [
                              createVNode("span", {
                                ...
                                style: { background: categoryColor((_q = unref(viewingCategory)) == null ? void 0 : _q.name) }
                              }, null, 4),
                              createVNode("code", null, toDisplayString(categoryColor((_r = unref(viewingCategory)) == null ? void 0 : _r.name)), 1)
                            ])
                          ]),
                          createVNode("div", { class: "az-cat-view__row" }, [
                            ...
                            createVNode("span", null, [
                              createVNode("span", {
                                class: ["az-cat-badge", categoryActiveObj((_s = unref(viewingCategory)) == null ? void 0 : _s.name) ? "az-cat-badge--custom" : "az-cat-badge--count"]
                              }, toDisplayString(categoryActiveObj((_t = unref(viewingCategory)) == null ? void 0 : _t.name) ? "Active" : "Inactive"), 3)
                            ])
                          ]),
                          createVNode(VDivider, { class: "my-3" }),
                          createVNode("div", { class: "az-cat-view__stats" }, [
                            createVNode("div", { class: "az-cat-view__stat" }, [
                              createVNode("span", { class: "az-cat-view__stat-num" }, toDisplayString((_v = (_u = unref(viewingCategory)) == null ? void 0 : _u.count) != null ? _v : 0), 1),
                              createVNode("span", { class: "az-cat-view__stat-label" }, "Expenses")
                            ]),
                            createVNode("div", { class: "az-cat-view__stat" }, [
                              createVNode("span", { class: "az-cat-view__stat-num text-error" }, toDisplayString(formatMoney((_w = unref(viewingCategory)) == null ? void 0 : _w.spend)), 1),
                              createVNode("span", { class: "az-cat-view__stat-label" }, "Spend")
                            ]),
                            createVNode("div", { class: "az-cat-view__stat" }, [
                              createVNode("span", { class: "az-cat-view__stat-num text-info" }, toDisplayString(formatMoney((_x = unref(viewingCategory)) == null ? void 0 : _x.cost)), 1),
                            ...
                            createVNode("div", { class: "az-cat-view__stat" }, [
                              createVNode("span", {
                                ...
                                style: { "color": "#7C4DFF" }
                              }, toDisplayString(formatMoney((_y = unref(viewingCategory)) == null ? void 0 : _y.retail)), 1),
                          ...
                          createVNode("div", { class: "mt-3" }, [
                            createVNode("div", { class: "d-flex align-center justify-space-between mb-1" }, [
                              ...
                              createVNode("span", { class: "text-caption font-weight-bold" }, toDisplayString(((_A = (_z = unref(viewingCategory)) == null ? void 0 : _z.pct) != null ? _A : 0).toFixed(1)) + "%", 1)
                            ]),
                            createVNode("div", { class: "az-bar-wrap az-bar-wrap--full" }, [
                              createVNode("div", {
                                class: "az-bar-fill",
                                style: { width: ((_C = (_B = unref(viewingCategory)) == null ? void 0 : _B.pct) != null ? _C : 0) + "%", background: categoryColor((_D = unref(viewingCategory)) == null ? void 0 : _D.name) }
                              }, null, 4)
                            ])
                          ])
                        ];
                      ...
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(VBtn, {
                          ...
                          onClick: ($event) => {
                            ...
                            openEditCategoryDialog((_a = unref(viewingCategory)) == null ? void 0 : _a.name);
                          }
                        }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                    ...
                    createVNode(VCardTitle, { class: "text-h6 font-weight-bold px-4 pt-4 d-flex align-center" }, {
                      default: withCtx(() => {
                        ...
                        return [
                          createVNode("div", {
                            class: "az-cat-grid__icon mr-3",
                            style: { background: categoryColor((_a = unref(viewingCategory)) == null ? void 0 : _a.name) }
                          }, toDisplayString((((_b = unref(viewingCategory)) == null ? void 0 : _b.name) || "?").charAt(0).toUpperCase()), 5),
                          createTextVNode(" " + toDisplayString(((_c = unref(viewingCategory)) == null ? void 0 : _c.name) || "Uncategorized"), 1)
                        ];
                      }),
                      _: 1
                    }),
                    createVNode(VCardText, { class: "px-4 pb-2" }, {
                      default: withCtx(() => {
                        ...
                        return [
                          ...
                          createVNode("div", { class: "az-cat-view__row" }, [
                            createVNode("span", { class: "az-cat-view__label" }, "Description"),
                            createVNode("span", { class: "text-medium-emphasis" }, toDisplayString(categoryDescription((_a = unref(viewingCategory)) == null ? void 0 : _a.name) || "\u2014"), 1)
                          ]),
                          createVNode("div", { class: "az-cat-view__row" }, [
                            createVNode("span", { class: "az-cat-view__label" }, "Color"),
                            createVNode("span", { class: "d-flex align-center gap-2" }, [
                              createVNode("span", {
                                class: "az-cat-view__swatch",
                                style: { background: categoryColor((_b = unref(viewingCategory)) == null ? void 0 : _b.name) }
                              }, null, 4),
                              createVNode("code", null, toDisplayString(categoryColor((_c = unref(viewingCategory)) == null ? void 0 : _c.name)), 1)
                            ])
                          ]),
                          createVNode("div", { class: "az-cat-view__row" }, [
                            createVNode("span", { class: "az-cat-view__label" }, "Status"),
                            createVNode("span", null, [
                              createVNode("span", {
                                class: ["az-cat-badge", categoryActiveObj((_d = unref(viewingCategory)) == null ? void 0 : _d.name) ? "az-cat-badge--custom" : "az-cat-badge--count"]
                              }, toDisplayString(categoryActiveObj((_e = unref(viewingCategory)) == null ? void 0 : _e.name) ? "Active" : "Inactive"), 3)
                            ])
                          ]),
                          createVNode(VDivider, { class: "my-3" }),
                          createVNode("div", { class: "az-cat-view__stats" }, [
                            createVNode("div", { class: "az-cat-view__stat" }, [
                              createVNode("span", { class: "az-cat-view__stat-num" }, toDisplayString((_g = (_f = unref(viewingCategory)) == null ? void 0 : _f.count) != null ? _g : 0), 1),
                              createVNode("span", { class: "az-cat-view__stat-label" }, "Expenses")
                            ]),
                            createVNode("div", { class: "az-cat-view__stat" }, [
                              createVNode("span", { class: "az-cat-view__stat-num text-error" }, toDisplayString(formatMoney((_h = unref(viewingCategory)) == null ? void 0 : _h.spend)), 1),
                              createVNode("span", { class: "az-cat-view__stat-label" }, "Spend")
                            ]),
                            createVNode("div", { class: "az-cat-view__stat" }, [
                              createVNode("span", { class: "az-cat-view__stat-num text-info" }, toDisplayString(formatMoney((_i = unref(viewingCategory)) == null ? void 0 : _i.cost)), 1),
                              createVNode("span", { class: "az-cat-view__stat-label" }, "Cost")
                            ]),
                            createVNode("div", { class: "az-cat-view__stat" }, [
                              createVNode("span", {
                                class: "az-cat-view__stat-num",
                                style: { "color": "#7C4DFF" }
                              }, toDisplayString(formatMoney((_j = unref(viewingCategory)) == null ? void 0 : _j.retail)), 1),
                              createVNode("span", { class: "az-cat-view__stat-label" }, "Retail")
                            ])
                          ]),
                          createVNode("div", { class: "mt-3" }, [
                            createVNode("div", { class: "d-flex align-center justify-space-between mb-1" }, [
                              createVNode("span", { class: "text-caption text-medium-emphasis" }, "Share of total cost"),
                              createVNode("span", { class: "text-caption font-weight-bold" }, toDisplayString(((_l = (_k = unref(viewingCategory)) == null ? void 0 : _k.pct) != null ? _l : 0).toFixed(1)) + "%", 1)
                            ]),
                            createVNode("div", { class: "az-bar-wrap az-bar-wrap--full" }, [
                              createVNode("div", {
                                class: "az-bar-fill",
                                style: { width: ((_n = (_m = unref(viewingCategory)) == null ? void 0 : _m.pct) != null ? _n : 0) + "%", background: categoryColor((_o = unref(viewingCategory)) == null ? void 0 : _o.name) }
                              }, null, 4)
                            ])
                          ])
                        ];
...
//# sourceMappingURL=categories-MUQcnNnS.mjs.map
