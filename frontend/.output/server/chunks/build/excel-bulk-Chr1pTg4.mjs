import { ref, computed, mergeProps, withCtx, createTextVNode, createVNode, isRef, unref, toDisplayString, withModifiers, openBlock, createBlock, Fragment, createCommentVNode, renderList, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrRenderClass, ssrInterpolate, ssrRenderStyle, ssrRenderList } from 'vue/server-renderer';
import { N as useRoute$1, u as useRouter$1, M as useToast, V as VContainer, g as VBtn, d as VIcon, i as VRow, j as VCol, Q as VAvatar, k as VCard, l as VTabs, m as VTab, a0 as VWindow, a1 as VWindowItem, f as VSpacer, h as VAlert, a2 as VScaleTransition, P as VTable, C as VTextField, S as VSelect, R as VSwitch, a3 as VSlideYTransition, I as VList, J as VListItem, K as VListItemTitle, L as VListItemSubtitle, v as VChip } from './server.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(VContainer, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="d-flex align-center ga-2 mb-4 flex-wrap" data-v-8a7f361e${_scopeId}>`);
            ...
            _push2(`<span class="text-body-2 text-medium-emphasis" data-v-8a7f361e${_scopeId}>Excel Import / Export</span></div>`);
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(VCol, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="d-flex align-center ga-3" data-v-8a7f361e${_scopeId3}>`);
                        ...
                        _push4(`<div data-v-8a7f361e${_scopeId3}><div class="text-h5 font-weight-bold" data-v-8a7f361e${_scopeId3}>Excel Import / Export</div><div class="text-body-2 text-medium-emphasis" data-v-8a7f361e${_scopeId3}> Bulk upload &amp; export stock items via .xlsx workbook </div></div></div>`);
                      } else {
                        return [
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(VCard, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="d-flex align-center ga-3 mb-4 flex-wrap" data-v-8a7f361e${_scopeId4}>`);
                              ...
                              _push5(`<div data-v-8a7f361e${_scopeId4}><div class="text-h6 font-weight-bold" data-v-8a7f361e${_scopeId4}>Download the Template</div><div class="text-body-2 text-medium-emphasis" data-v-8a7f361e${_scopeId4}> Pre-fill the workbook so column headers are recognized correctly </div></div>`);
                              ...
                              _push5(ssrRenderComponent(VAlert, {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(` Each row maps to one stock item. <strong data-v-8a7f361e${_scopeId5}>SKU is optional</strong> — blank SKUs are auto-generated. Existing SKUs are updated. `);
                                  } else {
                                    return [
                        ...
                        _push4(ssrRenderComponent(VCard, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="d-flex align-center ga-3 mb-5 flex-wrap" data-v-8a7f361e${_scopeId4}>`);
                              _push5(ssrRenderComponent(VAvatar, {
                                color: "primary-lighten-5",
                                size: "36",
                                rounded: "lg"
                              ...
                              _push5(`<div data-v-8a7f361e${_scopeId4}><div class="text-h6 font-weight-bold" data-v-8a7f361e${_scopeId4}>Upload &amp; Preview</div><div class="text-body-2 text-medium-emphasis" data-v-8a7f361e${_scopeId4}> Drag &amp; drop your completed workbook — review &amp; edit rows before saving </div></div></div><div class="${ssrRenderClass([{ "upload-zone-active": unref(isDragging), "upload-zone-has-file": unref(selectedFile) }, "upload-zone d-flex flex-column align-center justify-center ga-4 pa-10 mb-5 cursor-pointer"])}" data-v-8a7f361e${_scopeId4}><input type="file" accept=".xlsx,.xlsm" hidden data-v-8a7f361e${_scopeId4}>`);
                              _push5(ssrRenderComponent(VAvatar, {
                              ...
                              if (!unref(selectedFile)) {
                                _push5(`<!--[--><div class="text-h6 font-weight-bold" data-v-8a7f361e${_scopeId4}> Drop your .xlsx here or <span class="text-primary" data-v-8a7f361e${_scopeId4}>browse</span></div><div class="text-body-2 text-medium-emphasis" data-v-8a7f361e${_scopeId4}> Only .xlsx files · max 20MB · SKU optional </div><!--]-->`);
                              } else {
                                _push5(`<!--[--><div class="text-h6 font-weight-bold" style="${ssrRenderStyle({ "word-break": "break-all" })}" data-v-8a7f361e${_scopeId4}>${ssrInterpolate(unref(selectedFile).name)}</div><div class="text-body-2 text-medium-emphasis" data-v-8a7f361e${_scopeId4}>${ssrInterpolate(formatSize(unref(selectedFile).size))}</div><!--]-->`);
                              }
                              _push5(`</div>`);
                              if (unref(selectedFile)) {
                                _push5(`<div class="d-flex ga-3 flex-wrap" data-v-8a7f361e${_scopeId4}>`);
                                _push5(ssrRenderComponent(VBtn, {
                                  color: "primary",
                              ...
                              return [
                                ...
                                createVNode("div", {
                                  ...
                                  !unref(selectedFile) ? (openBlock(), createBlock(Fragment, { key: 0 }, [
                                    ...
                                    createVNode("div", { class: "text-body-2 text-medium-emphasis" }, " Only .xlsx files · max 20MB · SKU optional ")
                            ...
                            if (_push5) {
                              if (unref(preview)) {
                                _push5(ssrRenderComponent(VCard, {
                                  ...
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`<div class="d-flex align-center ga-3 mb-5 flex-wrap" data-v-8a7f361e${_scopeId5}>`);
                                      ...
                                      _push6(`<div data-v-8a7f361e${_scopeId5}><div class="text-h6 font-weight-bold" data-v-8a7f361e${_scopeId5}>Preview &amp; Edit Rows</div><div class="text-body-2 text-medium-emphasis" data-v-8a7f361e${_scopeId5}>${ssrInterpolate(unref(preview).rows.length)} row(s) · ${ssrInterpolate(unref(preview).skipped)} empty row(s) skipped · click any cell to edit </div></div>`);
                                      ...
                                      _push6(`<div class="overflow-x-auto" data-v-8a7f361e${_scopeId5}>`);
                                      _push6(ssrRenderComponent(VTable, {
                                        ...
                                        default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                          if (_push7) {
                                            _push7(`<thead class="bg-grey-lighten-4" data-v-8a7f361e${_scopeId6}><tr data-v-8a7f361e${_scopeId6}><th style="${ssrRenderStyle({ "min-width": "40px" })}" data-v-8a7f361e${_scopeId6}>#</th><th style="${ssrRenderStyle({ "min-width": "150px" })}" data-v-8a7f361e${_scopeId6}>SKU</th><th style="${ssrRenderStyle({ "min-width": "200px" })}" data-v-8a7f361e${_scopeId6}>Name *</th><th style="${ssrRenderStyle({ "min-width": "150px" })}" data-v-8a7f361e${_scopeId6}>Barcode</th><th style="${ssrRenderStyle({ "min-width": "160px" })}" data-v-8a7f361e${_scopeId6}>Category</th><th style="${ssrRenderStyle({ "min-width": "130px" })}" data-v-8a7f361e${_scopeId6}>Type</th><th style="${ssrRenderStyle({ "min-width": "150px" })}" data-v-8a7f361e${_scopeId6}>Brand</th><th style="${ssrRenderStyle({ "min-width": "110px" })}" data-v-8a7f361e${_scopeId6}>Cost Price</th><th style="${ssrRenderStyle({ "min-width": "110px" })}" data-v-8a7f361e${_scopeId6}>Retail Price</th><th style="${ssrRenderStyle({ "min-width": "110px" })}" data-v-8a7f361e${_scopeId6}>Wholesale</th><th style="${ssrRenderStyle({ "min-width": "100px" })}" data-v-8a7f361e${_scopeId6}>Tax %</th><th style="${ssrRenderStyle({ "min-width": "100px" })}" data-v-8a7f361e${_scopeId6}>Unit</th><th style="${ssrRenderStyle({ "min-width": "110px" })}" data-v-8a7f361e${_scopeId6}>Items/Unit</th><th style="${ssrRenderStyle({ "min-width": "130px" })}" data-v-8a7f361e${_scopeId6}>Expiry Date</th><th style="${ssrRenderStyle({ "min-width": "100px" })}" data-v-8a7f361e${_scopeId6}>Qty</th><th style="${ssrRenderStyle({ "min-width": "100px" })}" data-v-8a7f361e${_scopeId6}>Reorder</th><th style="${ssrRenderStyle({ "min-width": "90px" })}" data-v-8a7f361e${_scopeId6}>Active</th><th style="${ssrRenderStyle({ "min-width": "56px" })}" data-v-8a7f361e${_scopeId6}></th></tr></thead><tbody data-v-8a7f361e${_scopeId6}><!--[-->`);
                                            ssrRenderList(unref(previewRows), (row, i) => {
                                              _push7(`<tr class="${ssrRenderClass(rowInvalid(row) ? "bg-error-lighten-5" : row._autoSku ? "bg-primary-lighten-5" : "")}" data-v-8a7f361e${_scopeId6}><td class="text-caption text-disabled" data-v-8a7f361e${_scopeId6}>${ssrInterpolate(i + 1)}</td><td data-v-8a7f361e${_scopeId6}>`);
                                              ...
                                              _push7(`</td><td data-v-8a7f361e${_scopeId6}>`);
                                              _push7(ssrRenderComponent(VTextField, {
                                                modelValue: row.name,
                                      ...
                                      _push6(`</div><div class="d-flex align-center ga-3 mt-5 flex-wrap" data-v-8a7f361e${_scopeId5}>`);
                                      _push6(ssrRenderComponent(VBtn, {
                                        color: "success",
                                      ...
                                      if (unref(emptySkuCount) > 0) {
                                        _push6(`<span class="text-body-2 text-medium-emphasis" data-v-8a7f361e${_scopeId5}>${ssrInterpolate(unref(emptySkuCount))} row(s) will get auto-generated SKUs when saved </span>`);
                                      } else {
                                        _push6(`<!---->`);
                                      }
                                      _push6(`</div>`);
                                      ...
                                      return [
                                        createVNode("div", { class: "d-flex align-center ga-3 mb-5 flex-wrap" }, [
                                          ...
                                          createVNode("div", null, [
                                            ...
                                            createVNode("div", { class: "text-body-2 text-medium-emphasis" }, toDisplayString(unref(preview).rows.length) + " row(s) · " + toDisplayString(unref(preview).skipped) + " empty row(s) skipped · click any cell to edit ", 1)
                                          ]),
                                          createVNode(VSpacer),
                                          createVNode(VBtn, {
                                            variant: "text",
                                ...
                                _push5(ssrRenderComponent(VCard, {
                                  ...
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      ...
                                      _push6(`<div data-v-8a7f361e${_scopeId5}><div class="text-h6 font-weight-bold" data-v-8a7f361e${_scopeId5}>${ssrInterpolate(unref(importResult).failed > 0 ? "Import Finished (with issues)" : "Import Successful")}</div><div class="text-body-2 text-medium-emphasis" data-v-8a7f361e${_scopeId5}>${ssrInterpolate(unref(importResult).total_processed)} row(s) processed </div></div>`);
                                      _push6(ssrRenderComponent(VSpacer, null, null, _parent6, _scopeId5));
                                                ...
                                                if (_push8) {
                                                  _push8(ssrRenderComponent(VCard, {
                                                    ...
                                                    default: withCtx((_8, _push9, _parent9, _scopeId8) => {
                                                      if (_push9) {
                                                        _push9(`<div class="text-caption text-medium-emphasis text-uppercase" data-v-8a7f361e${_scopeId8}>Created</div><div class="text-h4 font-weight-bold text-success mt-1" data-v-8a7f361e${_scopeId8}>${ssrInterpolate(unref(importResult).created)}</div>`);
                                                      } else {
                                                        return [
                                              ...
                                              default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                if (_push8) {
                                                  _push8(ssrRenderComponent(VCard, {
                                                    ...
                                                    default: withCtx((_8, _push9, _parent9, _scopeId8) => {
                                                      if (_push9) {
                                                        _push9(`<div class="text-caption text-medium-emphasis text-uppercase" data-v-8a7f361e${_scopeId8}>Updated</div><div class="text-h4 font-weight-bold text-primary mt-1" data-v-8a7f361e${_scopeId8}>${ssrInterpolate(unref(importResult).updated)}</div>`);
                                                      } else {
                                                        return [
                                              ...
                                              default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                if (_push8) {
                                                  _push8(ssrRenderComponent(VCard, {
                                                    ...
                                                    default: withCtx((_8, _push9, _parent9, _scopeId8) => {
                                                      if (_push9) {
                                                        _push9(`<div class="text-caption text-medium-emphasis text-uppercase" data-v-8a7f361e${_scopeId8}>Failed</div><div class="${ssrRenderClass([unref(importResult).failed > 0 ? "text-error" : "text-disabled", "text-h4 font-weight-bold mt-1"])}" data-v-8a7f361e${_scopeId8}>${ssrInterpolate(unref(importResult).failed)}</div>`);
                                                      } else {
                                                        return [
                                              ...
                                              default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                if (_push8) {
                                                  _push8(ssrRenderComponent(VCard, {
                                                    ...
                                                    default: withCtx((_8, _push9, _parent9, _scopeId8) => {
                                                      if (_push9) {
                                                        _push9(`<div class="text-caption text-medium-emphasis text-uppercase" data-v-8a7f361e${_scopeId8}>Processed</div><div class="text-h4 font-weight-bold mt-1" data-v-8a7f361e${_scopeId8}>${ssrInterpolate(unref(importResult).total_processed)}</div>`);
                                                      } else {
                                                        return [
                                      ...
                                      if (unref(importResult).errors && unref(importResult).errors.length > 0) {
                                        _push6(`<div data-v-8a7f361e${_scopeId5}><div class="d-flex align-center ga-2 mb-3" data-v-8a7f361e${_scopeId5}>`);
                                        _push6(ssrRenderComponent(VIcon, {
                                          size: "18",
                                          color: "error"
                                        }, {
                                        ...
                                        _push6(`<span class="text-body-1 font-weight-bold" data-v-8a7f361e${_scopeId5}> Errors (${ssrInterpolate(unref(importResult).errors.length)}${ssrInterpolate(unref(importResult).errors_truncated ? "+" : "")}) </span></div>`);
                                                  ...
                                                  prepend: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                    if (_push8) {
                                                      _push8(ssrRenderComponent(VAvatar, {
                                                        ...
                                                        default: withCtx((_8, _push9, _parent9, _scopeId8) => {
                                                          if (_push9) {
                                                            _push9(`<span class="text-caption font-weight-bold text-error" data-v-8a7f361e${_scopeId8}>#${ssrInterpolate(err.row)}</span>`);
                                                          } else {
                                                            return [
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(ssrRenderComponent(VCard, {
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`<div class="d-flex align-center ga-3 mb-5" data-v-8a7f361e${_scopeId6}>`);
                                          ...
                                          _push7(`<div data-v-8a7f361e${_scopeId6}><div class="text-h6 font-weight-bold" data-v-8a7f361e${_scopeId6}>Export Stock Items to Excel</div><div class="text-body-2 text-medium-emphasis" data-v-8a7f361e${_scopeId6}> Download all products matching the active filters as a formatted .xlsx file </div></div></div>`);
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(ssrRenderComponent(VCard, {
                                      ...
                                      default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                        if (_push7) {
                                          _push7(`<div class="text-h6 font-weight-bold mb-4" data-v-8a7f361e${_scopeId6}>`);
                                          _push7(ssrRenderComponent(VIcon, {
                                            class: "mr-1",
                                            color: "primary"
                                          }, {
                                          ...
                                          if (unref(activeFilterChips).length === 0) {
                                            _push7(`<div class="text-body-2 text-medium-emphasis pa-4 text-center" data-v-8a7f361e${_scopeId6}> No filters active — export will include all stock items. </div>`);
                                          } else {
                                            _push7(`<div class="d-flex flex-wrap ga-2" data-v-8a7f361e${_scopeId6}><!--[-->`);
...
const excelBulk = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8a7f361e"]]);

export { excelBulk as default };
//# sourceMappingURL=excel-bulk-Chr1pTg4.mjs.map
