import { ref, computed, watch, resolveComponent, mergeProps, withCtx, createTextVNode, unref, isRef, toDisplayString, createVNode, openBlock, createBlock, createCommentVNode, useSSRContext } from 'file://D:/Projects/MY-APPS-2/DomendraPOS/frontend/node_modules/vue/index.mjs';
  ...
  setup(__props) {
    ...
    const filtered = computed(() => {
      ...
      if (searchText.value) {
        ...
        list = list.filter(
          (c) => {
            var _a, _b, _c;
            return ((_a = c.customer_name) == null ? void 0 : _a.toLowerCase().includes(s)) || ((_b = c.customer_phone) == null ? void 0 : _b.includes(s)) || ((_c = c.transaction_number) == null ? void 0 : _c.toLowerCase().includes(s));
          }
        );
      }
    ...
    const kpis = computed(() => {
      ...
      const avgDays = settled.length > 0 ? Math.round(settled.reduce((s, c) => {
        ...
        const lastPayment = ((_a = c.payments) == null ? void 0 : _a.length) > 0 ? new Date(c.payments[0].created_at) : /* @__PURE__ */ new Date();
    ...
    async function recordPayment() {
      ...
      try {
        ...
        const msg = ((_a = e == null ? void 0 : e.data) == null ? void 0 : _a.detail) || "Failed to record payment";
        errorToast(msg);
      } finally {
        saving.value = false;
      }
                  ...
                  _push3(ssrRenderComponent(VCardTitle, { class: "text-h6 font-weight-bold px-4 pt-4" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      ...
                      if (_push4) {
                        ...
                        _push4(` Payment History \u2014 ${ssrInterpolate((_a = unref(selectedCredit)) == null ? void 0 : _a.customer_name)}`);
                      } else {
                        return [
                          createVNode(VIcon, {
                            class: "mr-2",
                          ...
                          createTextVNode(" Payment History \u2014 " + toDisplayString((_b = unref(selectedCredit)) == null ? void 0 : _b.customer_name), 1)
                        ];
                      }
                    }),
                    _: 1
                    ...
                    createVNode(VCardTitle, { class: "text-h6 font-weight-bold px-4 pt-4" }, {
                      default: withCtx(() => {
                        ...
                        return [
                          ...
                          createTextVNode(" Payment History \u2014 " + toDisplayString((_a = unref(selectedCredit)) == null ? void 0 : _a.customer_name), 1)
                        ];
                      }),
                      _: 1
                    }),
...
//# sourceMappingURL=index-BoAxoqdx.mjs.map
