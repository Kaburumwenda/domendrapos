import { defineComponent, ref, computed, watch, mergeProps, withCtx, createTextVNode, unref, toDisplayString, isRef, createVNode, openBlock, createBlock, createCommentVNode, useSSRContext } from 'file://D:/Projects/MY-APPS-2/DomendraPOS/frontend/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrIncludeBooleanAttr, ssrRenderList, ssrRenderClass, ssrInterpolate, ssrRenderAttr, ssrRenderStyle, ssrLooseContain, ssrLooseEqual } from 'file://D:/Projects/MY-APPS-2/DomendraPOS/frontend/node_modules/vue/server-renderer/index.mjs';
import { u as useApi } from './useApi-D4YG8JPQ.mjs';
import { _ as _export_sfc, D as useToast, a as VIcon, x as VProgressCircular, q as VDialog, g as VCard, c as VBtn, k as VDivider } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const maxDayCount = computed(() => {
      var _a, _b;
      if (!((_b = (_a = summary.value) == null ? void 0 : _a.by_day) == null ? void 0 : _b.length)) return 1;
    ...
    const kpis = computed(() => {
      ...
      return [
        {
          label: "Total Events",
          value: (_b = (_a = summary.value) == null ? void 0 : _a.total) != null ? _b : logs.value.length,
          icon: "mdi-shield-key-outline",
          color: "primary"
        },
        {
          label: "Last 24 Hours",
          value: (_d = (_c = summary.value) == null ? void 0 : _c.recent_24h) != null ? _d : 0,
          icon: "mdi-clock-outline",
          color: "info"
        },
        {
          label: "Last 7 Days",
          value: (_f = (_e = summary.value) == null ? void 0 : _e.recent_7d) != null ? _f : 0,
          icon: "mdi-calendar-week-begin",
          color: "success"
        },
        {
          label: "Active Users",
          value: (_i = (_h = (_g = summary.value) == null ? void 0 : _g.by_user) == null ? void 0 : _h.length) != null ? _i : 0,
    ...
    const todayCount = computed(() => {
      ...
      return logs.value.filter((l) => {
        var _a;
        return (_a = l.timestamp) == null ? void 0 : _a.startsWith(today);
      }).length;
    });
...
//# sourceMappingURL=audit-logs-BJDwRv1W.mjs.map
