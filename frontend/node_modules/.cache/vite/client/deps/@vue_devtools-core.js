...
function flatHooks(configHooks, hooks2 = {}, parentName) {
  for (const key in configHooks) {
    ...
    if (typeof subHook === "object" && subHook !== null) flatHooks(subHook, hooks2, name);
    else if (typeof subHook === "function") hooks2[name] = subHook;
  }
  return hooks2;
}
...
var Hookable = class {
  ...
  removeHooks(configHooks) {
    const hooks2 = flatHooks(configHooks);
    for (const key in hooks2) this.removeHook(key, hooks2[key]);
  }
  removeAllHooks() {
...
var DevToolsMessagingEvents = (function(DevToolsMessagingEvents2) {
...
function createViteServerRpc(functions2) {
  createRpcServer(functions2, { preset: "vite" });
}
