...
import { camelizeProps, checkPrintable, deepEqual, ensureValidVNode, escapeForRegex, genericComponent, IN_BROWSER, isComposingIgnoreKey, noop, omit, propsFactory, useRender, wrapInArray } from "../../util/index.js"; // Types
  ...
  setup(props, {
    ...
    useRender(() => {
      ...
      return _createVNode(VTextField, _mergeProps({
        ...
        'append-inner': (...args) => _createElementVNode(_Fragment, null, [slots['append-inner']?.(...args), (!props.hideNoData || props.items.length) && props.menuIcon ? _createVNode(VIcon, {
