...
import { clamp, consoleWarn, genericComponent, normalizeMinusSign, omit, propsFactory, useRender } from "../../util/index.js"; // Types
...
export const VNumberInput = genericComponent()({
  ...
  setup(props, {
    ...
    function toNumber(val) {
      return Number(normalizeMinusSign(val ?? '').replaceAll(groupSeparator.value, '').replace(decimalSeparator.value, '.').replace(/[^0-9.-]/g, ''));
    }
