...
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrInterpolate, ssrRenderClass, ssrRenderStyle, ssrRenderAttr } from 'file://D:/Projects/MY-APPS-2/DomendraPOS/frontend/node_modules/vue/server-renderer/index.mjs';
  ...
  setup(__props) {
    ...
    async function loadData() {
      ...
      try {
        ...
        heatmapData.value = (heatmap == null ? void 0 : heatmap.grid) || heatmapData.value;
        ...
        recentTransactions.value = (recent == null ? void 0 : recent.results) || recent || [];
      } catch (e) {
...
//# sourceMappingURL=index-BXo13l3v.mjs.map
