import { _ as _sfc_main$1 } from './PaginationBar-D54ggLJ2.mjs';
import { ref, computed, watch, resolveComponent, mergeProps, withCtx, unref, createVNode, toDisplayString, isRef, createTextVNode, openBlock, createBlock, Fragment, renderList, createCommentVNode, useSSRContext } from 'file://D:/Projects/MY-APPS-2/DomendraPOS/frontend/node_modules/vue/index.mjs';
import { ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderStyle, ssrRenderClass } from 'file://D:/Projects/MY-APPS-2/DomendraPOS/frontend/node_modules/vue/server-renderer/index.mjs';
import { u as useFormat } from './useFormat-BvVWDMYe.mjs';
import { _ as _export_sfc, D as useToast, V as VContainer, e as VRow, f as VCol, W as VBtnToggle, c as VBtn, b as VSpacer, g as VCard, a as VIcon, h as VTabs, i as VTab, o as VChip, v as VTextField, J as VSelect, x as VProgressCircular, H as VAvatar, G as VTable, k as VDivider, p as VProgressLinear, q as VDialog, r as VCardTitle, s as VCardText, w as VCardActions } from './server.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    computed(
      () => {
        var _a;
        return ((_a = datePresetItems.find((p) => p.value === datePreset.value)) == null ? void 0 : _a.title) || "";
      }
    );
    ...
    const filteredSales = computed(() => {
      ...
      const q = (_a = searchQuery.value) == null ? void 0 : _a.toLowerCase().trim();
      if (q) {
        list = list.filter(
    ...
    const paymentChartOptions = computed(() => {
      ...
      const labels = [...map.keys()].map((k) => {
        ...
        return (item == null ? void 0 : item.payment_method_display) || k;
      });
      return {
    ...
    async function loadSales() {
      ...
      try {
        ...
        sales2.value = allSales.map((s) => {
          var _a;
          return { ...s, lines_count: s.items_count || ((_a = s.items) == null ? void 0 : _a.length) || 0 };
        });
        const costMap = /* @__PURE__ */ new Map();
    ...
    function exportCsv() {
      ...
      for (const r of rows) {
        const cells = [
          ...
          r.status || "",
          r.lines_count || 0,
          (_a = r.subtotal) != null ? _a : "",
          (_b = r.discount) != null ? _b : "",
          (_c = r.tax) != null ? _c : "",
          (_d = r.total) != null ? _d : "",
          r.created_at || ""
        ];
          ...
          if (_push2) {
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(VCol, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="text-h5 font-weight-bold" data-v-c9d5c0dc${_scopeId3}>Sales</div><div class="text-body-2 text-medium-emphasis" data-v-c9d5c0dc${_scopeId3}>${ssrInterpolate(unref(stats).totalSales)} sales \xB7 ${ssrInterpolate(unref(currency)(unref(stats).totalRevenue))} revenue \xB7 ${ssrInterpolate(unref(formatNumber)(unref(stats).totalItems))} items sold </div>`);
                      } else {
                        return [
                          createVNode("div", { class: "text-h5 font-weight-bold" }, "Sales"),
                          createVNode("div", { class: "text-body-2 text-medium-emphasis" }, toDisplayString(unref(stats).totalSales) + " sales \xB7 " + toDisplayString(unref(currency)(unref(stats).totalRevenue)) + " revenue \xB7 " + toDisplayString(unref(formatNumber)(unref(stats).totalItems)) + " items sold ", 1)
                        ];
                      }
                    }),
                    _: 1
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(VCard, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="d-flex align-start justify-space-between mb-2" data-v-c9d5c0dc${_scopeId4}><span class="text-caption text-medium-emphasis font-weight-medium" data-v-c9d5c0dc${_scopeId4}>Total Sales</span><div class="kpi-icon kpi-icon-blue" data-v-c9d5c0dc${_scopeId4}>`);
                              _push5(ssrRenderComponent(VIcon, {
                                size: "18",
                                icon: "mdi-receipt-text-outline"
                              }, null, _parent5, _scopeId4));
                              _push5(`</div></div><p class="text-h4 font-weight-bold mb-1" data-v-c9d5c0dc${_scopeId4}>${ssrInterpolate(unref(stats).totalSales)}</p><span class="text-caption text-medium-emphasis" data-v-c9d5c0dc${_scopeId4}>${ssrInterpolate(unref(stats).completedCount)} completed</span>`);
                            } else {
                              return [
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(VCard, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="d-flex align-start justify-space-between mb-2" data-v-c9d5c0dc${_scopeId4}><span class="text-caption text-medium-emphasis font-weight-medium" data-v-c9d5c0dc${_scopeId4}>Total Revenue</span><div class="kpi-icon kpi-icon-green" data-v-c9d5c0dc${_scopeId4}>`);
                              _push5(ssrRenderComponent(VIcon, {
                                size: "18",
                                icon: "mdi-cash-multiple"
                              }, null, _parent5, _scopeId4));
                              _push5(`</div></div><p class="text-h4 font-weight-bold mb-1 text-success" data-v-c9d5c0dc${_scopeId4}>${ssrInterpolate(unref(currency)(unref(stats).totalRevenue))}</p><span class="text-caption text-medium-emphasis" data-v-c9d5c0dc${_scopeId4}>Avg: ${ssrInterpolate(unref(currency)(unref(stats).avgSale))}</span>`);
                            } else {
                              return [
                                createVNode("div", { class: "d-flex align-start justify-space-between mb-2" }, [
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(VCard, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="d-flex align-start justify-space-between mb-2" data-v-c9d5c0dc${_scopeId4}><span class="text-caption text-medium-emphasis font-weight-medium" data-v-c9d5c0dc${_scopeId4}>Avg Sale Value</span><div class="kpi-icon kpi-icon-purple" data-v-c9d5c0dc${_scopeId4}>`);
                              _push5(ssrRenderComponent(VIcon, {
                                size: "18",
                                icon: "mdi-chart-line-variant"
                              }, null, _parent5, _scopeId4));
                              _push5(`</div></div><p class="text-h4 font-weight-bold mb-1" data-v-c9d5c0dc${_scopeId4}>${ssrInterpolate(unref(currency)(unref(stats).avgSale))}</p><span class="text-caption text-medium-emphasis" data-v-c9d5c0dc${_scopeId4}>${ssrInterpolate(unref(stats).totalDiscount > 0 ? "Discount: " + unref(currency)(unref(stats).totalDiscount) : "No discounts")}</span>`);
                            } else {
                              return [
                                createVNode("div", { class: "d-flex align-start justify-space-between mb-2" }, [
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(VCard, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="d-flex align-start justify-space-between mb-2" data-v-c9d5c0dc${_scopeId4}><span class="text-caption text-medium-emphasis font-weight-medium" data-v-c9d5c0dc${_scopeId4}>Items Sold</span><div class="kpi-icon kpi-icon-orange" data-v-c9d5c0dc${_scopeId4}>`);
                              _push5(ssrRenderComponent(VIcon, {
                                size: "18",
                                icon: "mdi-package-variant-closed"
                              }, null, _parent5, _scopeId4));
                              _push5(`</div></div><p class="text-h4 font-weight-bold mb-1" data-v-c9d5c0dc${_scopeId4}>${ssrInterpolate(unref(formatNumber)(unref(stats).totalItems))}</p><span class="text-caption text-medium-emphasis" data-v-c9d5c0dc${_scopeId4}>${ssrInterpolate(unref(stats).uniqueProducts)} unique products</span>`);
                            } else {
                              return [
                                createVNode("div", { class: "d-flex align-start justify-space-between mb-2" }, [
            ...
            if (unref(activeTab) === "transactions") {
              ...
              if (unref(hasActiveFilters)) {
                _push2(`<div class="d-flex align-center flex-wrap ga-2 mb-4" data-v-c9d5c0dc${_scopeId}><span class="text-body-2 text-medium-emphasis" data-v-c9d5c0dc${_scopeId}>Filters:</span>`);
                ...
                _push2(ssrRenderComponent(VCard, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      ...
                      _push3(`<div class="text-body-2 text-medium-emphasis" data-v-c9d5c0dc${_scopeId2}>Loading sales...</div>`);
                    } else {
                      return [
                ...
                _push2(ssrRenderComponent(VCard, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      ...
                      _push3(`<div class="text-h6 font-weight-bold mb-1" data-v-c9d5c0dc${_scopeId2}>No sales found</div><div class="text-body-2 text-medium-emphasis" data-v-c9d5c0dc${_scopeId2}>${ssrInterpolate(unref(hasActiveFilters) ? "Try adjusting your filters." : "Sales will appear here once transactions are processed.")}</div>`);
                    } else {
                      return [
                        createVNode(VAvatar, {
                          color: "blue-lighten-5",
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(ssrRenderComponent(VTable, {
                        ...
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            _push4(`<thead class="bg-grey-lighten-4" data-v-c9d5c0dc${_scopeId3}><tr data-v-c9d5c0dc${_scopeId3}><th class="text-center" style="${ssrRenderStyle({ "width": "52px" })}" data-v-c9d5c0dc${_scopeId3}>#</th><th class="text-left" style="${ssrRenderStyle({ "min-width": "160px" })}" data-v-c9d5c0dc${_scopeId3}>Transaction #</th><th class="text-left" data-v-c9d5c0dc${_scopeId3}>Customer</th><th class="text-left" data-v-c9d5c0dc${_scopeId3}>Cashier</th><th class="text-left" data-v-c9d5c0dc${_scopeId3}>Payment</th><th class="text-right" data-v-c9d5c0dc${_scopeId3}>Items</th><th class="text-right" data-v-c9d5c0dc${_scopeId3}>Subtotal</th><th class="text-right" data-v-c9d5c0dc${_scopeId3}>Discount</th><th class="text-right" data-v-c9d5c0dc${_scopeId3}>Tax</th><th class="text-right" data-v-c9d5c0dc${_scopeId3}>Total</th><th class="text-left" data-v-c9d5c0dc${_scopeId3}>Status</th><th class="text-left" data-v-c9d5c0dc${_scopeId3}>Date</th></tr></thead><tbody data-v-c9d5c0dc${_scopeId3}><!--[-->`);
                            ssrRenderList(unref(pagedSales), (sale, idx) => {
                              _push4(`<tr style="${ssrRenderStyle({ "cursor": "pointer" })}" data-v-c9d5c0dc${_scopeId3}><td class="text-center text-caption text-disabled font-weight-bold" data-v-c9d5c0dc${_scopeId3}>${ssrInterpolate(rowNumber(idx))}</td><td data-v-c9d5c0dc${_scopeId3}><div class="d-flex align-center ga-2" data-v-c9d5c0dc${_scopeId3}>`);
                              ...
                              _push4(`<span class="text-body-2 font-weight-bold font-mono" data-v-c9d5c0dc${_scopeId3}>${ssrInterpolate(sale.transaction_number)}</span></div></td><td data-v-c9d5c0dc${_scopeId3}>`);
                              if (sale.customer_name && sale.customer_name !== "Walk-in") {
                                _push4(`<span class="text-body-2" data-v-c9d5c0dc${_scopeId3}>${ssrInterpolate(sale.customer_name)}</span>`);
                              } else {
                                _push4(`<span class="text-disabled" data-v-c9d5c0dc${_scopeId3}>Walk-in</span>`);
                              }
                              _push4(`</td><td class="text-body-2 text-medium-emphasis" data-v-c9d5c0dc${_scopeId3}>${ssrInterpolate(sale.cashier_name || "\u2014")}</td><td data-v-c9d5c0dc${_scopeId3}>`);
                              if (sale.payment_method) {
                                ...
                                _push4(`<span class="text-disabled" data-v-c9d5c0dc${_scopeId3}>\u2014</span>`);
                              }
                              _push4(`</td><td class="text-right text-body-2" data-v-c9d5c0dc${_scopeId3}>${ssrInterpolate(sale.lines_count)}</td><td class="text-right text-body-2" data-v-c9d5c0dc${_scopeId3}>${ssrInterpolate(unref(currency)(sale.subtotal))}</td><td class="text-right text-body-2 text-error" data-v-c9d5c0dc${_scopeId3}>-${ssrInterpolate(unref(currency)(sale.discount))}</td><td class="text-right text-body-2 text-medium-emphasis" data-v-c9d5c0dc${_scopeId3}>${ssrInterpolate(unref(currency)(sale.tax))}</td><td class="text-right" data-v-c9d5c0dc${_scopeId3}><span class="font-weight-bold" data-v-c9d5c0dc${_scopeId3}>${ssrInterpolate(unref(currency)(sale.total))}</span></td><td data-v-c9d5c0dc${_scopeId3}>`);
                              _push4(ssrRenderComponent(VChip, {
                                size: "small",
                                color: statusColor(sale.status),
                                variant: "tonal",
                              ...
                              _push4(`</td><td class="text-body-2 text-medium-emphasis" data-v-c9d5c0dc${_scopeId3}>${ssrInterpolate(unref(datetime)(sale.created_at))}</td></tr>`);
                            });
                            _push4(`<!--]--></tbody>`);
                          } else {
                            return [
            ...
            if (unref(activeTab) === "analytics") {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(VCard, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<div class="d-flex align-start justify-space-between" data-v-c9d5c0dc${_scopeId4}><div data-v-c9d5c0dc${_scopeId4}><div class="text-caption text-medium-emphasis text-uppercase" data-v-c9d5c0dc${_scopeId4}>Gross Revenue</div><div class="text-h5 font-weight-bold text-success mt-2" data-v-c9d5c0dc${_scopeId4}>${ssrInterpolate(unref(currency)(unref(analytics).totalRevenue))}</div></div>`);
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(VCard, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<div class="d-flex align-start justify-space-between" data-v-c9d5c0dc${_scopeId4}><div data-v-c9d5c0dc${_scopeId4}><div class="text-caption text-medium-emphasis text-uppercase" data-v-c9d5c0dc${_scopeId4}>Avg Items / Sale</div><div class="text-h5 font-weight-bold mt-2" data-v-c9d5c0dc${_scopeId4}>${ssrInterpolate(unref(analytics).avgItemsPerSale.toFixed(1))}</div></div>`);
                                _push5(ssrRenderComponent(VAvatar, {
                                  color: "blue-lighten-5",
                                  rounded: "lg",
                                  size: "40"
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(VCard, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<div class="d-flex align-start justify-space-between" data-v-c9d5c0dc${_scopeId4}><div data-v-c9d5c0dc${_scopeId4}><div class="text-caption text-medium-emphasis text-uppercase" data-v-c9d5c0dc${_scopeId4}>Total Discount</div><div class="text-h5 font-weight-bold text-error mt-2" data-v-c9d5c0dc${_scopeId4}>${ssrInterpolate(unref(currency)(unref(analytics).totalDiscount))}</div></div>`);
                                _push5(ssrRenderComponent(VAvatar, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(VCard, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<div class="d-flex align-start justify-space-between" data-v-c9d5c0dc${_scopeId4}><div data-v-c9d5c0dc${_scopeId4}><div class="text-caption text-medium-emphasis text-uppercase" data-v-c9d5c0dc${_scopeId4}>Conversion Rate</div><div class="text-h5 font-weight-bold mt-2" data-v-c9d5c0dc${_scopeId4}>${ssrInterpolate(unref(analytics).completionRate.toFixed(1))}%</div></div>`);
                                _push5(ssrRenderComponent(VAvatar, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(VCard, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<div class="d-flex align-center ga-2 mb-3" data-v-c9d5c0dc${_scopeId4}>`);
                                _push5(ssrRenderComponent(VAvatar, {
                                  color: "blue-lighten-5",
                                  rounded: "lg",
                                  size: "36"
                                ...
                                _push5(`<div data-v-c9d5c0dc${_scopeId4}><div class="text-subtitle-1 font-weight-bold" data-v-c9d5c0dc${_scopeId4}>Revenue Trend</div><div class="text-caption text-medium-emphasis" data-v-c9d5c0dc${_scopeId4}>Daily revenue over selected period</div></div></div>`);
                          ...
                          _push4(ssrRenderComponent(VCard, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                ...
                                _push5(`<div data-v-c9d5c0dc${_scopeId4}><div class="text-subtitle-1 font-weight-bold" data-v-c9d5c0dc${_scopeId4}>Payment Methods</div><div class="text-caption text-medium-emphasis" data-v-c9d5c0dc${_scopeId4}>Revenue by payment type</div></div></div>`);
                                _push5(ssrRenderComponent(_component_apexchart, {
                                  type: "donut",
                                  height: "300",
                          ...
                          _push4(ssrRenderComponent(VCard, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                ...
                                _push5(`<div data-v-c9d5c0dc${_scopeId4}><div class="text-subtitle-1 font-weight-bold" data-v-c9d5c0dc${_scopeId4}>Top 10 Products by Revenue</div><div class="text-caption text-medium-emphasis" data-v-c9d5c0dc${_scopeId4}>Best-selling products this period</div></div></div>`);
                                _push5(ssrRenderComponent(_component_apexchart, {
                                  type: "bar",
                                  height: "320",
                          ...
                          _push4(ssrRenderComponent(VCard, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                ...
                                _push5(`<div data-v-c9d5c0dc${_scopeId4}><div class="text-subtitle-1 font-weight-bold" data-v-c9d5c0dc${_scopeId4}>Sales by Status</div><div class="text-caption text-medium-emphasis" data-v-c9d5c0dc${_scopeId4}>Transaction status distribution</div></div></div>`);
                                _push5(ssrRenderComponent(_component_apexchart, {
                                  type: "donut",
                                  height: "300",
                          ...
                          _push4(ssrRenderComponent(VCard, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                ...
                                _push5(`<div data-v-c9d5c0dc${_scopeId4}><div class="text-subtitle-1 font-weight-bold" data-v-c9d5c0dc${_scopeId4}>Sales by Day of Week</div><div class="text-caption text-medium-emphasis" data-v-c9d5c0dc${_scopeId4}>Revenue distribution across weekdays</div></div></div>`);
                                _push5(ssrRenderComponent(_component_apexchart, {
                                  type: "bar",
                                  height: "280",
                          ...
                          _push4(ssrRenderComponent(VCard, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                ...
                                _push5(`<div data-v-c9d5c0dc${_scopeId4}><div class="text-subtitle-1 font-weight-bold" data-v-c9d5c0dc${_scopeId4}>Peak Hours</div><div class="text-caption text-medium-emphasis" data-v-c9d5c0dc${_scopeId4}>Revenue and transactions by hour</div></div></div>`);
                                _push5(ssrRenderComponent(_component_apexchart, {
                                  type: "bar",
                                  height: "280",
              ...
              _push2(ssrRenderComponent(VCard, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="d-flex align-center ga-2 pa-4 pb-2 flex-wrap" data-v-c9d5c0dc${_scopeId2}>`);
                    _push3(ssrRenderComponent(VAvatar, {
                    ...
                    _push3(`<div class="me-auto" data-v-c9d5c0dc${_scopeId2}><div class="text-subtitle-1 font-weight-bold" data-v-c9d5c0dc${_scopeId2}>Time of Day Breakdown</div><div class="text-caption text-medium-emphasis" data-v-c9d5c0dc${_scopeId2}>Revenue and transactions grouped by time-of-day ranges</div></div>`);
                    ...
                    _push3(`<div class="peak-hours-layout" data-v-c9d5c0dc${_scopeId2}><div class="peak-hours-layout__chart" data-v-c9d5c0dc${_scopeId2}>`);
                    ...
                    _push3(`</div><div class="peak-hours-layout__ranges" data-v-c9d5c0dc${_scopeId2}><!--[-->`);
                    ssrRenderList(unref(timeRangeStats), (r) => {
                      var _a, _b, _c;
                      _push3(`<div class="${ssrRenderClass([{ "time-range-card--peak": r.label === ((_a = unref(busiestRange)) == null ? void 0 : _a.label) }, "time-range-card"])}" data-v-c9d5c0dc${_scopeId2}><div class="time-range-card__bar" style="${ssrRenderStyle({ background: r.color })}" data-v-c9d5c0dc${_scopeId2}></div><div class="time-range-card__body" data-v-c9d5c0dc${_scopeId2}><div class="d-flex align-center ga-1" data-v-c9d5c0dc${_scopeId2}>`);
                      _push3(ssrRenderComponent(VIcon, {
                        size: "16",
                        color: r.label === ((_b = unref(busiestRange)) == null ? void 0 : _b.label) ? "amber" : void 0
                      }, {
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                      ...
                      _push3(`<span class="text-subtitle-2 font-weight-bold" data-v-c9d5c0dc${_scopeId2}>${ssrInterpolate(r.label)}</span>`);
                      if (r.label === ((_c = unref(busiestRange)) == null ? void 0 : _c.label)) {
                        _push3(ssrRenderComponent(VIcon, {
                          size: "14",
                          color: "amber"
                        }, {
                      ...
                      _push3(`<span class="text-caption text-medium-emphasis" style="${ssrRenderStyle({ "font-size": "11px" })}" data-v-c9d5c0dc${_scopeId2}>${ssrInterpolate(r.sub)}</span></div><div class="d-flex align-center ga-2 mt-2" data-v-c9d5c0dc${_scopeId2}><div class="text-subtitle-1 font-weight-bold" data-v-c9d5c0dc${_scopeId2}>${ssrInterpolate(unref(currency)(r.revenue))}</div>`);
                      _push3(ssrRenderComponent(VSpacer, null, null, _parent3, _scopeId2));
                      _push3(`<span class="text-caption" style="${ssrRenderStyle({ "font-size": "10px" })}" data-v-c9d5c0dc${_scopeId2}>${ssrInterpolate(r.revenuePct.toFixed(0))}% rev</span></div><div class="time-range-card__progress mt-1" data-v-c9d5c0dc${_scopeId2}><div class="time-range-card__progress-fill" style="${ssrRenderStyle({ width: r.revenuePct + "%", background: r.color })}" data-v-c9d5c0dc${_scopeId2}></div></div><div class="text-caption text-medium-emphasis mt-1" style="${ssrRenderStyle({ "font-size": "10px" })}" data-v-c9d5c0dc${_scopeId2}>${ssrInterpolate(r.count)} txn${ssrInterpolate(r.count === 1 ? "" : "s")} \xB7 ${ssrInterpolate(r.sharePct.toFixed(0))}% of day </div></div></div>`);
                    });
                    _push3(`<!--]--></div></div>`);
                  } else {
                    return [
                        ...
                        createVNode("div", { class: "peak-hours-layout__ranges" }, [
                          (openBlock(true), createBlock(Fragment, null, renderList(unref(timeRangeStats), (r) => {
                            ...
                            return openBlock(), createBlock("div", {
                              key: r.label,
                              class: ["time-range-card", { "time-range-card--peak": r.label === ((_a = unref(busiestRange)) == null ? void 0 : _a.label) }]
                            }, [
                              createVNode("div", {
                              ...
                              createVNode("div", { class: "time-range-card__body" }, [
                                createVNode("div", { class: "d-flex align-center ga-1" }, [
                                  ...
                                  r.label === ((_c = unref(busiestRange)) == null ? void 0 : _c.label) ? (openBlock(), createBlock(VIcon, {
                                    key: 0,
                                    size: "14",
                                    color: "amber"
                                  }, {
                                ...
                                createVNode("div", {
                                  ...
                                  style: { "font-size": "10px" }
                                }, toDisplayString(r.count) + " txn" + toDisplayString(r.count === 1 ? "" : "s") + " \xB7 " + toDisplayString(r.sharePct.toFixed(0)) + "% of day ", 1)
                              ])
                            ], 2);
                          }), 128))
                        ])
              ...
              _push2(ssrRenderComponent(VCard, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="d-flex align-center ga-2 pa-4 pb-2" data-v-c9d5c0dc${_scopeId2}>`);
                    _push3(ssrRenderComponent(VAvatar, {
                    ...
                    _push3(`<div data-v-c9d5c0dc${_scopeId2}><div class="text-subtitle-1 font-weight-bold" data-v-c9d5c0dc${_scopeId2}>Cashier Performance</div><div class="text-caption text-medium-emphasis" data-v-c9d5c0dc${_scopeId2}>Sales activity by cashier</div></div></div>`);
                    _push3(ssrRenderComponent(VTable, {
                      density: "compact",
                      hover: ""
                    }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<thead class="bg-grey-lighten-4" data-v-c9d5c0dc${_scopeId3}><tr data-v-c9d5c0dc${_scopeId3}><th class="text-left" data-v-c9d5c0dc${_scopeId3}>Cashier</th><th class="text-right" data-v-c9d5c0dc${_scopeId3}>Transactions</th><th class="text-right" data-v-c9d5c0dc${_scopeId3}>Revenue</th><th class="text-right" data-v-c9d5c0dc${_scopeId3}>Avg Order</th><th class="text-right" data-v-c9d5c0dc${_scopeId3}>Items Sold</th><th class="text-right" data-v-c9d5c0dc${_scopeId3}>% of Revenue</th><th style="${ssrRenderStyle({ "width": "120px" })}" data-v-c9d5c0dc${_scopeId3}>Performance</th></tr></thead><tbody data-v-c9d5c0dc${_scopeId3}><!--[-->`);
                          ssrRenderList(unref(cashierPerformance), (c, idx) => {
                            _push4(`<tr data-v-c9d5c0dc${_scopeId3}><td data-v-c9d5c0dc${_scopeId3}><div class="d-flex align-center ga-2" data-v-c9d5c0dc${_scopeId3}>`);
                            _push4(ssrRenderComponent(VAvatar, {
                              size: "32",
                              rounded: "lg",
                              ...
                              default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                if (_push5) {
                                  _push5(`<span class="text-body-2 font-weight-bold" data-v-c9d5c0dc${_scopeId4}>${ssrInterpolate((c.name || "?").charAt(0).toUpperCase())}</span>`);
                                } else {
                                  return [
                            ...
                            _push4(`<span class="text-body-2 font-weight-medium" data-v-c9d5c0dc${_scopeId3}>${ssrInterpolate(c.name || "Unknown")}</span></div></td><td class="text-right text-body-2" data-v-c9d5c0dc${_scopeId3}>${ssrInterpolate(c.count)}</td><td class="text-right font-weight-bold text-success" data-v-c9d5c0dc${_scopeId3}>${ssrInterpolate(unref(currency)(c.revenue))}</td><td class="text-right text-body-2" data-v-c9d5c0dc${_scopeId3}>${ssrInterpolate(unref(currency)(c.avgOrder))}</td><td class="text-right text-body-2" data-v-c9d5c0dc${_scopeId3}>${ssrInterpolate(unref(formatNumber)(c.items))}</td><td class="text-right text-body-2 text-medium-emphasis" data-v-c9d5c0dc${_scopeId3}>${ssrInterpolate(c.share.toFixed(1))}%</td><td data-v-c9d5c0dc${_scopeId3}>`);
                          ...
                          if (unref(cashierPerformance).length === 0) {
                            _push4(`<tr data-v-c9d5c0dc${_scopeId3}><td colspan="7" class="text-center py-8 text-medium-emphasis" data-v-c9d5c0dc${_scopeId3}>No cashier data for this period.</td></tr>`);
                          } else {
                            _push4(`<!---->`);
                          }
                          _push4(`</tbody>`);
                      ...
                      if (_push4) {
                        _push4(ssrRenderComponent(VCardTitle, { class: "d-flex align-center justify-space-between pa-4" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            ...
                            if (_push5) {
                              _push5(`<div class="d-flex align-center ga-3" data-v-c9d5c0dc${_scopeId4}>`);
                              _push5(ssrRenderComponent(VAvatar, {
                                color: statusColor((_a = unref(selectedSale)) == null ? void 0 : _a.status),
                                variant: "tonal",
                                rounded: "lg",
                                size: "40"
                              }, {
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  ...
                                  if (_push6) {
                                    _push6(ssrRenderComponent(VIcon, {
                                      icon: statusIcon((_a2 = unref(selectedSale)) == null ? void 0 : _a2.status)
                                    }, null, _parent6, _scopeId5));
                                  } else {
                                    return [
                                      createVNode(VIcon, {
                                        icon: statusIcon((_b2 = unref(selectedSale)) == null ? void 0 : _b2.status)
                                      }, null, 8, ["icon"])
                                    ];
                                  }
                                }),
                              ...
                              _push5(`<div data-v-c9d5c0dc${_scopeId4}><div class="text-h6 font-weight-bold" data-v-c9d5c0dc${_scopeId4}>${ssrInterpolate((_b = unref(selectedSale)) == null ? void 0 : _b.transaction_number)}</div><div class="text-caption text-medium-emphasis" data-v-c9d5c0dc${_scopeId4}>${ssrInterpolate(unref(datetime)((_c = unref(selectedSale)) == null ? void 0 : _c.created_at))}</div></div></div>`);
                              _push5(ssrRenderComponent(VBtn, {
                                variant: "text",
                                icon: "mdi-close",
                                size: "small",
                              ...
                              return [
                                createVNode("div", { class: "d-flex align-center ga-3" }, [
                                  createVNode(VAvatar, {
                                    color: statusColor((_d = unref(selectedSale)) == null ? void 0 : _d.status),
                                    variant: "tonal",
                                    rounded: "lg",
                                    size: "40"
                                  }, {
                                  ...
                                  createVNode("div", null, [
                                    createVNode("div", { class: "text-h6 font-weight-bold" }, toDisplayString((_e = unref(selectedSale)) == null ? void 0 : _e.transaction_number), 1),
                                    createVNode("div", { class: "text-caption text-medium-emphasis" }, toDisplayString(unref(datetime)((_f = unref(selectedSale)) == null ? void 0 : _f.created_at)), 1)
                                  ])
                                ]),
                                createVNode(VBtn, {
                                  variant: "text",
                        ...
                        if (unref(selectedSale)) {
                          _push4(ssrRenderComponent(VCardText, { class: "pt-2" }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              var _a, _b;
                              if (_push5) {
                                _push5(`<div class="d-flex align-center ga-2 mb-4 flex-wrap" data-v-c9d5c0dc${_scopeId4}>`);
                                _push5(ssrRenderComponent(VChip, {
                                  size: "small",
                                ...
                                _push5(`<span class="text-body-2 text-medium-emphasis" data-v-c9d5c0dc${_scopeId4}>${ssrInterpolate(unref(selectedSale).customer_name || "Walk-in")} \xB7 ${ssrInterpolate(unref(selectedSale).cashier_name || "\u2014")} \xB7 ${ssrInterpolate(unref(selectedSale).branch_name || "\u2014")}</span></div><div class="text-subtitle-2 font-weight-bold mb-2" data-v-c9d5c0dc${_scopeId4}>Line Items (${ssrInterpolate(((_a = unref(selectedSale).items) == null ? void 0 : _a.length) || 0)})</div>`);
                                _push5(ssrRenderComponent(VTable, {
                                  ...
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`<thead class="bg-grey-lighten-4" data-v-c9d5c0dc${_scopeId5}><tr data-v-c9d5c0dc${_scopeId5}><th class="text-left" data-v-c9d5c0dc${_scopeId5}>Product</th><th class="text-right" data-v-c9d5c0dc${_scopeId5}>Qty</th><th class="text-right" data-v-c9d5c0dc${_scopeId5}>Price</th><th class="text-right" data-v-c9d5c0dc${_scopeId5}>Total</th></tr></thead><tbody data-v-c9d5c0dc${_scopeId5}><!--[-->`);
                                      ssrRenderList(unref(selectedSale).items, (item) => {
                                        _push6(`<tr data-v-c9d5c0dc${_scopeId5}><td data-v-c9d5c0dc${_scopeId5}><div class="text-body-2 font-weight-medium" data-v-c9d5c0dc${_scopeId5}>${ssrInterpolate(item.product_name)}</div><div class="text-caption text-disabled" data-v-c9d5c0dc${_scopeId5}>${ssrInterpolate(item.product_sku)}</div></td><td class="text-right text-body-2" data-v-c9d5c0dc${_scopeId5}>${ssrInterpolate(unref(formatNumber)(item.quantity))}</td><td class="text-right text-body-2" data-v-c9d5c0dc${_scopeId5}>${ssrInterpolate(unref(currency)(item.unit_price))}</td><td class="text-right text-body-2 font-weight-medium" data-v-c9d5c0dc${_scopeId5}>${ssrInterpolate(unref(currency)(item.line_total))}</td></tr>`);
                                      });
                                      _push6(`<!--]--></tbody>`);
                                    } else {
                                      return [
                                ...
                                _push5(`<div class="d-flex flex-column align-end ga-1" data-v-c9d5c0dc${_scopeId4}><div class="d-flex justify-space-between" style="${ssrRenderStyle({ "width": "220px" })}" data-v-c9d5c0dc${_scopeId4}><span class="text-body-2 text-medium-emphasis" data-v-c9d5c0dc${_scopeId4}>Subtotal</span><span class="text-body-2 font-weight-medium" data-v-c9d5c0dc${_scopeId4}>${ssrInterpolate(unref(currency)(unref(selectedSale).subtotal))}</span></div><div class="d-flex justify-space-between" style="${ssrRenderStyle({ "width": "220px" })}" data-v-c9d5c0dc${_scopeId4}><span class="text-body-2 text-medium-emphasis" data-v-c9d5c0dc${_scopeId4}>Discount</span><span class="text-body-2 font-weight-medium text-error" data-v-c9d5c0dc${_scopeId4}>-${ssrInterpolate(unref(currency)(unref(selectedSale).discount))}</span></div><div class="d-flex justify-space-between" style="${ssrRenderStyle({ "width": "220px" })}" data-v-c9d5c0dc${_scopeId4}><span class="text-body-2 text-medium-emphasis" data-v-c9d5c0dc${_scopeId4}>Tax</span><span class="text-body-2 font-weight-medium" data-v-c9d5c0dc${_scopeId4}>${ssrInterpolate(unref(currency)(unref(selectedSale).tax))}</span></div>`);
                                _push5(ssrRenderComponent(VDivider, {
                                  class: "my-1",
                                  style: { "width": "220px" }
                                }, null, _parent5, _scopeId4));
                                _push5(`<div class="d-flex justify-space-between" style="${ssrRenderStyle({ "width": "220px" })}" data-v-c9d5c0dc${_scopeId4}><span class="text-subtitle-2 font-weight-bold" data-v-c9d5c0dc${_scopeId4}>Total</span><span class="text-subtitle-1 font-weight-bold text-primary" data-v-c9d5c0dc${_scopeId4}>${ssrInterpolate(unref(currency)(unref(selectedSale).total))}</span></div></div>`);
                              } else {
                                return [
                                  createVNode("div", { class: "d-flex align-center ga-2 mb-4 flex-wrap" }, [
                                    ...
                                    createVNode("span", { class: "text-body-2 text-medium-emphasis" }, toDisplayString(unref(selectedSale).customer_name || "Walk-in") + " \xB7 " + toDisplayString(unref(selectedSale).cashier_name || "\u2014") + " \xB7 " + toDisplayString(unref(selectedSale).branch_name || "\u2014"), 1)
                                  ]),
                                  createVNode("div", { class: "text-subtitle-2 font-weight-bold mb-2" }, "Line Items (" + toDisplayString(((_b = unref(selectedSale).items) == null ? void 0 : _b.length) || 0) + ")", 1),
                                  createVNode(VTable, {
                                    density: "compact",
                                    class: "mb-4 rounded border"
                                  }, {
                            ...
                            default: withCtx(() => {
                              ...
                              return [
                                createVNode("div", { class: "d-flex align-center ga-3" }, [
                                  ...
                                  createVNode("div", null, [
                                    createVNode("div", { class: "text-h6 font-weight-bold" }, toDisplayString((_b = unref(selectedSale)) == null ? void 0 : _b.transaction_number), 1),
                                    createVNode("div", { class: "text-caption text-medium-emphasis" }, toDisplayString(unref(datetime)((_c = unref(selectedSale)) == null ? void 0 : _c.created_at)), 1)
                                  ])
                                ]),
                                createVNode(VBtn, {
                                  variant: "text",
                          ...
                          unref(selectedSale) ? (openBlock(), createBlock(VCardText, {
                            ...
                            default: withCtx(() => {
                              ...
                              return [
                                ...
                                createVNode("div", { class: "text-subtitle-2 font-weight-bold mb-2" }, "Line Items (" + toDisplayString(((_a = unref(selectedSale).items) == null ? void 0 : _a.length) || 0) + ")", 1),
                                createVNode(VTable, {
                                  density: "compact",
                                  class: "mb-4 rounded border"
                                }, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(VCardTitle, { class: "d-flex align-center justify-space-between" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<span class="text-h6" data-v-c9d5c0dc${_scopeId4}>Custom Date Range</span>`);
                              _push5(ssrRenderComponent(VBtn, {
                                variant: "text",
                                icon: "mdi-close",
                                size: "small",
...
const sales = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c9d5c0dc"]]);

export { sales as default };
//# sourceMappingURL=sales-CFYDzZOq.mjs.map
