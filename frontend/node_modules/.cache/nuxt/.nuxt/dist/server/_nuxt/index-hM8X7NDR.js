...
import { u as useBranchStore } from "./branch-BiP_OPcQ.js";
import { u as useAuthStore } from "./auth-DdTzNN53.js";
import { u as useFormat } from "./useFormat-DI4cy1hR.js";
import { M as useToast, d as VIcon, f as VSpacer, g as VBtn, v as VChip, o as VBadge, O as VSelect, C as VTextField, R as VBtnToggle, w as VProgressLinear, a1 as VImg, Z as VPagination, p as VDivider, x as VDialog, k as VCard, y as VCardTitle, z as VCardText, a2 as VAutocomplete, h as VAlert, D as VCardActions, X as VTextarea, N as VAvatar } from "../server.mjs";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "pos-shell" }, _attrs))} data-v-caeecab3><div class="pos-topbar" data-v-caeecab3>`);
      ...
      _push(`<div data-v-caeecab3><div class="text-subtitle-1 font-weight-bold" data-v-caeecab3> Point of Sale<span class="text-caption text-medium-emphasis font-weight-regular" data-v-caeecab3>· Walk-in / OTC sales</span></div><div class="text-caption text-medium-emphasis" data-v-caeecab3>${ssrInterpolate(unref(today))} · Cashier: ${ssrInterpolate(unref(cashierShort))}</div></div>`);
      ...
      _push(`</div><div class="pos-grid" data-v-caeecab3><section class="pos-products" data-v-caeecab3><div class="pos-search-bar" data-v-caeecab3>`);
      ...
      if (!unref(loading)) {
        _push(`<div class="pos-products-scroll" data-v-caeecab3>`);
        if (unref(filtered).length === 0) {
          _push(`<div class="pos-products-empty" data-v-caeecab3>`);
          _push(ssrRenderComponent(VIcon, {
            size: "48",
          ...
          _push(`<p class="mt-2 text-body-1 font-weight-medium" data-v-caeecab3>No products found</p><p class="text-caption text-medium-emphasis" data-v-caeecab3>Try a different search or category.</p></div>`);
        } else if (unref(viewMode) === "grid") {
          _push(`<div class="pos-product-grid" data-v-caeecab3><!--[-->`);
          ssrRenderList(unref(paginated), (p) => {
            _push(`<button type="button" class="${ssrRenderClass([{ "is-out": stockOf(p) <= 0, "is-list": false }, "pos-product-card"])}"${ssrIncludeBooleanAttr(stockOf(p) <= 0) ? " disabled" : ""} data-v-caeecab3><div class="pos-product-thumb" data-v-caeecab3>`);
            if (p.image) {
            ...
            if (stockLevel(p) !== "ok") {
              _push(`<span class="${ssrRenderClass([stockLevel(p) === "out" ? "bg-error" : "bg-warning", "pos-stock-badge"])}" data-v-caeecab3>${ssrInterpolate(stockLevel(p) === "out" ? "Out" : "Low")}</span>`);
            } else {
              _push(`<!---->`);
            }
            _push(`</div><div class="pos-product-body" data-v-caeecab3><div class="pos-product-name" data-v-caeecab3>${ssrInterpolate(nameOf(p))}</div><div class="pos-product-meta" data-v-caeecab3><span class="text-caption text-medium-emphasis" data-v-caeecab3>Stock: ${ssrInterpolate(stockOf(p))}</span></div></div><div class="pos-product-price" data-v-caeecab3>${ssrInterpolate(formatMoney(p.retail_price))}</div></button>`);
          });
          _push(`<!--]--></div>`);
        } else {
          _push(`<div class="pos-product-grid pos-product-grid--list" data-v-caeecab3><!--[-->`);
          ssrRenderList(unref(paginated), (p) => {
            _push(`<button type="button" class="${ssrRenderClass([{ "is-out": stockOf(p) <= 0 }, "pos-product-card is-list"])}"${ssrIncludeBooleanAttr(stockOf(p) <= 0) ? " disabled" : ""} data-v-caeecab3><div class="pos-product-thumb" data-v-caeecab3>`);
            if (p.image) {
              _push(ssrRenderComponent(VImg, {
                src: p.image,
                cover: "",
            ...
            _push(`</div><div class="pos-product-body" data-v-caeecab3><div class="pos-product-name" data-v-caeecab3>${ssrInterpolate(nameOf(p))}</div><div class="pos-product-meta" data-v-caeecab3><span class="text-caption text-medium-emphasis" data-v-caeecab3>${ssrInterpolate(p.sku || "—")} · Stock: ${ssrInterpolate(stockOf(p))}</span></div></div><div class="pos-product-price" data-v-caeecab3>${ssrInterpolate(formatMoney(p.retail_price))}</div></button>`);
          });
          _push(`<!--]--></div>`);
        }
        _push(`</div>`);
      ...
      _push(`<div class="pos-pagination" data-v-caeecab3><span class="text-caption text-medium-emphasis" data-v-caeecab3>${ssrInterpolate(unref(rangeLabel))}</span>`);
      _push(ssrRenderComponent(VSelect, {
      ...
      _push(`</div></section><aside class="pos-cart" data-v-caeecab3><div class="pos-cart-banner" data-v-caeecab3><div class="d-flex align-center" data-v-caeecab3>`);
      ...
      _push(`<div class="text-subtitle-1 font-weight-bold" data-v-caeecab3>Current Sale</div>`);
      _push(ssrRenderComponent(VSpacer, null, null, _parent));
      _push(ssrRenderComponent(VChip, {
        size: "small",
        variant: "tonal",
      ...
      _push(`</div></div><div class="pos-cart-header" data-v-caeecab3>`);
      _push(ssrRenderComponent(VTextField, {
      ...
      _push(`<div class="pos-cart-items" data-v-caeecab3>`);
      if (unref(pos).isEmpty) {
        _push(`<div class="pos-cart-empty" data-v-caeecab3>`);
        _push(ssrRenderComponent(VIcon, {
          size: "64",
          color: "grey-lighten-1"
        }, {
        ...
        _push(`<h3 class="text-h6 mt-2" data-v-caeecab3>Cart is empty</h3><p class="text-body-2 text-medium-emphasis" data-v-caeecab3>Tap a product to start a sale.</p></div>`);
      } else {
        _push(`<div class="px-3 py-2" data-v-caeecab3><div${ssrRenderAttrs({ name: "cart-item" })} data-v-caeecab3>`);
        ssrRenderList(unref(pos).cart, (item, i) => {
          _push(`<div class="pos-cart-row" data-v-caeecab3><div class="flex-grow-1 min-width-0" data-v-caeecab3><div class="text-body-2 font-weight-medium text-truncate" data-v-caeecab3>${ssrInterpolate(item.name)}</div><div class="text-caption text-medium-emphasis" data-v-caeecab3>${ssrInterpolate(formatMoney(item.price))} ea</div></div><div class="pos-qty" data-v-caeecab3>`);
          _push(ssrRenderComponent(VBtn, {
            icon: "mdi-minus",
            size: "x-small",
            variant: "tonal",
          ...
          _push(`<input${ssrRenderAttr("value", item.qty)} type="number" min="1"${ssrRenderAttr("max", item.max)} class="pos-qty-input" data-v-caeecab3>`);
          _push(ssrRenderComponent(VBtn, {
            icon: "mdi-plus",
            size: "x-small",
            variant: "tonal",
          ...
          _push(`</div><div class="pos-line-total" data-v-caeecab3>${ssrInterpolate(formatMoney(item.price * item.qty))}</div>`);
          _push(ssrRenderComponent(VBtn, {
            icon: "mdi-close",
            size: "x-small",
            variant: "text",
      ...
      _push(`</div><div class="pos-cart-footer" data-v-caeecab3><div class="px-4 py-3" data-v-caeecab3><div class="d-flex justify-space-between text-body-2 mb-1" data-v-caeecab3><span class="text-medium-emphasis" data-v-caeecab3>Subtotal</span><span data-v-caeecab3>${ssrInterpolate(formatMoney(unref(pos).subtotal))}</span></div><div class="d-flex align-center justify-space-between text-body-2 mb-1" data-v-caeecab3><span class="text-medium-emphasis" data-v-caeecab3>Discount</span>`);
      _push(ssrRenderComponent(VTextField, {
      ...
      _push(`</div><div class="d-flex justify-space-between text-body-2 mb-2" data-v-caeecab3><span class="text-medium-emphasis" data-v-caeecab3>Tax</span><span data-v-caeecab3>${ssrInterpolate(formatMoney(unref(pos).taxAmount))}</span></div>`);
      _push(ssrRenderComponent(VDivider, { class: "mb-2" }, null, _parent));
      _push(`<div class="d-flex justify-space-between align-center" data-v-caeecab3><span class="text-h6 font-weight-bold" data-v-caeecab3>Total</span><span class="pos-total-value" data-v-caeecab3>${ssrInterpolate(formatMoney(unref(pos).total))}</span></div></div><div class="px-4 pb-3" data-v-caeecab3><div class="payment-methods mb-3" data-v-caeecab3><!--[-->`);
      ssrRenderList(paymentOptions, (opt) => {
        _push(`<button type="button" class="${ssrRenderClass([{ "pay-btn--active": unref(pos).paymentMethod === opt.value }, "pay-btn"])}" data-v-caeecab3>`);
        ...
        _push(`<span data-v-caeecab3>${ssrInterpolate(opt.label)}</span></button>`);
      });
      _push(`<!--]--></div><div class="d-flex ga-2" data-v-caeecab3>`);
      _push(ssrRenderComponent(VBtn, {
        variant: "tonal",
        color: "secondary",
        rounded: "lg",
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(VCardText, { class: "pt-4" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="checkout-total-banner" data-v-caeecab3${_scopeId3}><span class="text-body-2 text-medium-emphasis" data-v-caeecab3${_scopeId3}>Total Due</span><span class="checkout-total-banner__value" data-v-caeecab3${_scopeId3}>${ssrInterpolate(formatMoney(unref(pos).total))}</span><div class="checkout-total-banner__method" data-v-caeecab3${_scopeId3}>`);
                        ...
                        _push4(`<span data-v-caeecab3${_scopeId3}>${ssrInterpolate(paymentOptions.find((o) => o.value === unref(pos).paymentMethod)?.label)}</span></div></div>`);
                        ...
                        if (unref(pos).paymentMethod === "cash") {
                          _push4(`<!--[--><p class="text-subtitle-2 font-weight-medium mb-2" data-v-caeecab3${_scopeId3}>Cash Received</p><div class="quick-cash-grid mb-2" data-v-caeecab3${_scopeId3}><!--[-->`);
                          ...
                          _push4(`<div class="${ssrRenderClass([{ "change-row--positive": unref(change) > 0 }, "change-row"])}" data-v-caeecab3${_scopeId3}><span class="text-body-2" data-v-caeecab3${_scopeId3}>Change</span><span class="text-h6 font-weight-bold" data-v-caeecab3${_scopeId3}>${ssrInterpolate(formatMoney(Math.max(0, unref(change))))}</span></div><!--]-->`);
                        } else {
                          _push4(`<!---->`);
                        }
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(VAlert, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="d-flex justify-space-between" data-v-caeecab3${_scopeId4}><span data-v-caeecab3${_scopeId4}>Items: ${ssrInterpolate(unref(pos).itemCount)}</span><span data-v-caeecab3${_scopeId4}>Total: ${ssrInterpolate(formatMoney(unref(pos).total))}</span></div>`);
                            } else {
                              return [
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(VCard, { rounded: "xl" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="receipt-success-header" data-v-caeecab3${_scopeId2}>`);
                  ...
                  _push3(`<h3 class="text-h6 font-weight-bold mt-2" data-v-caeecab3${_scopeId2}>Sale Completed</h3><p class="text-caption text-medium-emphasis" data-v-caeecab3${_scopeId2}>${ssrInterpolate(unref(lastTransaction)?.transaction_number)}</p></div>`);
                  _push3(ssrRenderComponent(VDivider, null, null, _parent3, _scopeId2));
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        if (unref(shift)) {
                          ...
                          _push4(`<div class="shift-info-grid" data-v-caeecab3${_scopeId3}><div class="shift-info-row" data-v-caeecab3${_scopeId3}><span data-v-caeecab3${_scopeId3}>Opened</span><span data-v-caeecab3${_scopeId3}>${ssrInterpolate(unref(format).datetime(unref(shift).opened_at))}</span></div><div class="shift-info-row" data-v-caeecab3${_scopeId3}><span data-v-caeecab3${_scopeId3}>Duration</span><span data-v-caeecab3${_scopeId3}>${ssrInterpolate(unref(shift).duration)}</span></div><div class="shift-info-row" data-v-caeecab3${_scopeId3}><span data-v-caeecab3${_scopeId3}>Opening Float</span><span data-v-caeecab3${_scopeId3}>${ssrInterpolate(formatMoney(unref(shift).opening_float))}</span></div><div class="shift-info-row" data-v-caeecab3${_scopeId3}><span data-v-caeecab3${_scopeId3}>Transactions</span><span data-v-caeecab3${_scopeId3}>${ssrInterpolate(unref(shift).transaction_count)}</span></div><div class="shift-info-row" data-v-caeecab3${_scopeId3}><span data-v-caeecab3${_scopeId3}>Gross Revenue</span><span data-v-caeecab3${_scopeId3}>${ssrInterpolate(formatMoney(unref(shift).gross_revenue))}</span></div></div><!--]-->`);
                        } else {
                          _push4(`<!--[--><p class="text-body-2 text-medium-emphasis mb-3" data-v-caeecab3${_scopeId3}>No active shift. Enter opening float to start a new shift.</p>`);
                          _push4(ssrRenderComponent(VTextField, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(VAlert, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div data-v-caeecab3${_scopeId4}>Customer: ${ssrInterpolate(unref(resumeData)?.customer_name || "Walk-in")}</div><div data-v-caeecab3${_scopeId4}>Items: ${ssrInterpolate(unref(resumeData)?.item_count)}</div><div data-v-caeecab3${_scopeId4}>Total: ${ssrInterpolate(formatMoney(unref(resumeData)?.total || 0))}</div>`);
                            } else {
                              return [
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-caeecab3"]]);
export {
  index as default
};
//# sourceMappingURL=index-hM8X7NDR.js.map
