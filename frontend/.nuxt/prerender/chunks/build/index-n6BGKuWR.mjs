import { u as usePosStore, _ as __nuxt_component_0 } from './pos-D7JNQgAI.mjs';
import { defineComponent, ref, computed, watch, mergeProps, withCtx, createTextVNode, unref, toDisplayString, createVNode, isRef, openBlock, createBlock, Fragment, renderList, createCommentVNode, useSSRContext } from 'file://D:/Projects/MY-APPS-2/DomendraPOS/frontend/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderClass, ssrIncludeBooleanAttr, ssrRenderAttr } from 'file://D:/Projects/MY-APPS-2/DomendraPOS/frontend/node_modules/vue/server-renderer/index.mjs';
...
import { _ as _export_sfc, D as useToast, a as VIcon, b as VSpacer, c as VBtn, o as VChip, j as VBadge, J as VSelect, v as VTextField, W as VBtnToggle, p as VProgressLinear, ae as VImg, a0 as VPagination, k as VDivider, q as VDialog, g as VCard, r as VCardTitle, s as VCardText, af as VAutocomplete, d as VAlert, w as VCardActions, $ as VTextarea, H as VAvatar } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function onBranchChange() {
      ...
      const name = (br == null ? void 0 : br.name) || "";
    ...
    function stockOf(p) {
      var _a, _b;
      return Number((_b = (_a = p.quantity_on_hand) != null ? _a : p.total_quantity) != null ? _b : 0);
    }
    function ipu(p) {
    ...
    async function printReceipt() {
      ...
      try {
        ...
        toast.error((e == null ? void 0 : e.message) || "Failed to print receipt");
      } finally {
    ...
    async function openShift() {
      ...
      try {
        ...
        toast.error(((_a = e == null ? void 0 : e.data) == null ? void 0 : _a.detail) || "Failed to open shift");
      } finally {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(VChip, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Today: ${ssrInterpolate(unref(todayStats).count)} \xB7 ${ssrInterpolate(formatMoney(unref(todayStats).revenue))}`);
          } else {
            return [
              createTextVNode(" Today: " + toDisplayString(unref(todayStats).count) + " \xB7 " + toDisplayString(formatMoney(unref(todayStats).revenue)), 1)
            ];
          }
        }),
        _: 1
      ...
      if (!unref(loading)) {
        ...
        if (unref(filtered).length === 0) {
          ...
          ssrRenderList(unref(paginated), (p) => {
            ...
            _push(`</div><div class="pos-product-body" data-v-e4f0800e><div class="pos-product-name" data-v-e4f0800e>${ssrInterpolate(nameOf(p))}</div><div class="pos-product-meta" data-v-e4f0800e><span class="text-caption text-medium-emphasis" data-v-e4f0800e>${ssrInterpolate(p.sku || "\u2014")} \xB7 Stock: ${ssrInterpolate(stockOf(p))} ${ssrInterpolate(unitLabel(p))}${ssrInterpolate(pieceStock(p))}</span></div></div><div class="pos-product-price" data-v-e4f0800e>${ssrInterpolate(formatMoney(piecePrice(p)))}`);
            if (Number(p.items_per_unit) > 1) {
              _push(`<!--[--> / piece<!--]-->`);
            } else {
              _push(`<!---->`);
      ...
      if (unref(pos).isEmpty) {
        ...
        ssrRenderList(unref(pos).cart, (item, i) => {
          ...
          if (item.items_per_unit > 1) {
            _push(`<!--[--> \xB7 ${ssrInterpolate(item.items_per_unit)} ${ssrInterpolate(item.unit)}/unit<!--]-->`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div>`);
                      ...
                      if (_push4) {
                        ...
                        _push4(ssrRenderComponent(VIcon, { size: "14" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            var _a2, _b2;
                            if (_push5) {
                              _push5(`${ssrInterpolate((_a2 = paymentOptions.find((o) => o.value === unref(pos).paymentMethod)) == null ? void 0 : _a2.icon)}`);
                            } else {
                              return [
                                createTextVNode(toDisplayString((_b2 = paymentOptions.find((o) => o.value === unref(pos).paymentMethod)) == null ? void 0 : _b2.icon), 1)
                              ];
                            }
                          }),
                          _: 1
                        }, _parent4, _scopeId3));
                        _push4(`<span data-v-e4f0800e${_scopeId3}>${ssrInterpolate((_a = paymentOptions.find((o) => o.value === unref(pos).paymentMethod)) == null ? void 0 : _a.label)}</span></div></div>`);
                            ...
                            createVNode("div", { class: "checkout-total-banner__method" }, [
                              createVNode(VIcon, { size: "14" }, {
                                default: withCtx(() => {
                                  var _a2;
                                  return [
                                    createTextVNode(toDisplayString((_a2 = paymentOptions.find((o) => o.value === unref(pos).paymentMethod)) == null ? void 0 : _a2.icon), 1)
                                  ];
                                }),
                                _: 1
                              }),
                              createVNode("span", null, toDisplayString((_b = paymentOptions.find((o) => o.value === unref(pos).paymentMethod)) == null ? void 0 : _b.label), 1)
                            ])
                          ]),
                        ...
                        return [
                          createVNode("div", { class: "checkout-total-banner" }, [
                            ...
                            createVNode("div", { class: "checkout-total-banner__method" }, [
                              ...
                              createVNode("span", null, toDisplayString((_a = paymentOptions.find((o) => o.value === unref(pos).paymentMethod)) == null ? void 0 : _a.label), 1)
                            ])
                          ]),
                          createVNode(VAutocomplete, {
                            modelValue: unref(pos).customerName,
            ...
            _push2(ssrRenderComponent(VCard, { rounded: "xl" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                ...
                if (_push3) {
                  ...
                  _push3(`<h3 class="text-h6 font-weight-bold mt-2" data-v-e4f0800e${_scopeId2}>Sale Completed</h3><p class="text-caption text-medium-emphasis" data-v-e4f0800e${_scopeId2}>${ssrInterpolate((_a = unref(lastTransaction)) == null ? void 0 : _a.transaction_number)}</p></div>`);
                  _push3(ssrRenderComponent(VDivider, null, null, _parent3, _scopeId2));
                  ...
                  return [
                    createVNode("div", { class: "receipt-success-header" }, [
                      ...
                      createVNode("p", { class: "text-caption text-medium-emphasis" }, toDisplayString((_b = unref(lastTransaction)) == null ? void 0 : _b.transaction_number), 1)
                    ]),
                    createVNode(VDivider),
                ...
                default: withCtx(() => {
                  ...
                  return [
                    createVNode("div", { class: "receipt-success-header" }, [
                      ...
                      createVNode("h3", { class: "text-h6 font-weight-bold mt-2" }, "Sale Completed"),
                      createVNode("p", { class: "text-caption text-medium-emphasis" }, toDisplayString((_a = unref(lastTransaction)) == null ? void 0 : _a.transaction_number), 1)
                    ]),
                    createVNode(VDivider),
                    createVNode(VCardText, { class: "pa-0" }, {
                      default: withCtx(() => [
                      ...
                      if (_push4) {
                        _push4(ssrRenderComponent(VAlert, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            ...
                            if (_push5) {
                              _push5(`<div data-v-e4f0800e${_scopeId4}>Customer: ${ssrInterpolate(((_a = unref(resumeData)) == null ? void 0 : _a.customer_name) || "Walk-in")}</div><div data-v-e4f0800e${_scopeId4}>Items: ${ssrInterpolate((_b = unref(resumeData)) == null ? void 0 : _b.item_count)}</div><div data-v-e4f0800e${_scopeId4}>Total: ${ssrInterpolate(formatMoney(((_c = unref(resumeData)) == null ? void 0 : _c.total) || 0))}</div>`);
                            } else {
                              return [
                                createVNode("div", null, "Customer: " + toDisplayString(((_d = unref(resumeData)) == null ? void 0 : _d.customer_name) || "Walk-in"), 1),
                                createVNode("div", null, "Items: " + toDisplayString((_e = unref(resumeData)) == null ? void 0 : _e.item_count), 1),
                                createVNode("div", null, "Total: " + toDisplayString(formatMoney(((_f = unref(resumeData)) == null ? void 0 : _f.total) || 0)), 1)
                              ];
                            }
                          }),
                          _: 1
                        ...
                        return [
                          createVNode(VAlert, {
                            ...
                            default: withCtx(() => {
                              var _a, _b, _c;
                              return [
                                createVNode("div", null, "Customer: " + toDisplayString(((_a = unref(resumeData)) == null ? void 0 : _a.customer_name) || "Walk-in"), 1),
                                createVNode("div", null, "Items: " + toDisplayString((_b = unref(resumeData)) == null ? void 0 : _b.item_count), 1),
                                createVNode("div", null, "Total: " + toDisplayString(formatMoney(((_c = unref(resumeData)) == null ? void 0 : _c.total) || 0)), 1)
                              ];
                            }),
                            _: 1
                          })
...
//# sourceMappingURL=index-n6BGKuWR.mjs.map
