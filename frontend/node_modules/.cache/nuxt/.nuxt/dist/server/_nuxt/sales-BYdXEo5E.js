import { _ as _sfc_main$1 } from "./PaginationBar-BRfeJHTm.js";
...
import { M as useToast, V as VContainer, i as VRow, j as VCol, R as VBtnToggle, g as VBtn, f as VSpacer, k as VCard, d as VIcon, l as VTabs, m as VTab, v as VChip, C as VTextField, O as VSelect, E as VProgressCircular, N as VAvatar, Y as VTable, w as VProgressLinear, x as VDialog, y as VCardTitle, z as VCardText, p as VDivider, D as VCardActions } from "../server.mjs";
          ...
          if (_push2) {
                ...
                if (_push3) {
                  _push3(ssrRenderComponent(VCol, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<div class="text-h5 font-weight-bold" data-v-ef5adf25${_scopeId3}>Sales</div><div class="text-body-2 text-medium-emphasis" data-v-ef5adf25${_scopeId3}>${ssrInterpolate(unref(stats).totalSales)} sales · ${ssrInterpolate(unref(currency)(unref(stats).totalRevenue))} revenue · ${ssrInterpolate(unref(formatNumber)(unref(stats).totalItems))} items sold </div>`);
                      } else {
                        return [
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(VCard, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="d-flex align-start justify-space-between mb-2" data-v-ef5adf25${_scopeId4}><span class="text-caption text-medium-emphasis font-weight-medium" data-v-ef5adf25${_scopeId4}>Total Sales</span><div class="kpi-icon kpi-icon-blue" data-v-ef5adf25${_scopeId4}>`);
                              _push5(ssrRenderComponent(VIcon, {
                                size: "18",
                                icon: "mdi-receipt-text-outline"
                              }, null, _parent5, _scopeId4));
                              _push5(`</div></div><p class="text-h4 font-weight-bold mb-1" data-v-ef5adf25${_scopeId4}>${ssrInterpolate(unref(stats).totalSales)}</p><span class="text-caption text-medium-emphasis" data-v-ef5adf25${_scopeId4}>${ssrInterpolate(unref(stats).completedCount)} completed</span>`);
                            } else {
                              return [
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(VCard, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="d-flex align-start justify-space-between mb-2" data-v-ef5adf25${_scopeId4}><span class="text-caption text-medium-emphasis font-weight-medium" data-v-ef5adf25${_scopeId4}>Total Revenue</span><div class="kpi-icon kpi-icon-green" data-v-ef5adf25${_scopeId4}>`);
                              _push5(ssrRenderComponent(VIcon, {
                                size: "18",
                                icon: "mdi-cash-multiple"
                              }, null, _parent5, _scopeId4));
                              _push5(`</div></div><p class="text-h4 font-weight-bold mb-1 text-success" data-v-ef5adf25${_scopeId4}>${ssrInterpolate(unref(currency)(unref(stats).totalRevenue))}</p><span class="text-caption text-medium-emphasis" data-v-ef5adf25${_scopeId4}>Avg: ${ssrInterpolate(unref(currency)(unref(stats).avgSale))}</span>`);
                            } else {
                              return [
                                createVNode("div", { class: "d-flex align-start justify-space-between mb-2" }, [
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(VCard, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="d-flex align-start justify-space-between mb-2" data-v-ef5adf25${_scopeId4}><span class="text-caption text-medium-emphasis font-weight-medium" data-v-ef5adf25${_scopeId4}>Avg Sale Value</span><div class="kpi-icon kpi-icon-purple" data-v-ef5adf25${_scopeId4}>`);
                              _push5(ssrRenderComponent(VIcon, {
                                size: "18",
                                icon: "mdi-chart-line-variant"
                              }, null, _parent5, _scopeId4));
                              _push5(`</div></div><p class="text-h4 font-weight-bold mb-1" data-v-ef5adf25${_scopeId4}>${ssrInterpolate(unref(currency)(unref(stats).avgSale))}</p><span class="text-caption text-medium-emphasis" data-v-ef5adf25${_scopeId4}>${ssrInterpolate(unref(stats).totalDiscount > 0 ? "Discount: " + unref(currency)(unref(stats).totalDiscount) : "No discounts")}</span>`);
                            } else {
                              return [
                                createVNode("div", { class: "d-flex align-start justify-space-between mb-2" }, [
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(VCard, {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="d-flex align-start justify-space-between mb-2" data-v-ef5adf25${_scopeId4}><span class="text-caption text-medium-emphasis font-weight-medium" data-v-ef5adf25${_scopeId4}>Items Sold</span><div class="kpi-icon kpi-icon-orange" data-v-ef5adf25${_scopeId4}>`);
                              _push5(ssrRenderComponent(VIcon, {
                                size: "18",
                                icon: "mdi-package-variant-closed"
                              }, null, _parent5, _scopeId4));
                              _push5(`</div></div><p class="text-h4 font-weight-bold mb-1" data-v-ef5adf25${_scopeId4}>${ssrInterpolate(unref(formatNumber)(unref(stats).totalItems))}</p><span class="text-caption text-medium-emphasis" data-v-ef5adf25${_scopeId4}>${ssrInterpolate(unref(stats).uniqueProducts)} unique products</span>`);
                            } else {
                              return [
                                createVNode("div", { class: "d-flex align-start justify-space-between mb-2" }, [
            ...
            if (unref(activeTab) === "transactions") {
              ...
              if (unref(hasActiveFilters)) {
                _push2(`<div class="d-flex align-center flex-wrap ga-2 mb-4" data-v-ef5adf25${_scopeId}><span class="text-body-2 text-medium-emphasis" data-v-ef5adf25${_scopeId}>Filters:</span>`);
                ...
                _push2(ssrRenderComponent(VCard, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      ...
                      _push3(`<div class="text-body-2 text-medium-emphasis" data-v-ef5adf25${_scopeId2}>Loading sales...</div>`);
                    } else {
                      return [
                ...
                _push2(ssrRenderComponent(VCard, {
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      ...
                      _push3(`<div class="text-h6 font-weight-bold mb-1" data-v-ef5adf25${_scopeId2}>No sales found</div><div class="text-body-2 text-medium-emphasis" data-v-ef5adf25${_scopeId2}>${ssrInterpolate(unref(hasActiveFilters) ? "Try adjusting your filters." : "Sales will appear here once transactions are processed.")}</div>`);
                    } else {
                      return [
                        createVNode(VAvatar, {
                          color: "blue-lighten-5",
                  ...
                  default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(ssrRenderComponent(VTable, {
                        ...
                        default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                          if (_push4) {
                            _push4(`<thead class="bg-grey-lighten-4" data-v-ef5adf25${_scopeId3}><tr data-v-ef5adf25${_scopeId3}><th class="text-center" style="${ssrRenderStyle({ "width": "52px" })}" data-v-ef5adf25${_scopeId3}>#</th><th class="text-left" style="${ssrRenderStyle({ "min-width": "160px" })}" data-v-ef5adf25${_scopeId3}>Transaction #</th><th class="text-left" data-v-ef5adf25${_scopeId3}>Customer</th><th class="text-left" data-v-ef5adf25${_scopeId3}>Cashier</th><th class="text-left" data-v-ef5adf25${_scopeId3}>Payment</th><th class="text-right" data-v-ef5adf25${_scopeId3}>Items</th><th class="text-right" data-v-ef5adf25${_scopeId3}>Subtotal</th><th class="text-right" data-v-ef5adf25${_scopeId3}>Discount</th><th class="text-right" data-v-ef5adf25${_scopeId3}>Tax</th><th class="text-right" data-v-ef5adf25${_scopeId3}>Total</th><th class="text-left" data-v-ef5adf25${_scopeId3}>Status</th><th class="text-left" data-v-ef5adf25${_scopeId3}>Date</th></tr></thead><tbody data-v-ef5adf25${_scopeId3}><!--[-->`);
                            ssrRenderList(unref(pagedSales), (sale, idx) => {
                              _push4(`<tr style="${ssrRenderStyle({ "cursor": "pointer" })}" data-v-ef5adf25${_scopeId3}><td class="text-center text-caption text-disabled font-weight-bold" data-v-ef5adf25${_scopeId3}>${ssrInterpolate(rowNumber(idx))}</td><td data-v-ef5adf25${_scopeId3}><div class="d-flex align-center ga-2" data-v-ef5adf25${_scopeId3}>`);
                              ...
                              _push4(`<span class="text-body-2 font-weight-bold font-mono" data-v-ef5adf25${_scopeId3}>${ssrInterpolate(sale.transaction_number)}</span></div></td><td data-v-ef5adf25${_scopeId3}>`);
                              if (sale.customer_name && sale.customer_name !== "Walk-in") {
                                _push4(`<span class="text-body-2" data-v-ef5adf25${_scopeId3}>${ssrInterpolate(sale.customer_name)}</span>`);
                              } else {
                                _push4(`<span class="text-disabled" data-v-ef5adf25${_scopeId3}>Walk-in</span>`);
                              }
                              _push4(`</td><td class="text-body-2 text-medium-emphasis" data-v-ef5adf25${_scopeId3}>${ssrInterpolate(sale.cashier_name || "—")}</td><td data-v-ef5adf25${_scopeId3}>`);
                              if (sale.payment_method) {
                                ...
                                _push4(`<span class="text-disabled" data-v-ef5adf25${_scopeId3}>—</span>`);
                              }
                              _push4(`</td><td class="text-right text-body-2" data-v-ef5adf25${_scopeId3}>${ssrInterpolate(sale.lines_count)}</td><td class="text-right text-body-2" data-v-ef5adf25${_scopeId3}>${ssrInterpolate(unref(currency)(sale.subtotal))}</td><td class="text-right text-body-2 text-error" data-v-ef5adf25${_scopeId3}>-${ssrInterpolate(unref(currency)(sale.discount))}</td><td class="text-right text-body-2 text-medium-emphasis" data-v-ef5adf25${_scopeId3}>${ssrInterpolate(unref(currency)(sale.tax))}</td><td class="text-right" data-v-ef5adf25${_scopeId3}><span class="font-weight-bold" data-v-ef5adf25${_scopeId3}>${ssrInterpolate(unref(currency)(sale.total))}</span></td><td data-v-ef5adf25${_scopeId3}>`);
                              _push4(ssrRenderComponent(VChip, {
                                size: "small",
                                color: statusColor(sale.status),
                                variant: "tonal",
                              ...
                              _push4(`</td><td class="text-body-2 text-medium-emphasis" data-v-ef5adf25${_scopeId3}>${ssrInterpolate(unref(datetime)(sale.created_at))}</td></tr>`);
                            });
                            _push4(`<!--]--></tbody>`);
                          } else {
                            return [
            ...
            if (unref(activeTab) === "analytics") {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(VCard, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<div class="d-flex align-start justify-space-between" data-v-ef5adf25${_scopeId4}><div data-v-ef5adf25${_scopeId4}><div class="text-caption text-medium-emphasis text-uppercase" data-v-ef5adf25${_scopeId4}>Gross Revenue</div><div class="text-h5 font-weight-bold text-success mt-2" data-v-ef5adf25${_scopeId4}>${ssrInterpolate(unref(currency)(unref(analytics).totalRevenue))}</div></div>`);
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(VCard, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<div class="d-flex align-start justify-space-between" data-v-ef5adf25${_scopeId4}><div data-v-ef5adf25${_scopeId4}><div class="text-caption text-medium-emphasis text-uppercase" data-v-ef5adf25${_scopeId4}>Avg Items / Sale</div><div class="text-h5 font-weight-bold mt-2" data-v-ef5adf25${_scopeId4}>${ssrInterpolate(unref(analytics).avgItemsPerSale.toFixed(1))}</div></div>`);
                                _push5(ssrRenderComponent(VAvatar, {
                                  color: "blue-lighten-5",
                                  rounded: "lg",
                                  size: "40"
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(VCard, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<div class="d-flex align-start justify-space-between" data-v-ef5adf25${_scopeId4}><div data-v-ef5adf25${_scopeId4}><div class="text-caption text-medium-emphasis text-uppercase" data-v-ef5adf25${_scopeId4}>Total Discount</div><div class="text-h5 font-weight-bold text-error mt-2" data-v-ef5adf25${_scopeId4}>${ssrInterpolate(unref(currency)(unref(analytics).totalDiscount))}</div></div>`);
                                _push5(ssrRenderComponent(VAvatar, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(VCard, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<div class="d-flex align-start justify-space-between" data-v-ef5adf25${_scopeId4}><div data-v-ef5adf25${_scopeId4}><div class="text-caption text-medium-emphasis text-uppercase" data-v-ef5adf25${_scopeId4}>Conversion Rate</div><div class="text-h5 font-weight-bold mt-2" data-v-ef5adf25${_scopeId4}>${ssrInterpolate(unref(analytics).completionRate.toFixed(1))}%</div></div>`);
                                _push5(ssrRenderComponent(VAvatar, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(ssrRenderComponent(VCard, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<div class="d-flex align-center ga-2 mb-3" data-v-ef5adf25${_scopeId4}>`);
                                _push5(ssrRenderComponent(VAvatar, {
                                  color: "blue-lighten-5",
                                  rounded: "lg",
                                  size: "36"
                                ...
                                _push5(`<div data-v-ef5adf25${_scopeId4}><div class="text-subtitle-1 font-weight-bold" data-v-ef5adf25${_scopeId4}>Revenue Trend</div><div class="text-caption text-medium-emphasis" data-v-ef5adf25${_scopeId4}>Daily revenue over selected period</div></div></div>`);
                          ...
                          _push4(ssrRenderComponent(VCard, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                ...
                                _push5(`<div data-v-ef5adf25${_scopeId4}><div class="text-subtitle-1 font-weight-bold" data-v-ef5adf25${_scopeId4}>Payment Methods</div><div class="text-caption text-medium-emphasis" data-v-ef5adf25${_scopeId4}>Revenue by payment type</div></div></div>`);
                                _push5(ssrRenderComponent(_component_apexchart, {
                                  type: "donut",
                                  height: "300",
                          ...
                          _push4(ssrRenderComponent(VCard, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                ...
                                _push5(`<div data-v-ef5adf25${_scopeId4}><div class="text-subtitle-1 font-weight-bold" data-v-ef5adf25${_scopeId4}>Top 10 Products by Revenue</div><div class="text-caption text-medium-emphasis" data-v-ef5adf25${_scopeId4}>Best-selling products this period</div></div></div>`);
                                _push5(ssrRenderComponent(_component_apexchart, {
                                  type: "bar",
                                  height: "320",
                          ...
                          _push4(ssrRenderComponent(VCard, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                ...
                                _push5(`<div data-v-ef5adf25${_scopeId4}><div class="text-subtitle-1 font-weight-bold" data-v-ef5adf25${_scopeId4}>Sales by Status</div><div class="text-caption text-medium-emphasis" data-v-ef5adf25${_scopeId4}>Transaction status distribution</div></div></div>`);
                                _push5(ssrRenderComponent(_component_apexchart, {
                                  type: "donut",
                                  height: "300",
                          ...
                          _push4(ssrRenderComponent(VCard, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                ...
                                _push5(`<div data-v-ef5adf25${_scopeId4}><div class="text-subtitle-1 font-weight-bold" data-v-ef5adf25${_scopeId4}>Sales by Day of Week</div><div class="text-caption text-medium-emphasis" data-v-ef5adf25${_scopeId4}>Revenue distribution across weekdays</div></div></div>`);
                                _push5(ssrRenderComponent(_component_apexchart, {
                                  type: "bar",
                                  height: "280",
                          ...
                          _push4(ssrRenderComponent(VCard, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                ...
                                _push5(`<div data-v-ef5adf25${_scopeId4}><div class="text-subtitle-1 font-weight-bold" data-v-ef5adf25${_scopeId4}>Peak Hours</div><div class="text-caption text-medium-emphasis" data-v-ef5adf25${_scopeId4}>Revenue and transactions by hour</div></div></div>`);
                                _push5(ssrRenderComponent(_component_apexchart, {
                                  type: "bar",
                                  height: "280",
                                  options: unref(peakHoursChartOptions),
                                  series: unref(peakHoursChartSeries)
                                }, null, _parent5, _scopeId4));
                              } else {
                                return [
                                  createVNode("div", { class: "d-flex align-center ga-2 mb-3" }, [
              ...
              _push2(ssrRenderComponent(VCard, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="d-flex align-center ga-2 pa-4 pb-2" data-v-ef5adf25${_scopeId2}>`);
                    _push3(ssrRenderComponent(VAvatar, {
                    ...
                    _push3(`<div data-v-ef5adf25${_scopeId2}><div class="text-subtitle-1 font-weight-bold" data-v-ef5adf25${_scopeId2}>Cashier Performance</div><div class="text-caption text-medium-emphasis" data-v-ef5adf25${_scopeId2}>Sales activity by cashier</div></div></div>`);
                    _push3(ssrRenderComponent(VTable, {
                      density: "compact",
                      hover: ""
                    }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`<thead class="bg-grey-lighten-4" data-v-ef5adf25${_scopeId3}><tr data-v-ef5adf25${_scopeId3}><th class="text-left" data-v-ef5adf25${_scopeId3}>Cashier</th><th class="text-right" data-v-ef5adf25${_scopeId3}>Transactions</th><th class="text-right" data-v-ef5adf25${_scopeId3}>Revenue</th><th class="text-right" data-v-ef5adf25${_scopeId3}>Avg Order</th><th class="text-right" data-v-ef5adf25${_scopeId3}>Items Sold</th><th class="text-right" data-v-ef5adf25${_scopeId3}>% of Revenue</th><th style="${ssrRenderStyle({ "width": "120px" })}" data-v-ef5adf25${_scopeId3}>Performance</th></tr></thead><tbody data-v-ef5adf25${_scopeId3}><!--[-->`);
                          ssrRenderList(unref(cashierPerformance), (c, idx) => {
                            _push4(`<tr data-v-ef5adf25${_scopeId3}><td data-v-ef5adf25${_scopeId3}><div class="d-flex align-center ga-2" data-v-ef5adf25${_scopeId3}>`);
                            _push4(ssrRenderComponent(VAvatar, {
                              size: "32",
                              rounded: "lg",
                              ...
                              default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                if (_push5) {
                                  _push5(`<span class="text-body-2 font-weight-bold" data-v-ef5adf25${_scopeId4}>${ssrInterpolate((c.name || "?").charAt(0).toUpperCase())}</span>`);
                                } else {
                                  return [
                            ...
                            _push4(`<span class="text-body-2 font-weight-medium" data-v-ef5adf25${_scopeId3}>${ssrInterpolate(c.name || "Unknown")}</span></div></td><td class="text-right text-body-2" data-v-ef5adf25${_scopeId3}>${ssrInterpolate(c.count)}</td><td class="text-right font-weight-bold text-success" data-v-ef5adf25${_scopeId3}>${ssrInterpolate(unref(currency)(c.revenue))}</td><td class="text-right text-body-2" data-v-ef5adf25${_scopeId3}>${ssrInterpolate(unref(currency)(c.avgOrder))}</td><td class="text-right text-body-2" data-v-ef5adf25${_scopeId3}>${ssrInterpolate(unref(formatNumber)(c.items))}</td><td class="text-right text-body-2 text-medium-emphasis" data-v-ef5adf25${_scopeId3}>${ssrInterpolate(c.share.toFixed(1))}%</td><td data-v-ef5adf25${_scopeId3}>`);
                          ...
                          if (unref(cashierPerformance).length === 0) {
                            _push4(`<tr data-v-ef5adf25${_scopeId3}><td colspan="7" class="text-center py-8 text-medium-emphasis" data-v-ef5adf25${_scopeId3}>No cashier data for this period.</td></tr>`);
                          } else {
                            _push4(`<!---->`);
                          }
                          _push4(`</tbody>`);
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(VCardTitle, { class: "d-flex align-center justify-space-between pa-4" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<div class="d-flex align-center ga-3" data-v-ef5adf25${_scopeId4}>`);
                              _push5(ssrRenderComponent(VAvatar, {
                              ...
                              _push5(`<div data-v-ef5adf25${_scopeId4}><div class="text-h6 font-weight-bold" data-v-ef5adf25${_scopeId4}>${ssrInterpolate(unref(selectedSale)?.transaction_number)}</div><div class="text-caption text-medium-emphasis" data-v-ef5adf25${_scopeId4}>${ssrInterpolate(unref(datetime)(unref(selectedSale)?.created_at))}</div></div></div>`);
                              _push5(ssrRenderComponent(VBtn, {
                                variant: "text",
                                icon: "mdi-close",
                                size: "small",
                        ...
                        if (unref(selectedSale)) {
                          _push4(ssrRenderComponent(VCardText, { class: "pt-2" }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<div class="d-flex align-center ga-2 mb-4 flex-wrap" data-v-ef5adf25${_scopeId4}>`);
                                _push5(ssrRenderComponent(VChip, {
                                  size: "small",
                                  color: statusColor(unref(selectedSale).status),
                                  variant: "tonal",
                                ...
                                _push5(`<span class="text-body-2 text-medium-emphasis" data-v-ef5adf25${_scopeId4}>${ssrInterpolate(unref(selectedSale).customer_name || "Walk-in")} · ${ssrInterpolate(unref(selectedSale).cashier_name || "—")} · ${ssrInterpolate(unref(selectedSale).branch_name || "—")}</span></div><div class="text-subtitle-2 font-weight-bold mb-2" data-v-ef5adf25${_scopeId4}>Line Items (${ssrInterpolate(unref(selectedSale).items?.length || 0)})</div>`);
                                _push5(ssrRenderComponent(VTable, {
                                  ...
                                  default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                    if (_push6) {
                                      _push6(`<thead class="bg-grey-lighten-4" data-v-ef5adf25${_scopeId5}><tr data-v-ef5adf25${_scopeId5}><th class="text-left" data-v-ef5adf25${_scopeId5}>Product</th><th class="text-right" data-v-ef5adf25${_scopeId5}>Qty</th><th class="text-right" data-v-ef5adf25${_scopeId5}>Price</th><th class="text-right" data-v-ef5adf25${_scopeId5}>Total</th></tr></thead><tbody data-v-ef5adf25${_scopeId5}><!--[-->`);
                                      ssrRenderList(unref(selectedSale).items, (item) => {
                                        _push6(`<tr data-v-ef5adf25${_scopeId5}><td data-v-ef5adf25${_scopeId5}><div class="text-body-2 font-weight-medium" data-v-ef5adf25${_scopeId5}>${ssrInterpolate(item.product_name)}</div><div class="text-caption text-disabled" data-v-ef5adf25${_scopeId5}>${ssrInterpolate(item.product_sku)}</div></td><td class="text-right text-body-2" data-v-ef5adf25${_scopeId5}>${ssrInterpolate(unref(formatNumber)(item.quantity))}</td><td class="text-right text-body-2" data-v-ef5adf25${_scopeId5}>${ssrInterpolate(unref(currency)(item.unit_price))}</td><td class="text-right text-body-2 font-weight-medium" data-v-ef5adf25${_scopeId5}>${ssrInterpolate(unref(currency)(item.line_total))}</td></tr>`);
                                      });
                                      _push6(`<!--]--></tbody>`);
                                    } else {
                                      return [
                                ...
                                _push5(`<div class="d-flex flex-column align-end ga-1" data-v-ef5adf25${_scopeId4}><div class="d-flex justify-space-between" style="${ssrRenderStyle({ "width": "220px" })}" data-v-ef5adf25${_scopeId4}><span class="text-body-2 text-medium-emphasis" data-v-ef5adf25${_scopeId4}>Subtotal</span><span class="text-body-2 font-weight-medium" data-v-ef5adf25${_scopeId4}>${ssrInterpolate(unref(currency)(unref(selectedSale).subtotal))}</span></div><div class="d-flex justify-space-between" style="${ssrRenderStyle({ "width": "220px" })}" data-v-ef5adf25${_scopeId4}><span class="text-body-2 text-medium-emphasis" data-v-ef5adf25${_scopeId4}>Discount</span><span class="text-body-2 font-weight-medium text-error" data-v-ef5adf25${_scopeId4}>-${ssrInterpolate(unref(currency)(unref(selectedSale).discount))}</span></div><div class="d-flex justify-space-between" style="${ssrRenderStyle({ "width": "220px" })}" data-v-ef5adf25${_scopeId4}><span class="text-body-2 text-medium-emphasis" data-v-ef5adf25${_scopeId4}>Tax</span><span class="text-body-2 font-weight-medium" data-v-ef5adf25${_scopeId4}>${ssrInterpolate(unref(currency)(unref(selectedSale).tax))}</span></div>`);
                                _push5(ssrRenderComponent(VDivider, {
                                  class: "my-1",
                                  style: { "width": "220px" }
                                }, null, _parent5, _scopeId4));
                                _push5(`<div class="d-flex justify-space-between" style="${ssrRenderStyle({ "width": "220px" })}" data-v-ef5adf25${_scopeId4}><span class="text-subtitle-2 font-weight-bold" data-v-ef5adf25${_scopeId4}>Total</span><span class="text-subtitle-1 font-weight-bold text-primary" data-v-ef5adf25${_scopeId4}>${ssrInterpolate(unref(currency)(unref(selectedSale).total))}</span></div></div>`);
                              } else {
                                return [
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(ssrRenderComponent(VCardTitle, { class: "d-flex align-center justify-space-between" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<span class="text-h6" data-v-ef5adf25${_scopeId4}>Custom Date Range</span>`);
                              _push5(ssrRenderComponent(VBtn, {
                                variant: "text",
                                icon: "mdi-close",
                                size: "small",
...
const sales = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ef5adf25"]]);
export {
  sales as default
};
//# sourceMappingURL=sales-BYdXEo5E.js.map
