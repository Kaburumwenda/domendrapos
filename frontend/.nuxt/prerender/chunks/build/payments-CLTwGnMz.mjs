import { defineComponent, ref, computed, watch, mergeProps, withCtx, createTextVNode, unref, isRef, createVNode, toDisplayString, useSSRContext } from 'file://D:/Projects/MY-APPS-2/DomendraPOS/frontend/node_modules/vue/index.mjs';
  ...
  setup(__props) {
    ...
    const filteredTxns = computed(() => {
      ...
      if (fSearch.value) {
        ...
        list = list.filter(
          (t) => {
            var _a, _b, _c;
            return ((_a = t.tenant_name) == null ? void 0 : _a.toLowerCase().includes(q)) || ((_b = t.phone) == null ? void 0 : _b.toLowerCase().includes(q)) || ((_c = t.checkout_request_id) == null ? void 0 : _c.toLowerCase().includes(q));
          }
        );
      }
      return list;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(loading) && !unref(transactions).length) {
        ...
        _push(`</div></div><p class="sa-kpi__value">${ssrInterpolate((_a = unref(totals).count) != null ? _a : 0)}</p><div class="sa-kpi__sub">All M-Pesa requests</div></div><div class="sa-kpi"><div class="sa-kpi__top"><span class="sa-kpi__label">Collected</span><div class="sa-kpi__icon sa-kpi__icon--success">`);
        _push(ssrRenderComponent(VIcon, { size: "20" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
        ...
        _push(`</div></div><p class="sa-kpi__value text-warning">${ssrInterpolate((_b = unref(totals).pending) != null ? _b : 0)}</p><div class="sa-kpi__sub">Awaiting confirmation</div></div><div class="sa-kpi"><div class="sa-kpi__top"><span class="sa-kpi__label">Failed</span><div class="sa-kpi__icon sa-kpi__icon--error">`);
        _push(ssrRenderComponent(VIcon, { size: "20" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
        ...
        _push(`</div></div><p class="sa-kpi__value text-error">${ssrInterpolate((_c = unref(totals).failed) != null ? _c : 0)}</p><div class="sa-kpi__sub">Unsuccessful payments</div></div></div><div class="sa-card"><div class="sa-card__header"><div class="sa-card__header-icon sa-card__header-icon--teal">`);
        _push(ssrRenderComponent(VIcon, { size: "20" }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
...
//# sourceMappingURL=payments-CLTwGnMz.mjs.map
